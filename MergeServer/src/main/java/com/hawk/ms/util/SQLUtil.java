...
public class SQLUtil {
	 ...
	 * @return
	 */
	public static boolean isActiivtyDataTable(String tableName) {
		return tableName.contains("activity_");
	}
	
	public static boolean isBuildingTable(String tableName) {
		return tableName.contains("building");
	}
}

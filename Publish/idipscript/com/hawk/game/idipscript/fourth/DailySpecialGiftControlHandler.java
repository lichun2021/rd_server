 ...
 * 每日特惠礼包开关控制
 *
 * localhost:8080/script/idip/4257?GiftBagId=&Switch=
 *
 ...
 * @author lating
 */
@HawkScript.Declare(id = "idip/4257")
public class DailySpecialGiftControlHandler extends IdipScriptHandler {
	@Override
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		IdipUtil.systemSwitchControl(switchVal, ControlerModule.RECHARGE_SHOP, (int) giftId);

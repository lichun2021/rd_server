...
import com.hawk.activity.type.impl.playerComeBack.cfg.exchange.PlayerComeBackExchangeTimeCfg;
import com.hawk.activity.type.impl.playerComeBack.entity.PlayerComeBackEntity;
import com.hawk.game.protocol.Activity;

public class ComeBackPlayerExchangeTimeController extends PlayerComeBackTimeController {
	...
	public Class<? extends HawkConfigBase> getTimeCfgClass() {
		return PlayerComeBackExchangeTimeCfg.class;
	}

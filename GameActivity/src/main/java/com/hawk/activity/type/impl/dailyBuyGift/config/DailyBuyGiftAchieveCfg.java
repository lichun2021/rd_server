 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/daiy_buy_gift/daiy_buy_gift_achieve.xml")
public class DailyBuyGiftAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

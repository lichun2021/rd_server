 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/festival_two/festival_two_achieve.xml")
public class FestivalTwoAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

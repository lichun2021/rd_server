...
@HawkConfigManager.XmlResource(file = "activity/url_model_342/url_model_342_time.xml")
public class UrlModel342TimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id

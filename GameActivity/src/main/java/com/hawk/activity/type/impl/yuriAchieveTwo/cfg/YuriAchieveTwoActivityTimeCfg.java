 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/yuri_achieve_two/yuri_achieve_two_activity_time.xml")
public class YuriAchieveTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public YuriAchieveTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

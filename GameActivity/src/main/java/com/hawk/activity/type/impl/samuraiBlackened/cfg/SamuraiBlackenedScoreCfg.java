 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/samurai_blackened/samurai_blackened_score.xml")
public class SamuraiBlackenedScoreCfg extends AchieveConfig {
	/** */
	@Id
	...
	public SamuraiBlackenedScoreCfg() {
		achieveId = 0;
		rewards = "";
		conditionType = 0;
		conditionValue = "";

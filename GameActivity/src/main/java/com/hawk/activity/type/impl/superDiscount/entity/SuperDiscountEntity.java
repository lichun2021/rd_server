package com.hawk.activity.type.impl.superDiscount.entity;
...
@Entity
@Table(name="activity_super_discount")
public class SuperDiscountEntity extends HawkDBEntity implements IActivityDataEntity {
	@Id
    ...
    @IndexProp(id = 11)
	@Column(name = "drawAllTimes", nullable = false)
	private int drawAllTimes;
	...
	public SuperDiscountEntity(){}
	
	public SuperDiscountEntity(String playerId, int termId) {
	...
	public int getDrawAllTimes() {
		return drawAllTimes;
	}

	public void setDrawAllTimes(int drawAllTimes) {
		this.drawAllTimes = drawAllTimes;
	}

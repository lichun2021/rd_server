 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/fighter_puzzle/fighter_puzzle_time.xml")
public class FighterPuzzleTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

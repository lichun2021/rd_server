...
@HawkConfigManager.XmlResource(file = "activity/hellfire_two/activity_hellfire_two_time.xml")
public class ActivityHellFireTwoTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public ActivityHellFireTwoTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
public class HonourHeroReturnDailyScoreParser extends AchieveParser<AddTavernScoreEvent> {

	@Override
	public AchieveType geAchieveType() {
		return AchieveType.HONOUR_HERO_RETURN_DAILY_SCORE;
	}

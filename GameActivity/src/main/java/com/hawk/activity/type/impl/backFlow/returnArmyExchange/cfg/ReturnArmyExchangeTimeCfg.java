...
@HawkConfigManager.XmlResource(file = "activity/return_army_exchange/return_army_exchange_time.xml")
public class ReturnArmyExchangeTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	...
	public ReturnArmyExchangeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/snowball/snowball_activity_time.xml")
public class SnowballTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

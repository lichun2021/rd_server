 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/armed_science/armed_science_time.xml")
public class VirtualLaboratoryActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public VirtualLaboratoryActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

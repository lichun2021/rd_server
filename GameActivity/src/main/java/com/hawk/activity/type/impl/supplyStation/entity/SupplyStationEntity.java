package com.hawk.activity.type.impl.supplyStation.entity;
...
@Entity
@Table(name="activity_supply_station")
public class SupplyStationEntity extends HawkDBEntity implements IActivityDataEntity{
	...
	public SupplyStationEntity(){}
	
	public SupplyStationEntity(String playerId, int termId) {
	...
	public String toString() {
		return "SupplyStationEntity [id=" + id + ", playerId=" + playerId + ", termId=" + termId + ", buyInfo="

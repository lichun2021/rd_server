 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_dragonboat/dw_dragonboat_time.xml")
public class DragonBoatGiftTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

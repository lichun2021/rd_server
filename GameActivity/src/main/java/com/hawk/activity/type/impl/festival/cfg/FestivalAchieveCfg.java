 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/festival/%s/festival_achieve.xml", autoLoad=false, loadParams="10")
public class FestivalAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

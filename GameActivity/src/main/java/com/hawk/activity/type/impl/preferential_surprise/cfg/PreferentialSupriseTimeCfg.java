 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/preferential_surprise/preferential_surprise_time.xml")
public class PreferentialSupriseTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public PreferentialSupriseTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

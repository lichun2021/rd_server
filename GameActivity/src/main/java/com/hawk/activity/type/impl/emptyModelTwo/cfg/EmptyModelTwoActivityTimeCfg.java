 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/empty_model_two/empty_model_two_activity_time.xml")
public class EmptyModelTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EmptyModelTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
public class StrongestHistoryPersonTotalRank implements StrongestHistoryRank {

	private int termId;
	
	public StrongestHistoryPersonTotalRank(int termId){
		this.termId = termId;
	}
	...
	public String toString() {
		return "StrongestHistoryPersonTotalRank [termId=" + termId + "]";
	}
}

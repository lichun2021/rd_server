...
@HawkConfigManager.XmlResource(file = "activity/recharge_gift/%s/recharge_gift_activity_time.xml", autoLoad=false, loadParams="36")
public class RechargeGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public RechargeGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

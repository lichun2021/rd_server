 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/first_recharge_reset/first_recharge_reset_time.xml")
public class EmptyModelEightActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EmptyModelEightActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

package com.hawk.activity.type.impl.dressup.energygather.entity;
...
@Entity
@Table(name = "activity_dress_energy_gather")
public class EnergyGatherEntity extends ActivityDataEntity{
	...
	public EnergyGatherEntity() {
	}
	
	public EnergyGatherEntity(String playerId, int termId) {

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/team_return/team_return_achieve.xml")
public class PlayerTeamBackAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public PlayerTeamBackAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		score = 0;
		conditionValue = "";

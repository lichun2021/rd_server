 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/strongest_alliance/strongest_allian_activity_time.xml")
public class StrongestGuildActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public StrongestGuildActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

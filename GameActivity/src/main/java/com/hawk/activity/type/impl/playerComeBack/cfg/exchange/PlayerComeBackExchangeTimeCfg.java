...
@HawkConfigManager.XmlResource(file = "activity/return_activity/return_activity_exchange_time.xml")
public class PlayerComeBackExchangeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public PlayerComeBackExchangeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

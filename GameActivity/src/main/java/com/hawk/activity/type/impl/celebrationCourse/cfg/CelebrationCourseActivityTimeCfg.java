 ...
 * @author luke
 */
@HawkConfigManager.XmlResource(file = "activity/celebration_course/celebration_course_time.xml")
public class CelebrationCourseActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public CelebrationCourseActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/blessing/blessing_achieve.xml")
public class GreetingsAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

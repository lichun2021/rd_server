...
@HawkConfigManager.KVResource(file = "activity/gold_baby_new/%s/gold_baby_new_cfg.xml", autoLoad=false, loadParams="332")
public class GoldBabyNewKVCfg extends HawkConfigBase {
	...
	protected boolean assemble() {
		try {
			...
			startTime = HawkTime.parseTime(servertime);
		} catch (Exception e) {

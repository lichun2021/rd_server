...
@HawkConfigManager.XmlResource(file = "activity/time_lover/timelover_exchange.xml")
public class SupplyStationTwoExchangeCfg extends HawkConfigBase {
    @Id
    ...
    public SupplyStationTwoExchangeCfg(){
        id = 0;
        needItem = "";
        gainItem = "";
        times = 0;

...
@HawkConfigManager.XmlResource(file = "activity/migrant/migrant_activity_time.xml")
public class ImmgrationActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ImmgrationActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

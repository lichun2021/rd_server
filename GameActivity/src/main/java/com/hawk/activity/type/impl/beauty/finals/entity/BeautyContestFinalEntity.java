package com.hawk.activity.type.impl.beauty.finals.entity;
...
@Entity
@Table(name="activity_beauty_final")
public class BeautyContestFinalEntity extends HawkDBEntity implements IActivityDataEntity {
	...
	public BeautyContestFinalEntity() {
	}
	
	public BeautyContestFinalEntity(String playerId, int termId) {

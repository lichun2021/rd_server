package com.hawk.activity.type.impl.jigsawconnect326.entity;
...
@Entity
@Table(name = "activity_jxjigsaw_connect")
public class JXJigsawConnectEntity extends HawkDBEntity implements IActivityDataEntity{
	@Id
	...
	public JXJigsawConnectEntity() {
	}
	
	public JXJigsawConnectEntity(String playerId, int termId) {
	...
	public AchieveItem getAchieveItem(int achieveId){

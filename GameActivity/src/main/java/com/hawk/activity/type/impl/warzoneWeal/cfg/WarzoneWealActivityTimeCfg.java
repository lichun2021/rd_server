 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/warzone_weal/warzone_weal_activity_time.xml")
public class WarzoneWealActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public WarzoneWealActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

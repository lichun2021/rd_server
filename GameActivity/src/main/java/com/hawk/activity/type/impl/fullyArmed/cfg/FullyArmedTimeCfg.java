...
@HawkConfigManager.XmlResource(file = "activity/fully_armed/fully_armed_time.xml")
public class FullyArmedTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

...
@HawkConfigManager.XmlResource(file = "activity/develop_fast/develop_fast_task.xml")
public class DevelopFastAchieveCfg  extends AchieveConfig {
    /** 成就id*/
    @Id

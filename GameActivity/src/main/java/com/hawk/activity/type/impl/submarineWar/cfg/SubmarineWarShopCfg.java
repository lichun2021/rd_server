 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/submarine_war/submarine_war_shop.xml")
public class SubmarineWarShopCfg extends AExchangeTipConfig {
	// 奖励ID
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/exchange_three/activity_item_collect_three.xml")
public class ActivityItemCollectThreeCfg extends HawkConfigBase {
	/**
	 * 操作ID
	 */
	...
	public ActivityItemCollectThreeCfg() {
		this.id = 0;
		this.name = "";
		this.dropParam = 0;
		this.dropLimit = 0;

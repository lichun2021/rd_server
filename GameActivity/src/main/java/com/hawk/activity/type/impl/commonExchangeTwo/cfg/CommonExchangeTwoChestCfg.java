...
@HawkConfigManager.XmlResource(file = "activity/universal_exchange_two/universal_exchange_two_package.xml")
public class CommonExchangeTwoChestCfg extends HawkConfigBase {
	...
	public CommonExchangeTwoChestCfg(){
		id = 0;
		price = "";
		limit = 0;
		awardId = 0;

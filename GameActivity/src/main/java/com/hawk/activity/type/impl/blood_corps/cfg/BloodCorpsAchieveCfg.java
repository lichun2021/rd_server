 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/blood_corps/blood_corps_achieve.xml")
public class BloodCorpsAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

 ...
 * 实力飞升 时间配置
 */
@HawkConfigManager.XmlResource(file = "activity/develop_fast_old/develop_fast_old_time.xml")
public class DevelopFastOldTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id

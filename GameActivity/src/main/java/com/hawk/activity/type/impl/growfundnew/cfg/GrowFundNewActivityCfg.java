 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/new_grow_fund/%s/new_growfund_activity.xml", autoLoad=false, loadParams="263")
public class GrowFundNewActivityCfg extends AchieveConfig {

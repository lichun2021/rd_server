 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_five/url_model_five_time.xml")
public class UrlModelFiveActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelFiveActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/super_gold/super_gold_activity_time.xml")
public class SuperGoldTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

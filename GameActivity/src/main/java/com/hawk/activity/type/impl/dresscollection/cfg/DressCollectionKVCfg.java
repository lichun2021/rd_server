...
@HawkConfigManager.KVResource(file = "activity/dress_collection/dress_collection_kv_cfg.xml")
public class DressCollectionKVCfg extends HawkConfigBase {

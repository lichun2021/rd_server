 ...
 * @author luke
 */
@HawkConfigManager.XmlResource(file = "activity/joy_exchange/joy_exchange_achieve.xml")
public class JoyBuyAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id

 ...
 * 新兵作训-成就配置
 */
@HawkConfigManager.XmlResource(file = "activity/newbie_train/%s/newbie_train_number.xml", autoLoad=false, loadParams="334")
public class NewbieTrainAchieveCfg extends AchieveConfig{
	/** 
	 * 成就id 
	 */
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/hellfire_thr/activity_hellfire_thr_condition.xml")
public class ActivityHellFireThreeConditionCfg extends HawkConfigBase {
	/**
	 * 条件
	 */
	@Id
	...
	public ActivityHellFireThreeConditionCfg() {

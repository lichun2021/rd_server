 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/machine_sell/machine_sell_achieve.xml")
public class MachineSellAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

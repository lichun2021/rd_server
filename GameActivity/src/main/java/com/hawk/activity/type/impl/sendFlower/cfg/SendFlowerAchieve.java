...
@HawkConfigManager.XmlResource(file = "activity/send_flower/send_flower_achieve.xml")
public class SendFlowerAchieve extends AchieveConfig {
	/** 成就id */
	@Id

 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/blessing_gift/blessing_gift_time.xml")
public class HongFuGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public HongFuGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

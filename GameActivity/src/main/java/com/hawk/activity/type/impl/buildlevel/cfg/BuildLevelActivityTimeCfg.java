 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/build_level/%s/build_level_activity_time.xml", autoLoad=false, loadParams="6")
public class BuildLevelActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public BuildLevelActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

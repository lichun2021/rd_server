 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_three/url_model_three_time.xml")
public class UrlModelThreeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelThreeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

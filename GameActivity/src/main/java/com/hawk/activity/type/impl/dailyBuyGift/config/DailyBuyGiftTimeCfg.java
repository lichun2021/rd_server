...
*  中部养成计划
*/
@HawkConfigManager.XmlResource(file = "activity/daiy_buy_gift/daiy_buy_gift_time.xml")
public class DailyBuyGiftTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

package com.hawk.activity.type.impl.medalFund.entity;
...
@Entity
@Table(name = "activity_medal_fund")
public class MedalFundEntity extends HawkDBEntity implements IActivityDataEntity{
	@Id
	...
	public MedalFundEntity() {
	}
	
	public MedalFundEntity(String playerId) {
		this.playerId = playerId;
		this.daliyTaskMap = new HashMap<>();
		this.buyInfoMap = new HashMap<>();
	}
	
	public MedalFundEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.daliyTaskMap = new HashMap<>();
		this.buyInfoMap = new HashMap<>();

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_topup/dw_topup_reward.xml")
public class DragonBoatRechargeDaysCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public DragonBoatRechargeDaysCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

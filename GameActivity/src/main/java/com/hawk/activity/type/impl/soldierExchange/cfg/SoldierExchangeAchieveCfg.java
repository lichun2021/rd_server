...
@HawkConfigManager.XmlResource(file = "activity/soldier_exchange/soldier_exchange_achieve.xml")
public class SoldierExchangeAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public SoldierExchangeAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

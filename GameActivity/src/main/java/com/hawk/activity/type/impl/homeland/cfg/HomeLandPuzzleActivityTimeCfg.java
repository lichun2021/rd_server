...
@HawkConfigManager.XmlResource(file = "activity/act_home382/act_home382_time.xml")
public class HomeLandPuzzleActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /**
     * 活动期数
     */
    @Id
    ...
    public HomeLandPuzzleActivityTimeCfg() {
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

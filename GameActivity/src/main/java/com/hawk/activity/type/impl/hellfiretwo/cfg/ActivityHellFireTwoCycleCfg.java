...
@HawkConfigManager.XmlResource(file = "activity/hellfire_two/activity_hellfire_two_cycle.xml")
public class ActivityHellFireTwoCycleCfg extends HawkConfigBase {
	/**
	 * 周期ID
	 */
	@Id
	...
	public ActivityHellFireTwoCycleCfg() {
		this.cycleId = 0;
		this.name = "";
		this.conditionType = "";
		this.targetId = "";

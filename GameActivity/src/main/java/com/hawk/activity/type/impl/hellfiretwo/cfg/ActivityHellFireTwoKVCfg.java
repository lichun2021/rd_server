...
@HawkConfigManager.KVResource(file = "activity/hellfire_two/activity_hellfire_two_cfg.xml")
public class ActivityHellFireTwoKVCfg extends HawkConfigBase {
	/**
	 * 服务器开服延时开启活动时间
	 */
	...
	/** 单例 */
	private static ActivityHellFireTwoKVCfg instance;

	public static ActivityHellFireTwoKVCfg getInstance() {
		return instance;
	}

	public ActivityHellFireTwoKVCfg() {
		this.serverDelay = 0;

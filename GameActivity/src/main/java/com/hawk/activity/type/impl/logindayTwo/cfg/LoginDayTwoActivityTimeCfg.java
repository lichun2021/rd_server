 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/login_day_two/login_day_two_time.xml")
public class LoginDayTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public LoginDayTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/dress_drawing_search/dress_drawing_search_time.xml")
public class DrawingSearchTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

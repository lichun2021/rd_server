...
@HawkConfigManager.XmlResource(file = "activity/empty_exchange/empty_exchange_time.xml")
public class DomeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

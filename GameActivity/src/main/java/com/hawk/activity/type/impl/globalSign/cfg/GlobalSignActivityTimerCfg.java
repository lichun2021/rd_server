...
@HawkConfigManager.XmlResource(file ="activity/ssy_full_signin/ssy_full_signin_time.xml")
public class GlobalSignActivityTimerCfg extends HawkConfigBase implements IActivityTimeCfg{
	//活动期数
	@Id
	...
	public GlobalSignActivityTimerCfg() {
		this.termId = 0;
		this.showTime = "";
		this.startTime = "";
		this.endTime = "";

...
public class GoldBabyRewardPool {
	...
	public static GoldBabyRewardPool valueOf(String data) {
		...
		int index = 0;
		GoldBabyRewardPool pool = new GoldBabyRewardPool();
	...
	public void setRandomRewards() {
		...
		for (GoldBabyRewardCfg cfg: cfgs){

 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/dress_treasure/dress_treasure_time.xml")
public class DressTreasureTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

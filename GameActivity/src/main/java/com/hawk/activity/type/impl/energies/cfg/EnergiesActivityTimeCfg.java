 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/energies/energies_time.xml")
public class EnergiesActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EnergiesActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

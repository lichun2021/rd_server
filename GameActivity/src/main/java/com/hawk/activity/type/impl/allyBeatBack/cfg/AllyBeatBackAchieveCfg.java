...
@HawkConfigManager.XmlResource(file = "activity/ally_beat_back/activity_allybeatback_achieve.xml")
public class AllyBeatBackAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id

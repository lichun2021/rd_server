...
@HawkConfigManager.XmlResource(file = "activity/back_soldier_exchange/back_soldier_exchange_time.xml")
public class BackSoldierExchangeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public BackSoldierExchangeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

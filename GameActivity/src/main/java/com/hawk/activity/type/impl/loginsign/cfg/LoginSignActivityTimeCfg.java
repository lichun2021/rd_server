 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/login_sign/login_sign_activity_time.xml")
public class LoginSignActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public LoginSignActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

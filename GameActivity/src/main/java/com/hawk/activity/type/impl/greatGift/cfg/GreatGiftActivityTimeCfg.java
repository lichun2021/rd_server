...
@HawkConfigManager.XmlResource(file = "activity/super_gift/super_gift_activity_time.xml")
public class GreatGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public GreatGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

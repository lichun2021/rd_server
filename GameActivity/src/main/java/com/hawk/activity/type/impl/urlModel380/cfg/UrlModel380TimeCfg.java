 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/act_380/act_380_time.xml")
public class UrlModel380TimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

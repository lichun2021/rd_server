...
@XmlResource(file="activity/recharge_fund/recharge_fund_time.xml")
public class RechargeFundTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id

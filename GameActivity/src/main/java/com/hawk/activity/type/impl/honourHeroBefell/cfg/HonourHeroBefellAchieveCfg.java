 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/honour_hero_befell/honour_hero_befell_achieve.xml")
public class HonourHeroBefellAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public HonourHeroBefellAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

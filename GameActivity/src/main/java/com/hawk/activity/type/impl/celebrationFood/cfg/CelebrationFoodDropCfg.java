...
@HawkConfigManager.XmlResource(file = "activity/celebration_share_cake/celebration_share_cake_drop.xml")
public class CelebrationFoodDropCfg extends HawkConfigBase {
	/**
	 * 操作ID
	 */

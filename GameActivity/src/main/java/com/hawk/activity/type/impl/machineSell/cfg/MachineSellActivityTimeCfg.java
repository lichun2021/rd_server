...
@HawkConfigManager.XmlResource(file = "activity/machine_sell/machine_sell_activity_time.xml")
public class MachineSellActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public MachineSellActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

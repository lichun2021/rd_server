...
@HawkConfigManager.XmlResource(file = "activity/ally_beat_back/activity_allybeatback_time.xml")
public class AllyBeatBackTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/login_fund/loginfund_activity_time.xml")
public class LoginFundActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public LoginFundActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

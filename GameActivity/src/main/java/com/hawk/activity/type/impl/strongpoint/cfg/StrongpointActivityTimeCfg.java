package com.hawk.activity.type.impl.strongpoint.cfg;
 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/strongpoint/strongpoint_activity_time.xml")
public class StrongpointActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public StrongpointActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

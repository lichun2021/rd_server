 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_theme/hero_theme_achieve.xml")
public class HeroThemeAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/grassback/grassback_activity_time.xml")
public class ChemistryTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

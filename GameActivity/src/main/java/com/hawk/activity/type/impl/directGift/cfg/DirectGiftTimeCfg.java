...
@HawkConfigManager.XmlResource(file = "activity/direct_gift/direct_gift_time.xml")
public class DirectGiftTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

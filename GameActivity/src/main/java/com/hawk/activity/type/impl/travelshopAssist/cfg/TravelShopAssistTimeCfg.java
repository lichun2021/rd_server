 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/travel_shop_assist/travel_shop_assist_time_cfg.xml")
public class TravelShopAssistTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public TravelShopAssistTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

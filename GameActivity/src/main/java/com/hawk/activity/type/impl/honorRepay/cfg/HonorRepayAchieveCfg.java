 ...
 * 荣耀返利成就配置
 */
@HawkConfigManager.XmlResource(file = "activity/honor_repay/honor_repay_award.xml")
public class HonorRepayAchieveCfg extends AchieveConfig {
    /** 成就id*/
    @Id

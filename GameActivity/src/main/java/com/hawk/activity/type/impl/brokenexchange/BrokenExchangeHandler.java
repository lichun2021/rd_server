...
public class BrokenExchangeHandler extends ActivityProtocolHandler {
	@ProtocolHandler(code = HP.code.BROKEN_EXCHANGE_REQ_VALUE)
	public void brokenExchange(HawkProtocol protocol, String playerId) {
		BrokenExchangeActivity activity = getActivity(ActivityType.BROKEN_EXCHANGE_ACTIVITY);

...
@Entity
@Table(name = "activity_develop_fast")
public class DevelopFastEntity extends HawkDBEntity implements IActivityDataEntity {
    @Id
    ...
    @Transient
    private List<DevelopFastTask> taskList = new ArrayList<>();
    /** 活动成就 */
    @Transient
    ...
    public DevelopFastEntity(){

    }

    public DevelopFastEntity(String playerId, int termId){
    ...
    public void afterRead() {
        ...
        SerializeHelper.stringToList(DevelopFastTask.class, this.taskItems, this.taskList);
    ...
    public List<DevelopFastTask> getTaskList() {
        return taskList;
    }

    public void setTaskList(List<DevelopFastTask> taskList) {

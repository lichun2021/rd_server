 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/festival_two/festival_two_activity_time.xml")
public class FestivalTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public FestivalTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

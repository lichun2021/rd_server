 ...
 * @author che
 */
@HawkConfigManager.XmlResource(file = "activity/honour_hero_befell/honour_hero_befell_time.xml")
public class HonourHeroBefellTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public HonourHeroBefellTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

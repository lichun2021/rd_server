...
@HawkConfigManager.XmlResource(file = "activity/reward_order/rewardOrderActivityTime.xml")
public class RewardOrderTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id

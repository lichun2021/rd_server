...
public class DevelopSpurtTimeController extends PlayerComeBackTimeController {
	...
	public long getShowTimeByTermId(int termId, String playerId) {
		...
		DevelopSpurtEntity entity = (DevelopSpurtEntity)optional.get();
	...
	protected Optional<HawkDBEntity> getDBEntity(String playerId) {
		Optional<ActivityBase> optional = ActivityManager.getInstance().
				getActivity(Activity.ActivityType.DEVELOP_SPURT_VALUE);
		if(!optional.isPresent()){
	...
	public Class<? extends HawkConfigBase> getTimeCfgClass() {
		return DevelopSpurtTimeCfg.class;
	}

...
@HawkConfigManager.XmlResource(file = "activity/equipment_tech/equipment_tech_achieve.xml")
public class EquipTechAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

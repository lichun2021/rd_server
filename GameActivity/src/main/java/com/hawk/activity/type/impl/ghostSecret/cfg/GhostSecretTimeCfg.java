...
@HawkConfigManager.XmlResource(file = "activity/equip_treasure/equip_treasure_time.xml")
public class GhostSecretTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

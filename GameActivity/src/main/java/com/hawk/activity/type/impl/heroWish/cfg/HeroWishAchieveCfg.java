 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_wish/hero_wish_achieve.xml")
public class HeroWishAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

 ...
 * @author che
 */
@HawkConfigManager.XmlResource(file = "activity/exclusive_memory/exclusive_memory_time.xml")
public class ExclusiveMemoryTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

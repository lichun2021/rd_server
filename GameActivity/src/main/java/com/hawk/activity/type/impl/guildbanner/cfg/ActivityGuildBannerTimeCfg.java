...
@HawkConfigManager.XmlResource(file = "activity/flag_king/activity_flagking_time.xml")
public class ActivityGuildBannerTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public ActivityGuildBannerTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

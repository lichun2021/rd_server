 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/gift_rebate/gift_rebate_activity_time.xml")
public class PresentRebateActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public PresentRebateActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

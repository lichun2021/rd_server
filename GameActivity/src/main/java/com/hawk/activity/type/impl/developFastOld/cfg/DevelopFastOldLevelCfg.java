...
@HawkConfigManager.XmlResource(file = "activity/develop_fast_old/develop_fast_old_level.xml")
public class DevelopFastOldLevelCfg extends HawkConfigBase {
    /** id*/
    @Id

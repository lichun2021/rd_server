...
@XmlResource(file = "activity/recall_friend/recall_alliance_task.xml")
public class RecallFriendGuildTaskCfg extends AchieveConfig {
	@Id
	...
	public RecallFriendGuildTaskCfg() {
		this.achieveId = 0;

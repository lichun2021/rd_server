package com.hawk.activity.type.impl.brokenexchange.entity; 
...
*/
@Entity
@Table(name="activity_broken_exchange")
public class BrokenActivityEntity extends HawkDBEntity implements IActivityDataEntity{
	...
	public BrokenActivityEntity() {
	}
	
	public BrokenActivityEntity(String playerId, int termId) {

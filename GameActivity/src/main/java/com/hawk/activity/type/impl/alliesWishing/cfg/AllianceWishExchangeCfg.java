...
@HawkConfigManager.XmlResource(file = "activity/alliance_wish/alliance_wish_exchange.xml")
public class AllianceWishExchangeCfg extends HawkConfigBase {
	/**
	 * 唯一ID
	 */
	@Id
	...
	public AllianceWishExchangeCfg() {
		id = 0;
		needItem = "";
		gainItem = "";
		times = 0;

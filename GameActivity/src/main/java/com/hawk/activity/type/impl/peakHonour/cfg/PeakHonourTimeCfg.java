...
@HawkConfigManager.XmlResource(file = "activity/peak_honour/peak_honour_time.xml")
public class PeakHonourTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_eight/url_model_eight_time.xml")
public class UrlModelEightActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelEightActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 * @author Winder
 */
@HawkConfigManager.XmlResource(file = "activity/medal_action/medal_task_achieve.xml")
public class MedalActionTaskAchieveCfg extends AchieveConfig{
	/** 成就id */
	@Id
	...
	public MedalActionTaskAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

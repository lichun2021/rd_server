...
*  中部养成计划
*/
@HawkConfigManager.XmlResource(file = "activity/shooting_practice/shooting_practice_time.xml")
public class ShootingPracticeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id
    ...
    public ShootingPracticeTimeCfg(){
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_one/url_model_one_time.xml")
public class UrlModelOneActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelOneActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

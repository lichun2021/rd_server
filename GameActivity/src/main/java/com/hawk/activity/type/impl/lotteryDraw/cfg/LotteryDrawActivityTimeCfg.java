 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/lottery_draw/lottery_draw_activity_time.xml")
public class LotteryDrawActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public LotteryDrawActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

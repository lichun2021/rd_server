 ...
 * 虚拟实验室活动配置
 */
@HawkConfigManager.XmlResource(file = "activity/armed_science/armed_science_task.xml")
public class VirtualLaboratoryAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public VirtualLaboratoryAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		isReset = 0;

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/preferential_surprise/preferential_surprise_score.xml")
public class PreferentialSupriseScoreCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public PreferentialSupriseScoreCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

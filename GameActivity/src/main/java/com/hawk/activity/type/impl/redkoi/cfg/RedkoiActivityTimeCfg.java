 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/redkoi/koi_fish_time.xml")
public class RedkoiActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

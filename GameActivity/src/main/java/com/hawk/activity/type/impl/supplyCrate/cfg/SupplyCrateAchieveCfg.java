...
@HawkConfigManager.XmlResource(file = "activity/supply_crate/supply_crate_achieve.xml")
public class SupplyCrateAchieveCfg  extends AchieveConfig{
    /** 成就id*/
    @Id

...
public class CommonExchangeHandler extends ActivityProtocolHandler {
	 ...
	 * @param playerId
	 */
	@ProtocolHandler(code = HP.code.COMMON_EXCHANGE_TIPS_C_VALUE)
	public void domeExchangePlayerTips(HawkProtocol protocol, String playerId){
		CommonExchangeActivity activity = getActivity(ActivityType.COMMON_EXCHANGE_ACTIVITY);
	 ...
	 * @param playerId
	 */
	@ProtocolHandler(code = HP.code.COMMON_EXCHANGE_EXCHANGE_VALUE)
	...
	@ProtocolHandler(code = HP.code.COMMON_EXCHANGE_BUY_C_VALUE)

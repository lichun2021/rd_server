 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/jx_jigsaw_connect/jx_jigsaw_connect_combo.xml")
public class JXJigsawConnectComboCfg extends HawkConfigBase {
	/** */
	@Id
	...
	public JXJigsawConnectComboCfg() {
		connectId = 0;
		achieveConnect = "";
	}

package com.hawk.activity.type.impl.backFlow.chemistry.entity;
...
@Entity
@Table(name = "activity_chemistry")
public class ChemistryEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public ChemistryEntity(String playerId) {
		this.playerId = playerId;
		this.achieveItems = "";
	}
	
	public ChemistryEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.achieveItems = "";
	}

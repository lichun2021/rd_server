...
@HawkConfigManager.XmlResource(file = "activity/time_limit_drop/time_limit_drop_data.xml")
public class TimeLimitDropDataCfg extends HawkConfigBase {
	/**
	 * 操作ID
	 */

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/j20_celebration/j20_celebration_activity_time.xml")
public class FlightPlanActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public FlightPlanActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

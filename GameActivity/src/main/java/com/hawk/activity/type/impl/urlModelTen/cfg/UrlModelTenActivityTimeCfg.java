 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_ten/url_model_ten_time.xml")
public class UrlModelTenActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelTenActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

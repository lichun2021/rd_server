 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/yuri_revenge/yuri_revenge_activity_time.xml")
public class YuriRevengeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public YuriRevengeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

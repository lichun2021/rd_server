...
@HawkConfigManager.XmlResource(file = "activity/submarine_war/submarine_war_time.xml")
public class SubmarineWarTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

...
@HawkConfigManager.XmlResource(file = "activity/return_activity/return_activity_package_time.xml")
public class PlayerComeBackBuyTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public PlayerComeBackBuyTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

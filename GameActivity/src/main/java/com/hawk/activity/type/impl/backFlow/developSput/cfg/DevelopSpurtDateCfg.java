...
@HawkConfigManager.XmlResource(file = "activity/return_develop/return_develop_type.xml")
public class DevelopSpurtDateCfg extends HawkConfigBase{
	@Id

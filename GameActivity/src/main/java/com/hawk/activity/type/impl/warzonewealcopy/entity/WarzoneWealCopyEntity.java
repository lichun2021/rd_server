package com.hawk.activity.type.impl.warzonewealcopy.entity;
...
@Entity
@Table(name = "activity_gift_send")
public class WarzoneWealCopyEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public WarzoneWealCopyEntity() {
	}
	public WarzoneWealCopyEntity(String playerId, int termId) {

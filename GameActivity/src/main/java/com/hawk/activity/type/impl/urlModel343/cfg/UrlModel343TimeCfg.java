...
@HawkConfigManager.XmlResource(file = "activity/url_model_343/url_model_343_time.xml")
public class UrlModel343TimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id

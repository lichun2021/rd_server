 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/fighter_puzzle_sopen/%s/fighter_puzzle_sopen_score.xml", autoLoad=false, loadParams="282")
public class FighterPuzzleServeropenScoreCfg extends AchieveConfig {
	/** */
	@Id
	...
	public FighterPuzzleServeropenScoreCfg() {
		achieveId = 0;
		rewards = "";
		conditionType = 0;
		conditionValue = "";

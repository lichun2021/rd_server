 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/ordnance_fortress/ordnance_fortress_comm_reward.xml")
public class OrdnanceFortressCommReward extends HawkConfigBase {
	// 奖励ID
	@Id
	...
	public OrdnanceFortressCommReward() {
		id = 0;
		type = 0;
		rewards = "";
	}

...
@HawkConfigManager.XmlResource(file = "activity/dyzz_achieve/dyzz_achieve_time.xml")
public class DYZZAchieveTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id

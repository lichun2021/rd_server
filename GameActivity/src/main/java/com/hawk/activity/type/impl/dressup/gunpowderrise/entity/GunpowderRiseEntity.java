package com.hawk.activity.type.impl.dressup.gunpowderrise.entity;
 ...
 */
@Entity
@Table(name="activity_dress_gunpowder_rise")
public class GunpowderRiseEntity extends HawkDBEntity implements IActivityDataEntity {
	@Id
	...
	public GunpowderRiseEntity(){}
	
	public GunpowderRiseEntity(String playerId, int termId) {
	...
	public void initTips(){
		if (playerPoints.isEmpty()){
			ConfigIterator<GunpowderRiseExchangeCfg> ite = HawkConfigManager.getInstance().getConfigIterator(GunpowderRiseExchangeCfg.class);
			while(ite.hasNext()){
				GunpowderRiseExchangeCfg config = ite.next();

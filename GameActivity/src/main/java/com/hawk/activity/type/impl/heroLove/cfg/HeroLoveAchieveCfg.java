 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_love/hero_love_achieve.xml")
public class HeroLoveAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

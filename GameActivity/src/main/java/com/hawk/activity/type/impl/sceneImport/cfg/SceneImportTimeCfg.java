 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/scene_import/scene_import_time.xml")
public class SceneImportTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

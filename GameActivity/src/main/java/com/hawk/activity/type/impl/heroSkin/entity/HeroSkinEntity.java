package com.hawk.activity.type.impl.heroSkin.entity;
...
import com.hawk.activity.type.impl.heroSkin.cfg.HeroSkinRewardPoolCfg;
 ...
 */
@Entity
@Table(name = "activity_hero_skin")
public class HeroSkinEntity extends AchieveActivityEntity implements IActivityDataEntity {
	@Id
	...
	public HeroSkinEntity(String playerId, int termId) {
	...
	public void resetItems() {
		ConfigIterator<HeroSkinRewardPoolCfg> it = HawkConfigManager.getInstance().getConfigIterator(HeroSkinRewardPoolCfg.class);
		HeroSkinRewardPoolCfg cfg = HawkRand.randomWeightObject(it.toList());

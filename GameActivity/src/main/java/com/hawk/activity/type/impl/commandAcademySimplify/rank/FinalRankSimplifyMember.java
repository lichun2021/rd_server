...
public class FinalRankSimplifyMember extends CommandAcademySimplifyRankMember{
	...
	public FinalRankSimplifyMember() {
		
	}
	
	
	public FinalRankSimplifyMember(String playerId,double score,int stage,int param) {

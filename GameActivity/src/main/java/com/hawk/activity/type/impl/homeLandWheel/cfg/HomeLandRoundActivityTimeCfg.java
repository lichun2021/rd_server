...
@HawkConfigManager.XmlResource(file = "activity/homeland_round/homeland_round_time.xml")
public class HomeLandRoundActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /**
     * 活动期数
     */
    @Id
    ...
    public HomeLandRoundActivityTimeCfg() {
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

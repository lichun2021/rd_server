 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/armies_mass/armies_mass_time.xml")
public class ArmiesMassTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

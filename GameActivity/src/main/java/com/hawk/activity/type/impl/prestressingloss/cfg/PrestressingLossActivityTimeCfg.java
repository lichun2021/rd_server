...
@HawkConfigManager.XmlResource(file = "activity/loss/loss_activity_time.xml")
public class PrestressingLossActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public PrestressingLossActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college/%s/commander_college_box.xml", autoLoad=false, loadParams="162")
public class CommandAcademyBoxAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public CommandAcademyBoxAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

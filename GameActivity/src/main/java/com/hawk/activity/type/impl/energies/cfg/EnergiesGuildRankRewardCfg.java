 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/energies/energies_alliance_rank_award.xml")
public class EnergiesGuildRankRewardCfg extends HawkConfigBase {
	/** */
	@Id
	...
	public EnergiesGuildRankRewardCfg() {
		id = 0;
		rankHigh = 0;
		rankLow = 0;
		gainItem = "";
	...
	protected final boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("EnergiesGuildRankRewardCfg reward error, id: %s , reward: %s", id, gainItem));
		}

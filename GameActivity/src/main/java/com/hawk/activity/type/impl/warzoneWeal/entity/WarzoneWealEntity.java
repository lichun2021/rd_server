package com.hawk.activity.type.impl.warzoneWeal.entity;
...
@Entity
@Table(name = "activity_warzone_weal")
public class WarzoneWealEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public WarzoneWealEntity() {
	}
	public WarzoneWealEntity(String playerId, int termId) {

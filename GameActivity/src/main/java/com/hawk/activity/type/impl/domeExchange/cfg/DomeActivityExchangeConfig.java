...
@HawkConfigManager.XmlResource(file = "activity/empty_exchange/empty_exchange.xml")
public class DomeActivityExchangeConfig extends HawkConfigBase {
	...
	public DomeActivityExchangeConfig(){
		id = 0;
		needItem = "";
		gainItem = "";
		times = 0;

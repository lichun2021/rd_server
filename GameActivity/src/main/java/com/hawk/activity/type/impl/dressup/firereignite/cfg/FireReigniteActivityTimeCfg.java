 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/dress_war_reburning/dress_war_reburning_time.xml")
public class FireReigniteActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public FireReigniteActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

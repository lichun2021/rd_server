 ...
 * 道具回收活动时间控制配置
 */
@HawkConfigManager.XmlResource(file = "activity/recovery_exchange/recovery_exchange_time.xml")
public class RecoveryExchangeTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /**
     * 活动期数
     */
    @Id
    ...
    public RecoveryExchangeTimeCfg() {
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

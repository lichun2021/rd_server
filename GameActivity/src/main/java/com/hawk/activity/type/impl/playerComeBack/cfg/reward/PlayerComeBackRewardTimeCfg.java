...
@HawkConfigManager.XmlResource(file = "activity/return_activity/return_activity_reward_time.xml")
public class PlayerComeBackRewardTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public PlayerComeBackRewardTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

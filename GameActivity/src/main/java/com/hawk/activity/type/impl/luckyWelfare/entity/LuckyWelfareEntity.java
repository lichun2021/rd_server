package com.hawk.activity.type.impl.luckyWelfare.entity;
...
@Entity
@Table(name = "activity_lucky_welfare")
public class LuckyWelfareEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public LuckyWelfareEntity() {
	}
	public LuckyWelfareEntity(String playerId, int termId) {

...
@HawkConfigManager.XmlResource(file = "activity/ssy_full_signin/ssy_full_signin_reward.xml")
public class GlobalSignAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

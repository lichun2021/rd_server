...
@HawkConfigManager.XmlResource(file = "activity/airdrop_supply/airdrop_supply_achieve.xml")
public class AirdropSupplyAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public AirdropSupplyAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

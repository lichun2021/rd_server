 ...
 * @author Winder
 */
@HawkConfigManager.XmlResource(file = "activity/medal_action/medal_action_achieve.xml")
public class MedalActionAchieveCfg extends AchieveConfig{
	/** 成就id */
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/universal_exchange/universal_exchange_package_time.xml")
public class ComeBackExchangeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public ComeBackExchangeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

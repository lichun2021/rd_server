...
@HawkConfigManager.XmlResource(file = "activity/back_soldier_exchange/back_soldier_exchange_achieve.xml")
public class BackSoldierExchangeAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public BackSoldierExchangeAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

package com.hawk.activity.type.impl.fighter_puzzle_serveropen.entity;
...
@Entity
@Table(name = "activity_fighter_puzzle_serveropen")
public class FighterPuzzleServeropenEntity extends ActivityDataEntity {
    ...
    @IndexProp(id = 4)
	@Column(name = "initDay", nullable = false)
	private int initDay;
	...
	public FighterPuzzleServeropenEntity() {
	}

	public FighterPuzzleServeropenEntity(String playerId, int termId) {

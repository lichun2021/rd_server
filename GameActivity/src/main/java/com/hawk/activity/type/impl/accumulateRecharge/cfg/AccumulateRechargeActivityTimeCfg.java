 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/accumulate_recharge_achieve/recharge_activity_time.xml")
public class AccumulateRechargeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public AccumulateRechargeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

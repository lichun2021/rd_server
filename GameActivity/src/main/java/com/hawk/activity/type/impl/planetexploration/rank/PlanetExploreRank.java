package com.hawk.activity.type.impl.planetexploration.rank;
...
public interface PlanetExploreRank<T extends PlanetExploreRankData> {
	...
	default int getTermId(){
		Optional<ActivityBase> opActivity = ActivityManager.getInstance().getActivity(ActivityType.PLANET_EXPLORE_347_VALUE);

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/battlefield_treasure/battlefield_achieve_award.xml")
public class BattleFieldAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

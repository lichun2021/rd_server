 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dress_energy_gather/dress_energy_gather_time.xml")
public class EnergyGatherActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EnergyGatherActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

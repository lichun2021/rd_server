package com.hawk.activity.type.impl.backSoldierExchange.entity;
...
@Entity
@Table(name = "activity_back_soldier_exchange")
public class BackSoldierExchangeEntity extends AchieveActivityEntity implements IActivityDataEntity {
	@Id
	...
	public BackSoldierExchangeEntity() {
		
	}

	public BackSoldierExchangeEntity(String playerId) {
		this.playerId = playerId;
		this.histor = "";
	}

	public BackSoldierExchangeEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.histor = "";
	}

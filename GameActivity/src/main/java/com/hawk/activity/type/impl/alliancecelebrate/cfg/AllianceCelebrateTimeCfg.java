 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/ssy_alliance_celebrate/ssy_alliance_celebrate_time.xml")
public class AllianceCelebrateTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public AllianceCelebrateTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/recharge_welfare/recharge_welfare_achieve.xml")
public class RechargeWelfareAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public RechargeWelfareAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

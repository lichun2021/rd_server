 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_gift/dw_gift_time.xml")
public class DragonBoatCelebrationTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DragonBoatCelebrationTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

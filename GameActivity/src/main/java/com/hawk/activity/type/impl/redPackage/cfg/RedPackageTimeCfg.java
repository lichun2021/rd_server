...
@HawkConfigManager.XmlResource(file = "activity/red_packet/red_packet_activity_time.xml")
public class RedPackageTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

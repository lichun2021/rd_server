 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_gold/dw_gold_achieve.xml")
public class DragonBoatLuckyBagAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public DragonBoatLuckyBagAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/shop_skip/shop_skip_activity_time.xml")
public class ShopSkipActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ShopSkipActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

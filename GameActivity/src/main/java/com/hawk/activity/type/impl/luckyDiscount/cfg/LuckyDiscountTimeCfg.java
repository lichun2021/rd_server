...
@HawkConfigManager.XmlResource(file = "activity/lucky_discount/luckydiscount_time.xml")
public class LuckyDiscountTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

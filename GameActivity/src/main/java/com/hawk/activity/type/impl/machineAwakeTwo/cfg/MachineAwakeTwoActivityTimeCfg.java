 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/machine_awake_two/machine_awake_two_time.xml")
public class MachineAwakeTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	private final int nianType;
	
	public MachineAwakeTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

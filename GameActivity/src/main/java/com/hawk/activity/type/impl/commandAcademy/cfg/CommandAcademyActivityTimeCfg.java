 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college/%s/commander_college_time.xml", autoLoad=false, loadParams="162")
public class CommandAcademyActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public CommandAcademyActivityTimeCfg() {
		termId = 0;
		showTime = 0;
		startTime = 0;
		endTime = 0;

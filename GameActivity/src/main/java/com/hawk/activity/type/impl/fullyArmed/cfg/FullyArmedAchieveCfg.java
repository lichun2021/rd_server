 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/fully_armed/fully_armed_achieve.xml")
public class FullyArmedAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

...
@XmlResource(file="activity/pandora_box/pandora_box_activity_time.xml")
public class PandoraBoxTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_six/url_model_six_time.xml")
public class UrlModelSixActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelSixActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

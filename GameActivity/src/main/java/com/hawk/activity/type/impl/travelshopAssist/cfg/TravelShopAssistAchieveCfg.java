 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/travel_shop_assist/travel_shop_assist_achieve.xml")
public class TravelShopAssistAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public TravelShopAssistAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

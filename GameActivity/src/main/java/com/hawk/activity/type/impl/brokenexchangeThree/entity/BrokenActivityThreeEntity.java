package com.hawk.activity.type.impl.brokenexchangeThree.entity; 
...
*/
@Entity
@Table(name="activity_broken_exchange_three")
public class BrokenActivityThreeEntity extends HawkDBEntity implements IActivityDataEntity{
	...
	public BrokenActivityThreeEntity() {
	}
	
	public BrokenActivityThreeEntity(String playerId, int termId) {

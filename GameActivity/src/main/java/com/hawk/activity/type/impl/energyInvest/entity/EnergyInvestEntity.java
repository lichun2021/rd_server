package com.hawk.activity.type.impl.energyInvest.entity;
...
@Entity
@Table(name = "activity_energy_invest")
public class EnergyInvestEntity extends HawkDBEntity implements IActivityDataEntity{
	@Id
	...
	public EnergyInvestEntity() {
	}
	
	public EnergyInvestEntity(String playerId) {
		this.playerId = playerId;
		this.daliyTaskMap = new HashMap<>();
		this.buyInfoMap = new HashMap<>();
	}
	
	public EnergyInvestEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.daliyTaskMap = new HashMap<>();
		this.buyInfoMap = new HashMap<>();

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/alliance_carnival/alliance_carnival_activity_time.xml")
public class AllianceCarnivalTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public AllianceCarnivalTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/power_invest/power_invest_menu.xml")
public class EnergyInvestMenuCfg extends HawkConfigBase {
	// 礼包ID
	@Id 

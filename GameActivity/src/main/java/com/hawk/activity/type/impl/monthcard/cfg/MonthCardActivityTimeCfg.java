 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/month_card/activity_monthCard_time.xml")
public class MonthCardActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public MonthCardActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

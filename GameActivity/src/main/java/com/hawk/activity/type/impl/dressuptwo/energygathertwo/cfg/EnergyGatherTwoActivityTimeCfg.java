 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/christmas_snow_plan/christmas_snow_plan_time.xml")
public class EnergyGatherTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EnergyGatherTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

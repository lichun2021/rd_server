 ...
 * @author Richard
 */
@HawkConfigManager.XmlResource(file = "activity/alliance_share_glory/alliance_share_glory_time.xml")
public class ShareGloryTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /**
     * 活动期数
     */
    @Id

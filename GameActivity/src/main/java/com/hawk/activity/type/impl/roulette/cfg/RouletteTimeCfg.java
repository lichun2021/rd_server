...
@XmlResource(file="activity/roulette/roulette_activity_time.xml")
public class RouletteTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/versionOftaste/versionOftaste_date.xml")
public class NewlyExperienceDateCfg extends HawkConfigBase{
	@Id

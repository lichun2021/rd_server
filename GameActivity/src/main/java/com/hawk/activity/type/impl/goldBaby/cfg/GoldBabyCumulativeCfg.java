...
//累计抽奖次数奖励配置
@HawkConfigManager.XmlResource(file = "activity/gold_baby/gold_baby_cumulative.xml")
public class GoldBabyCumulativeCfg extends AchieveConfig {
	/** 成就id*/
	@Id

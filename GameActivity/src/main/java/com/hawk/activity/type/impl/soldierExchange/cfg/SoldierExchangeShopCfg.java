...
@HawkConfigManager.XmlResource(file = "activity/soldier_exchange/soldier_exchange_shop.xml")
public class SoldierExchangeShopCfg extends HawkConfigBase {

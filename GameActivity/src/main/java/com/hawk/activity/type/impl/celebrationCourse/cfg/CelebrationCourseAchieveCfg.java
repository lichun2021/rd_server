 ...
 * @author luke
 */
@HawkConfigManager.XmlResource(file = "activity/celebration_course/celebration_course_achieve.xml")
public class CelebrationCourseAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public CelebrationCourseAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 * 新首充奖励配置
 */
@HawkConfigManager.XmlResource(file = "activity/first_recharge_three/first_recharge_three_reward.xml")
public class FirstRechargeRewardThreeCfg extends HawkConfigBase {
    @Id
    ...
    public FirstRechargeRewardThreeCfg(){
        this.id = 0;
        this.waitTime = 0;
        this.payCount = 0;
        this.commonAward = "";

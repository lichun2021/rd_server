 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/warzone_weal/warzone_weal_achieve.xml")
public class WarezoneWealAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

...
*/
@HawkConfigManager.XmlResource(file = "activity/cny_exam/cny_exam_time.xml")
public class CnyExamTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

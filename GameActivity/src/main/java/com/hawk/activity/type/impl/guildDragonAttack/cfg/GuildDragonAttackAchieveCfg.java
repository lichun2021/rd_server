 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/alliance_boss/alliance_boss_achieve.xml")
public class GuildDragonAttackAchieveCfg extends AchieveConfig {
	...
	public GuildDragonAttackAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

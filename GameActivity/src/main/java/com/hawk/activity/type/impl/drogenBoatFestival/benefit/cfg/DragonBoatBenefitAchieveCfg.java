 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_shop/dw_shop_achieve.xml")
public class DragonBoatBenefitAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public DragonBoatBenefitAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

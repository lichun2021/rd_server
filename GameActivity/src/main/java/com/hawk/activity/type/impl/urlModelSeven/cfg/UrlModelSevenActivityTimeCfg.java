 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_seven/url_model_seven_time.xml")
public class UrlModelSevenActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelSevenActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

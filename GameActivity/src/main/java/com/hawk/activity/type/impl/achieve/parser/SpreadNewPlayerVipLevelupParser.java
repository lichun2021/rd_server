...
/**
 * 
 * @author RickMei 推广员活动绑定玩家贵族等级提升
 */
public class SpreadNewPlayerVipLevelupParser extends AchieveParser<VipLevelupEvent> {

	@Override
	public AchieveType geAchieveType() {
		return AchieveType.SPREAD_N_VIP_LEVEL;
	}
	...
	@Override
	protected boolean updateAchieve(AchieveItem achieveData, AchieveConfig achieveConfig, VipLevelupEvent event) {

 ...
 *
 */
@HawkConfigManager.KVResource(file = "activity/hidden_treasure_new/hidden_treasure_new_cfg.xml")
public class DeepTreasureActivityKVCfg extends HawkConfigBase {
	/**
	 * 服务器开服延时开启活动时间
	 */
	...
	public DeepTreasureActivityKVCfg() {
		serverDelay = 0;

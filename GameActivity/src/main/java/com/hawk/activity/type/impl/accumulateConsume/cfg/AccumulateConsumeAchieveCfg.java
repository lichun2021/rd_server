 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/accumulate_consume_achieve/consume_achieve.xml")
public class AccumulateConsumeAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public AccumulateConsumeAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

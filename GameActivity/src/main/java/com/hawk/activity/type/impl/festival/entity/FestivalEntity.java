package com.hawk.activity.type.impl.festival.entity;
...
@Entity
@Table(name = "activity_festival")
public class FestivalEntity  extends HawkDBEntity implements IActivityDataEntity{
	...
	public FestivalEntity(String playerId, int termId) {

...
@HawkConfigManager.XmlResource(file = "activity/hero_skin_lottery/hero_skin_lottery_achieve.xml")
public class HeroSkinAchieveCfg extends AchieveConfig {

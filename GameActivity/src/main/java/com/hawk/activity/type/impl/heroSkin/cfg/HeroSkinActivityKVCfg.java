 ...
 *
 */
@HawkConfigManager.KVResource(file = "activity/hero_skin_lottery/hero_skin_lottery_activity_cfg.xml")
public class HeroSkinActivityKVCfg extends HawkConfigBase {
	// # 服务器开服延时开启活动时间；单位：秒
	...
	public RewardItem.Builder getGetItemList() {
		return getItemList;
	}
}
 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/machine_awake/machine_awake_rank_award.xml")
public class MachineAwakeRankRewardCfg extends HawkConfigBase {
	/** */
	@Id
	...
	public MachineAwakeRankRewardCfg() {
		id = 0;
		rankType = 0;
		rankUpper = 0;
		rankLower = 0;

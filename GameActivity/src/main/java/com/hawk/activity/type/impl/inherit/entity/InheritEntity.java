package com.hawk.activity.type.impl.inherit.entity;
 ...
 */
@Entity
@Table(name = "activity_inherit")
public class InheritEntity extends AchieveActivityEntity implements IActivityDataEntity{
	...
	public InheritEntity() {
	}
	
	public InheritEntity(String playerId, int termId) {

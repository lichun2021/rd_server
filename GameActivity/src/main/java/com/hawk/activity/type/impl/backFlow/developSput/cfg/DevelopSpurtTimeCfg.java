...
@HawkConfigManager.XmlResource(file = "activity/return_develop/return_develop_time.xml")
public class DevelopSpurtTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	...
	public void setStopTriggerValue(long stopTriggerValue) {

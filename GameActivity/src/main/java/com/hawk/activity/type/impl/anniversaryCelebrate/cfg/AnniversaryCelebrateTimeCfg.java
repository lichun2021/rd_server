 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/anniversary_celebrate/anniversary_celebrate_time.xml")
public class AnniversaryCelebrateTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public AnniversaryCelebrateTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

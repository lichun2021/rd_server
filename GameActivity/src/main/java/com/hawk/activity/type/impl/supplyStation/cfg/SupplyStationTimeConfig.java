...
@HawkConfigManager.XmlResource(file = "activity/supply_station/supply_station_activity_time.xml")
public class SupplyStationTimeConfig extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public SupplyStationTimeConfig() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 * 分为每日重置成就和累计成就
 */
@HawkConfigManager.XmlResource(file = "activity/gold_baby/gold_baby_achieve.xml")
public class GoldBabyDailyAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public GoldBabyDailyAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		resetting=0;
		conditionValue = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/scene_share/scene_share_achieve.xml")
public class SceneShareAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

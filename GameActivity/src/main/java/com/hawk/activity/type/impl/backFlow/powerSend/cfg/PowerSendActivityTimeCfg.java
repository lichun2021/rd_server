...
@HawkConfigManager.XmlResource(file = "activity/return_send_gift/return_sent_gift_time.xml")
public class PowerSendActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	...
	public PowerSendActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

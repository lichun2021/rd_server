...
@HawkConfigManager.XmlResource(file = "activity/treasure_cavalry/treasure_cavalry_activity_time.xml")
public class TreasureCavalryActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public TreasureCavalryActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

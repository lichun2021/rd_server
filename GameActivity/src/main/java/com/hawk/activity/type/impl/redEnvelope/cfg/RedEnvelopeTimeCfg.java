...
@HawkConfigManager.XmlResource(file = "activity/redPacket_achieve/redPacket_activity_time.xml")
public class RedEnvelopeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

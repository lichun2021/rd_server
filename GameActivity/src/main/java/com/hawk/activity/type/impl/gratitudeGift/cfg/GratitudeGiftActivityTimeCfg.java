...
@HawkConfigManager.XmlResource(file = "activity/gratitude_gift/gratitude_gift_activity_time.xml")
public class GratitudeGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public GratitudeGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

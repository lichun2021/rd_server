...
@HawkConfigManager.XmlResource(file = "activity/ally_beat_back/activity_allybeatback_type.xml")
public class AllyBeatBackTypeCfg extends HawkConfigBase {
	/**
	 * 操作ID
	 */

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_trial/hero_trial_time.xml")
public class HeroTrialActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public HeroTrialActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/mecha_invest/mecha_invest_menu.xml")
public class SupersoldierInvestMenuCfg extends HawkConfigBase {
	// 礼包ID
	@Id 
	...
	public SupersoldierInvestMenuCfg() {
		id = 0;
		androidPayId = "";
		iosPayId = "";
		buyAward = "";

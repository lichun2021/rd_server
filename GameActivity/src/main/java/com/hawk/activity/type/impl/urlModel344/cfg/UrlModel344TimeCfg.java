...
@HawkConfigManager.XmlResource(file = "activity/url_model_344/url_model_344_time.xml")
public class UrlModel344TimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/empty_model_six/empty_model_six_activity_time.xml")
public class EmptyModelSixActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EmptyModelSixActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

package com.hawk.activity.type.impl.loginday.entity;
 ...
 */
@Entity
@Table(name = "activity_login_day")
public class ActivityLoginDayEntity extends HawkDBEntity implements IActivityDataEntity{
	...
	public ActivityLoginDayEntity() {
	}
	
	public ActivityLoginDayEntity(String playerId, int termId) {

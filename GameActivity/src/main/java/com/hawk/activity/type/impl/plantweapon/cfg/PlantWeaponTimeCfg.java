...
@HawkConfigManager.XmlResource(file = "activity/plant_weapon/plant_weapon_time.xml")
public class PlantWeaponTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

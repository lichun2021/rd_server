 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/team_return/team_return_activity_time.xml")
public class PlayerTeamBackActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public PlayerTeamBackActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

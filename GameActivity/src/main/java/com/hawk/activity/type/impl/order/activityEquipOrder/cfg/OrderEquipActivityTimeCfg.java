 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/equip_order/equip_order_time.xml")
public class OrderEquipActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public OrderEquipActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";
	...
	protected boolean checkValid() {
		int activityWeeks = OrderEquipTaskCfg.getContinueWeeks();
		long weekTime = HawkTime.DAY_MILLI_SECONDS * 7;
		long activityTime = this.hiddenTimeValue - this.showTimeValue;
		if(activityTime > activityWeeks * weekTime){
			return  false;
		}

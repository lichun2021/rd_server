 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/break_shackles/break_shackles_time_cfg.xml")
public class BreakShacklesTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

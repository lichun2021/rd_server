 ...
 *
 */
public class GoldBabyNewHandler extends ActivityProtocolHandler {
	
	//活动信息请求
	@ProtocolHandler(code = HP.code2.GOLD_BABY_NEW_INFO_REQ_VALUE)
	public boolean onInfoReq(HawkProtocol protocol, String playerId) {
		GoldBabyNewActivity activity = getActivity(ActivityType.GOLD_BABY_NEW_ACTIVITY);
	...
	//搜寻
	@ProtocolHandler(code = HP.code2.GOLD_BABY_NEW_FIND_REQ_VALUE)
	...
	//锁定最高档
	@ProtocolHandler(code = HP.code2.GOLD_BABY_NEW_LOCK_REQ_VALUE)
	...
	//购买道具请求
	@ProtocolHandler(code = HP.code2.GOLD_BABY_NEW_BUY_TICKET_REQ_VALUE)

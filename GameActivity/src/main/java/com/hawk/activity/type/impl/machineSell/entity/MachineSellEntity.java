package com.hawk.activity.type.impl.machineSell.entity;
...
@Entity
@Table(name = "activity_machine_sell")
public class MachineSellEntity extends AchieveActivityEntity implements IActivityDataEntity {
	@Id
    ...
    @IndexProp(id = 9)
	@Column(name = "singleTimes", nullable = false)
	private int singleTimes;
	
	@Transient
	private List<AchieveItem> itemList = new CopyOnWriteArrayList<AchieveItem>();
	public MachineSellEntity() {
	}

	public MachineSellEntity(String playerId, int termId) {
	...
	public void incLotteryTimes( int times ) {
	...
	public void incSingleTimes(int times) {
		this.singleTimes += times;
	}
}

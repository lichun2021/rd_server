 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/order/order_activity_time.xml")
public class OrderActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

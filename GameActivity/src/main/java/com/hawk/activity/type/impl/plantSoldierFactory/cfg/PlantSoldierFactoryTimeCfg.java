...
*/
@HawkConfigManager.XmlResource(file = "activity/plant_soldier_factory/plant_soldier_factory_time.xml")
public class PlantSoldierFactoryTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id
    ...
    public PlantSoldierFactoryTimeCfg(){
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

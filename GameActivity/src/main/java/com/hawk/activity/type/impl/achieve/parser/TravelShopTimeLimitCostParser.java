...
public class TravelShopTimeLimitCostParser extends AchieveParser<TravelShopPurchaseEvent> {

	@Override
	public AchieveType geAchieveType() {
		return AchieveType.TRAVEL_SHOP_LIMITE_TIME_COST;
	}
	...
	protected boolean updateAchieve(AchieveItem achieveItem, AchieveConfig achieveConfig, TravelShopPurchaseEvent event) {
		...
		achieveItem.setValue(0, achieveItem.getValue(0) + (int)event.getCostNum());
		return true;
	}
}

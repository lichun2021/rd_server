 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/recharge_buy_new/recharge_buy_new_time.xml")
public class RechargeBuyNewActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public RechargeBuyNewActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

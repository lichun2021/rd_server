 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/return_puzzle/return_puzzle_achieve.xml")
public class ReturnPuzzleAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

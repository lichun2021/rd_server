 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_exchange/dw_exchange_time.xml")
public class DragonBoatExchangeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DragonBoatExchangeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

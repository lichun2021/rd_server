...
@HawkConfigManager.XmlResource(file = "activity/group_buy/group_buying_reward.xml")
public class GroupBuyAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

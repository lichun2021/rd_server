...
@HawkConfigManager.XmlResource(file = "activity/universal_exchange/universal_package.xml")
public class CommonExchangeChestCfg extends HawkConfigBase {

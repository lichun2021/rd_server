package com.hawk.activity.type.impl.domeExchange.entity;
...
@Entity
@Table(name="activity_dome_exchange")
public class DomeExchangeEntity extends HawkDBEntity implements IActivityDataEntity {
	@Id
	...
	public DomeExchangeEntity(){}
	
	public DomeExchangeEntity(String playerId, int termId) {

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/gift_send/%s/gift_send_achieve.xml", autoLoad=false, loadParams="95")
public class WarezoneWealAchieveCopyCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public WarezoneWealAchieveCopyCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

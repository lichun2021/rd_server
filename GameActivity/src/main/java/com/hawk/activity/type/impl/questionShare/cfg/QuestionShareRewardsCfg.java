 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/question_share/question_share_rewards.xml")
public class QuestionShareRewardsCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public QuestionShareRewardsCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

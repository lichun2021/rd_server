 ...
 * @author lating
 */
@HawkConfigManager.XmlResource(file = "activity/beauty_contest/beauty_contest_time.xml")
public class BeautyContestTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

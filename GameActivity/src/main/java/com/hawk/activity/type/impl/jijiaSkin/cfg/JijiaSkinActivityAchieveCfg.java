...
@HawkConfigManager.XmlResource(file = "activity/jijia_skin_activity/jijia_skin_activity_achieve.xml")
public class JijiaSkinActivityAchieveCfg  extends AchieveConfig{
    /** 成就id*/
    @Id
    ...
    public JijiaSkinActivityAchieveCfg(){
        achieveId = 0;
        conditionType = 0;
        conditionValue = "";
        rewards = "";

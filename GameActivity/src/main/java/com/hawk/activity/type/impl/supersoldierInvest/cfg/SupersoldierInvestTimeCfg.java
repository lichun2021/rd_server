...
@HawkConfigManager.XmlResource(file = "activity/mecha_invest/mecha_invest_time.xml")
public class SupersoldierInvestTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public SupersoldierInvestTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		buyEndTime = "";

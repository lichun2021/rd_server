 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/resource_defense/resource_defense_activity_time.xml")
public class ResourceDefenseTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

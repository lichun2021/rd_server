...
@HawkConfigManager.XmlResource(file = "activity/universal_exchange_two/universal_exchange_two.xml")
public class CommonActivityExchangeTwoConfig extends HawkConfigBase {
	...
	public CommonActivityExchangeTwoConfig(){
		id = 0;
		needItem = "";
		gainItem = "";
		times = 0;

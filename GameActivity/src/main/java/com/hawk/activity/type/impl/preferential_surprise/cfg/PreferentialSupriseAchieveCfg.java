 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/preferential_surprise/preferential_surprise_achieve.xml")
public class PreferentialSupriseAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public PreferentialSupriseAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college/%s/commander_college.xml", autoLoad=false, loadParams="162")
public class CommandAcademyStageCfg extends HawkConfigBase{
	/** 成就id*/
	@Id
	...
	public CommandAcademyStageCfg(int stageId,int orderId){

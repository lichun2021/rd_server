...
@HawkConfigManager.XmlResource(file = "activity/overlord_blessing/overlord_blessing_time.xml")
public class OverlordBlessingTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public OverlordBlessingTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

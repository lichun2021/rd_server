 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/lover_meet/lover_meet_cfg_time.xml")
public class LoverMeetTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

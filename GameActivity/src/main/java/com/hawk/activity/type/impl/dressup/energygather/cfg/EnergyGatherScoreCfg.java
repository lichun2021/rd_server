 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dress_energy_gather/dress_energy_gather_reward.xml")
public class EnergyGatherScoreCfg extends AchieveConfig {
	/** */
	@Id

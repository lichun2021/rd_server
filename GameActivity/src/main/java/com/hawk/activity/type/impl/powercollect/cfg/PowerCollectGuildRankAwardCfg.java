...
@HawkConfigManager.XmlResource(file = "activity/super_lab/super_lab_alliance_rank_award.xml")
public class PowerCollectGuildRankAwardCfg extends HawkConfigBase {
	...
	public PowerCollectGuildRankAwardCfg(){
		this.id = 0;
		this.rankHigh = 0;
		this.rankLow = 0;
		this.gainItem = "";
	...
	protected final boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("PowerCollectGuildRankAwardCfg reward error, id: %s , reward: %s", id, gainItem));
		}

...
public class ActivityHellFireTwoRankCfg extends HawkConfigBase {
	@Id
	...
	public ActivityHellFireTwoRankCfg() {
		id = 0;
		rankId = 0;
		lvMin = 0;
		lvMax = 0;
	...
	protected final boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("ActivityHellFireTwoRankCfg reward error, id: %s , item: %s", id, reward));
		}

...
@HawkConfigManager.XmlResource(file = "activity/recharge_gift/%s/recharge_gift.xml", autoLoad=false, loadParams="36")
public class RechargeGiftAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	@Override
	public List<Builder> getRewardList() {
		return rewardList;
	}

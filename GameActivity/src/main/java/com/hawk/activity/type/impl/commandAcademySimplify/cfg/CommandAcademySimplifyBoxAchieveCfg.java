 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college_cut/%s/commander_college_cut_box.xml", autoLoad=false, loadParams="284")
public class CommandAcademySimplifyBoxAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public CommandAcademySimplifyBoxAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

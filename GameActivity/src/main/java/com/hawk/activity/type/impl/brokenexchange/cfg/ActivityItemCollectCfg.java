...
@HawkConfigManager.XmlResource(file = "activity/exchange/activity_item_collect.xml")
public class ActivityItemCollectCfg extends HawkConfigBase {
	/**
	 * 操作ID
	 */

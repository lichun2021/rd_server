...
@HawkConfigManager.XmlResource(file = "activity/grassback/grassback_gift_activity_task.xml")
public class ChemistryAchieveConfig extends AchieveConfig {

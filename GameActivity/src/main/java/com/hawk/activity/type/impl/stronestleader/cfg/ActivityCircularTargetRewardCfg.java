 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/strongest_leader/activity_circular_target_reward.xml")
public class ActivityCircularTargetRewardCfg extends HawkConfigBase {
	/** */
	@Id
	...
	public ActivityCircularTargetRewardCfg() {
		id = 0;
		targetId = 0;
		lvMin = 0;
		lvMax = 0;
	...
	protected final boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("ActivityCircularTargetRewardCfg reward error, id: %s , reward: %s", id, reward));
		}

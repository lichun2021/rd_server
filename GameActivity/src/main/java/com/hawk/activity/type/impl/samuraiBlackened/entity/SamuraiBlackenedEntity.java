package com.hawk.activity.type.impl.samuraiBlackened.entity;
...
@Entity
@Table(name = "activity_samurai_blackened")
public class SamuraiBlackenedEntity extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public SamuraiBlackenedEntity() {
	}

	public SamuraiBlackenedEntity(String playerId, int termId) {

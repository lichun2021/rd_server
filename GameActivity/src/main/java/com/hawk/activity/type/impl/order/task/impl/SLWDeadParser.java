...
public class SLWDeadParser implements OrderTaskParser<SWScoreEvent> {

    @Override
    public OrderTaskType getTaskType() {
        return OrderTaskType.SLW_DEAD;
    }
    ...
    public boolean onEventUpdate(IOrderDateEntity dataEntity, IOrderTaskCfg cfg, OrderItem orderItem, SWScoreEvent event) {
        ...
        return onAddValue(dataEntity, cfg, orderItem, event.getDead());
    }
}

...
import com.hawk.activity.type.impl.playerComeBack.cfg.achieve.PlayerComeBackAchieveTimeCfg;
import com.hawk.activity.type.impl.playerComeBack.entity.PlayerComeBackEntity;
import com.hawk.game.protocol.Activity;

public class ComeBackPlayerAchieveTimeController extends PlayerComeBackTimeController {
	...
	public Class<? extends HawkConfigBase> getTimeCfgClass() {
		return PlayerComeBackAchieveTimeCfg.class;
	}

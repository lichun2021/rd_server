...
@HawkConfigManager.XmlResource(file = "activity/hero_exchange/hero_exchange_time.xml")
public class HeroBackExchangeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public HeroBackExchangeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

package com.hawk.activity.type.impl.powerup.entity;
...
@Entity
@Table(name = "activity_power_up")
public class PowerUpEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public PowerUpEntity(String playerId) {
		this.playerId = playerId;
		this.achieveItems = "";
	}
	
	public PowerUpEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.achieveItems = "";
	}

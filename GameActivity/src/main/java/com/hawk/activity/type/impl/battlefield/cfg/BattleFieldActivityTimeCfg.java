 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/battlefield_treasure/battlefield_treasure_time.xml")
public class BattleFieldActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public BattleFieldActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

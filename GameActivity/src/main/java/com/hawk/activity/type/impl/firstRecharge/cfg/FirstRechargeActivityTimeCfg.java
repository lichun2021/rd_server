 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/first_recharge/activity_first_recharge_time.xml")
public class FirstRechargeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public FirstRechargeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/spread/spread_new_achieve.xml")
public class SpreadNewAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

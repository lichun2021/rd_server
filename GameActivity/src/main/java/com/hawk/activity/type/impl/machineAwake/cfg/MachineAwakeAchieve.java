...
@HawkConfigManager.XmlResource(file = "activity/machine_awake/machine_awake_achieve.xml")
public class MachineAwakeAchieve extends AchieveConfig {
	/** 成就id */
	@Id

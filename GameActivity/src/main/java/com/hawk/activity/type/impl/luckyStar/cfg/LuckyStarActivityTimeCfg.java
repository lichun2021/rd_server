...
@HawkConfigManager.XmlResource(file = "activity/lucky_star/lucky_star_time.xml")
public class LuckyStarActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	...
	public LuckyStarActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/exchange_three/broken_exchange_three_time.xml")
public class ActivityExchangeThreeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ActivityExchangeThreeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

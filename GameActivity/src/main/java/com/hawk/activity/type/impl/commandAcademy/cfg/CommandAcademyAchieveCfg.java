 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college/%s/commander_college_achieve.xml", autoLoad=false, loadParams="162")
public class CommandAcademyAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public CommandAcademyAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

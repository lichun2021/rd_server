 ...
 *
 */
@HawkConfigManager.KVResource(file = "activity/peak_honour/peak_honour_cfg.xml")
public class PeakHonourKVCfg extends HawkConfigBase {
	/**
	 * 起服延迟开放时间
	 */
	 ...
	 * 单例
	 */
	private static PeakHonourKVCfg instance;
	
	/**
	 * 获取单例
	 * @return
	 */
	public static PeakHonourKVCfg getInstance(){
		return instance;
	}

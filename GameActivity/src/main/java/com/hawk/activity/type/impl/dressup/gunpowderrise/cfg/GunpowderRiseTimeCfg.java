 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/dress_smoke_again/dress_smoke_again_time.xml")
public class GunpowderRiseTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id

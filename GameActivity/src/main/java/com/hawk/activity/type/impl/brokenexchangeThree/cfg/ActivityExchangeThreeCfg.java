...
@HawkConfigManager.XmlResource(file = "activity/exchange_three/activity_exchange_three.xml")
public class ActivityExchangeThreeCfg extends HawkConfigBase {
	/**
	 * 唯一ID
	 */
	@Id
	...
	public ActivityExchangeThreeCfg() {
		id = 0;
		needItem = "";
		gainItem = "";
		dailyTimes = 0;

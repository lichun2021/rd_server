 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/empty_model/empty_model_activity_time.xml")
public class EmptyModelActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EmptyModelActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

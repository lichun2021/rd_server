...
import com.hawk.game.protocol.Activity.PBHiddenTreasureOpenboxItemBuyReq;
...
public class HiddenTreasureHandler extends ActivityProtocolHandler {

	/** 开箱子*/
	@ProtocolHandler(code = HP.code2.HIDDEN_TREASURE_OPEN_BOX_REQ_VALUE)
	public void medalTreasureLottery(HawkProtocol protocol, String playerId) {
		HiddenTreasureActivity activity = getActivity(ActivityType.HIDDEN_TREASURE_ACTIVITY);
		PBHiddenTreasureOpenboxReq req = protocol.parseProtocol(PBHiddenTreasureOpenboxReq.getDefaultInstance());
	 ...
	 * 刷新
	 */
	@ProtocolHandler(code = HP.code2.HIDDEN_TREASURE_REFRESH_BOX_REQ_VALUE)
	 ...
	 * 买开箱子道具
	 */
	@ProtocolHandler(code = HP.code2.HIDDEN_TREASURE_BOX_ITEM_BUY_REQ_VALUE)
	public void purchaseItemCost(HawkProtocol protocol, String playerId) {
		PBHiddenTreasureOpenboxItemBuyReq req = protocol.parseProtocol(PBHiddenTreasureOpenboxItemBuyReq.getDefaultInstance());
		HiddenTreasureActivity activity = getActivity(ActivityType.HIDDEN_TREASURE_ACTIVITY);
	...
	@ProtocolHandler(code = HP.code2.HIDDEN_TREASURE_ITEM_EXECHANGE_REQ_VALUE)
	public void allianceGuildExchange(HawkProtocol hawkProtocol, String playerId) {
		HiddenTreasureActivity activity = this.getActivity(ActivityType.HIDDEN_TREASURE_ACTIVITY);
		if (activity == null) {
			return;
		}

...
@HawkConfigManager.XmlResource(file = "activity/recharge_qixi/recharge_qixi_achieve_two.xml")
public class RechargeQixiLimitAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public RechargeQixiLimitAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

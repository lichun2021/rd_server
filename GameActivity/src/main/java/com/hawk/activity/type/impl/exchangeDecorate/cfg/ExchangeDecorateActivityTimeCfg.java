...
@HawkConfigManager.XmlResource(file = "activity/freeavatar/freeavatar_activity_time.xml")
public class ExchangeDecorateActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ExchangeDecorateActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/radiation_war/%s/radiation_war_achieve.xml", autoLoad=false, loadParams="184")
public class RadiationWarAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id

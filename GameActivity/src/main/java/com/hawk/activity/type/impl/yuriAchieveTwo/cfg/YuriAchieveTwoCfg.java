...
@HawkConfigManager.XmlResource(file = "activity/yuri_achieve_two/yuri_achieve_two.xml")
public class YuriAchieveTwoCfg extends AchieveConfig {
	/** 成就id */
	@Id

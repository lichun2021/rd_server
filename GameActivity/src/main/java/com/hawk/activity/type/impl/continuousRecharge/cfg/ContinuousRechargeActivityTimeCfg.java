 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/even_filling/even_filling_activity_time.xml")
public class ContinuousRechargeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public ContinuousRechargeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

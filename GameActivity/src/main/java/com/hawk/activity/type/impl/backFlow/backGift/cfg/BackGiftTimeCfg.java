...
@HawkConfigManager.XmlResource(file = "activity/back_gift_activity/back_gift_activity_time.xml")
public class BackGiftTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

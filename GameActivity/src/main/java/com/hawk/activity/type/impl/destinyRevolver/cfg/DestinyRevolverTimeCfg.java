 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/destiny_revolver/destiny_revolver_time.xml")
public class DestinyRevolverTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

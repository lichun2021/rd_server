...
@HawkConfigManager.XmlResource(file = "activity/changeserver/changeserver_point_get.xml")
public class ChangeServerPointGetCfg  extends HawkConfigBase {
    /**
     * 获取积分途径
     * 1:使用一个金条给n点积分
     * 2:使用一个金币给n点积分
     ...
     * 构造
     */
    public ChangeServerPointGetCfg(){
        getType = 0;
        proportion = 0;
        isGetLimit = 0;
        limitPoints = 0;

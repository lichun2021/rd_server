...
@HawkConfigManager.XmlResource(file = "activity/super_lab/super_lab_time.xml")
public class PowerCollectTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

...
@HawkConfigManager.XmlResource(file = "activity/after_competition_party/after_competition_party_achieve.xml")
public class AfterCompetitionAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public AfterCompetitionAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		reward = "";

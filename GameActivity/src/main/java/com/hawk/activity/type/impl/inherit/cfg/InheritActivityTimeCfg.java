...
@HawkConfigManager.XmlResource(file = "activity/inherit/inherit_activity_time.xml")
public class InheritActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/rose_gift/rose_gift_time.xml")
public class RoseGiftTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id

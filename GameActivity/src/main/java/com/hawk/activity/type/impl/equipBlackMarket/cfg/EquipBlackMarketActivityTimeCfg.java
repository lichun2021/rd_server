 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/arms_market/arms_market_time.xml")
public class EquipBlackMarketActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public EquipBlackMarketActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/anniversary_gift/anniversary_gift_time.xml")
public class AnniversaryGiftTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

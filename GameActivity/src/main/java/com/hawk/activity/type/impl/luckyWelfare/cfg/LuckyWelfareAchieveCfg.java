...
@HawkConfigManager.XmlResource(file = "activity/lucky_welfare/lucky_welfare_achieve.xml")
public class LuckyWelfareAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

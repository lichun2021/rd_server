 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/custom_made/custom_made_activity_time.xml")
public class CustomGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public CustomGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

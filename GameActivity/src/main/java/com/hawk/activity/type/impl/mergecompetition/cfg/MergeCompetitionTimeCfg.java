...
@HawkConfigManager.XmlResource(file = "activity/merge_competition/%s/merge_competition_time.xml", autoLoad=false, loadParams="368")
public class MergeCompetitionTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public MergeCompetitionTimeCfg() {
		termId = 0;
		showTime = 0;
		startTime = 0;
		endTime = 0;

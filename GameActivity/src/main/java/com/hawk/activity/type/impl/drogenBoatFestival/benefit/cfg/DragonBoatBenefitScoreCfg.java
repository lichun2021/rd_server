 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_shop/dw_shop_score.xml")
public class DragonBoatBenefitScoreCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public DragonBoatBenefitScoreCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

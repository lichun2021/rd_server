package com.hawk.activity.type.impl.heroBack.entity;
...
@Entity
@Table(name="activity_hero_back")
public class HeroBackEntity extends HawkDBEntity implements IActivityDataEntity{
	...
	public HeroBackEntity(){}
	
	public HeroBackEntity(String playerId, int termId) {

...
@HawkConfigManager.XmlResource(file = "activity/service_bonus/%s/bonusr_time.xml", autoLoad=false, loadParams="323")
public class DiffNewServerTechTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id
    ...
    public DiffNewServerTechTimeCfg(){
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

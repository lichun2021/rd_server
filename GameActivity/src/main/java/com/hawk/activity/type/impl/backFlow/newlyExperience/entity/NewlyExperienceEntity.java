package com.hawk.activity.type.impl.backFlow.newlyExperience.entity;
...
@Entity
@Table(name = "activity_newly_experience")
public class NewlyExperienceEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public NewlyExperienceEntity() {
	}
	
	public NewlyExperienceEntity(String playerId) {
		this.playerId = playerId;
		this.achieveItems = "";
	}
	
	public NewlyExperienceEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.achieveItems = "";
	}

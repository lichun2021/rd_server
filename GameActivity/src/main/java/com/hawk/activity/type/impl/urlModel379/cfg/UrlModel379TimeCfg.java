 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/act_379/act_379_time.xml")
public class UrlModel379TimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

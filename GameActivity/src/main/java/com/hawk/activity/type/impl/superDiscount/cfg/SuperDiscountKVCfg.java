...
@HawkConfigManager.KVResource(file = "activity/ssy_superSale/ssy_superSale_cfg.xml")
public class SuperDiscountKVCfg extends HawkConfigBase {
	...
	private List<RewardItem.Builder> needgoldList;
	
	//每天刷新上限次数
	private final int refreshLimit;
	//每天免费次数
	private final int refreshFree;
	//# 是否每日0点重置免费刷新次数
	...
	public List<RewardItem.Builder> getNeedgoldList() {
		return needgoldList;
	}
	...
	protected boolean assemble() {
		...
		try {
			needgoldList = RewardHelper.toRewardItemImmutableList(needgold);
		} catch (Exception e) {

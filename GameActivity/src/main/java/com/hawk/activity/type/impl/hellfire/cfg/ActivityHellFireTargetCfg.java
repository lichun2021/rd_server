...
@HawkConfigManager.XmlResource(file = "activity/hellfire/activity_hellfire_target.xml")
public class ActivityHellFireTargetCfg extends HawkConfigBase {
	/**
	 * 目标id
	 */
	@Id
	...
	public ActivityHellFireTargetCfg() {
		this.id = 0;
		this.targetId = 0;
		this.lvMax = 0;
		this.lvMin = 0;
	...
	public boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("ActivityHellFireTargetCfg reward error, id: %s , reward: %s", id, reward));
		}

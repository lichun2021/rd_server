...
@HawkConfigManager.XmlResource(file = "activity/medal_invest_two/medal_invest_two_time.xml")
public class MedalFundTwoTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

...
@HawkConfigManager.XmlResource(file = "activity/return_army_exchange/return_army_exchange.xml")
public class ReturnArmyExchangeConfig extends HawkConfigBase {
	...
	public ReturnArmyExchangeConfig(){
		id = 0;
		playerType = 0;
		limit = 0;
		price = "";

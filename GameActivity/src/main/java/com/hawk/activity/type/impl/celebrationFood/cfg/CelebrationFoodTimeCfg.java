 ...
 *庆典美食
 */
@HawkConfigManager.XmlResource(file = "activity/celebration_share_cake/celebration_share_cake_time.xml")
public class CelebrationFoodTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

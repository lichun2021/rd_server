 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/exclusive_memory/exclusive_memory_achieve.xml")
public class ExclusiveMemoryAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public ExclusiveMemoryAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

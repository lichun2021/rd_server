 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/samurai_blackened/samurai_blackened_achieve.xml")
public class SamuraiBlackenedAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public SamuraiBlackenedAchieveCfg() {
		day = 0;
		achieveId = 0;
		conditionType = 0;
		score = 0;

...
@HawkConfigManager.XmlResource(file = "activity/machine_lab/machine_lab_time.xml")
public class MachineLabTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/equip_achieve/equip_achieve.xml")
public class ActivityEquipAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public ActivityEquipAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

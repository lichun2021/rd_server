...
@HawkConfigManager.XmlResource(file = "activity/save_gold/save_time.xml")
public class DiffInfoSaveTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id

...
@HawkConfigManager.XmlResource(file = "activity/coreplate/%s/coreplate_activity_achieve.xml", autoLoad=false, loadParams="283")
public class CoreplateAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

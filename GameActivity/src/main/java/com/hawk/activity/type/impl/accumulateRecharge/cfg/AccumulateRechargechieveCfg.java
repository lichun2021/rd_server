 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/accumulate_recharge_achieve/recharge_achieve.xml")
public class AccumulateRechargechieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public AccumulateRechargechieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

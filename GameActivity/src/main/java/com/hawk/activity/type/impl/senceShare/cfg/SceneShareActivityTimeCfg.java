 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/scene_share/scene_share_activity_time.xml")
public class SceneShareActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public SceneShareActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/lucky_welfare/lucky_welfare_time.xml")
public class LuckyWelfareActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public LuckyWelfareActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/honour_hero_befell/honour_hero_befell_exchange.xml")
public class HonourHeroBefellExchangeCfg extends HawkConfigBase {
	/**
	 * 唯一ID
	 */
	@Id
	...
	public HonourHeroBefellExchangeCfg() {
		id = 0;
		needItem = "";
		gainItem = "";
		times = 0;

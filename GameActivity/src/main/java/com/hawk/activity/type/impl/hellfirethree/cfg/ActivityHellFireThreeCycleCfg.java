...
@HawkConfigManager.XmlResource(file = "activity/hellfire_thr/activity_hellfire_thr_cycle.xml")
public class ActivityHellFireThreeCycleCfg extends HawkConfigBase {
	/**
	 * 周期ID
	 */
	@Id
	...
	public ActivityHellFireThreeCycleCfg() {
		this.cycleId = 0;
		this.name = "";
		this.conditionType = "";
		this.targetId = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/equip_craftsman/equip_craftsman_time.xml")
public class EquipCarftsmanTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/spread/spread_hidden_achieve.xml")
public class SpreadHiddenAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	private final int finishAchieveId;
	private AchieveType achieveType;
	private List<RewardItem.Builder> rewardList;
	private List<Integer> conditionValueList;

	public SpreadHiddenAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";
	...
	public int getFinishAchieveId() {
		return finishAchieveId;
	}
}

...
@HawkConfigManager.XmlResource(file = "activity/planet_exploration/planet_exploration_target.xml")
public class PlanetExploreAchieveCfg extends AchieveConfig {
	...
	public PlanetExploreAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 *
 */
@HawkConfigManager.KVResource(file = "activity/url_model_nine/url_model_nine_cfg.xml")
public class UrlModelNineActivityKVCfg extends URLRewardBaseCfg {
	...
	public UrlModelNineActivityKVCfg() {
		reward = "";
		serverDelay = 0;
	}

package com.hawk.activity.type.impl.dresscollection.cfg;
...
@HawkConfigManager.XmlResource(file = "activity/dress_collection/dress_collection_time.xml")
public class DressCollectionTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

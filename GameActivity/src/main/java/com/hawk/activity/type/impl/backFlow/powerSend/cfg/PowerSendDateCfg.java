...
@HawkConfigManager.XmlResource(file = "activity/return_send_gift/return_send_gift_type.xml")
public class PowerSendDateCfg extends HawkConfigBase{
	@Id

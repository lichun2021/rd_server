...
@HawkConfigManager.XmlResource(file = "activity/black_tech/black_tech_time.xml")
public class BlackTechTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

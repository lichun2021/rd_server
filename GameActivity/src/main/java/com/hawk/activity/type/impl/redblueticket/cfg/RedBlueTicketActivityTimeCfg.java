 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/red_blue_ticket/red_blue_time.xml")
public class RedBlueTicketActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public RedBlueTicketActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

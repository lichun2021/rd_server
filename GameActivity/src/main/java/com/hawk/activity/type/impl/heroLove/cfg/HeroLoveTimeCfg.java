 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_love/hero_love_time.xml")
public class HeroLoveTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

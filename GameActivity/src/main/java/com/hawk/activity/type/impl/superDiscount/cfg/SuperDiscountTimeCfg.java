...
@HawkConfigManager.XmlResource(file = "activity/ssy_superSale/ssy_superSale_time.xml")
public class SuperDiscountTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

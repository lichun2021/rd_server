 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/empty_model_five/empty_model_five_activity_time.xml")
public class EmptyModelFiveActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EmptyModelFiveActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

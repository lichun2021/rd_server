 ...
 * 霸主膜拜成就数据
 * 
 * @author Winder - lating
 */
@HawkConfigManager.XmlResource(file = "activity/overlord_blessing/overlord_blessing_achieve.xml")
public class OverlordBlessingAchieveCfg extends AchieveConfig{
	/** 成就id */
	@Id
	...
	public OverlordBlessingAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

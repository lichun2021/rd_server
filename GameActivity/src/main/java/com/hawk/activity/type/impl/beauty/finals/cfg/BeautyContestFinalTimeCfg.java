 ...
 * @author lating
 */
@HawkConfigManager.XmlResource(file = "activity/beauty_contest_finals/beauty_contest_finals_time.xml")
public class BeautyContestFinalTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public BeautyContestFinalTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

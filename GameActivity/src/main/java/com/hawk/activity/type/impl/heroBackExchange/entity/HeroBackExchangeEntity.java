package com.hawk.activity.type.impl.heroBackExchange.entity;
...
@Entity
@Table(name="activity_hero_back_exchange")
public class HeroBackExchangeEntity extends HawkDBEntity implements IActivityDataEntity {
	@Id
	...
	public HeroBackExchangeEntity(){}
	
	public HeroBackExchangeEntity(String playerId, int termId) {
	...
	public String toString() {
		return "HeroBackEntity [id=" + id + ", playerId=" + playerId + ", termId=" + termId + ", buyInfo="

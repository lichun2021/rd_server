...
import com.hawk.activity.type.impl.playerComeBack.cfg.buy.PlayerComeBackBuyTimeCfg;
import com.hawk.activity.type.impl.playerComeBack.entity.PlayerComeBackEntity;
import com.hawk.game.protocol.Activity;

public class ComeBackPlayerBuyTimeController extends PlayerComeBackTimeController {
	...
	public Class<? extends HawkConfigBase> getTimeCfgClass() {
		return PlayerComeBackBuyTimeCfg.class;
	}

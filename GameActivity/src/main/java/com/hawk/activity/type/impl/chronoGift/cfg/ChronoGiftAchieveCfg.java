 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/space_gift/space_gift_achieve.xml")
public class ChronoGiftAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

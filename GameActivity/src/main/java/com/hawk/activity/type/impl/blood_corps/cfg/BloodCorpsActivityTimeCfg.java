 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/blood_corps/blood_corps_activity_time.xml")
public class BloodCorpsActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public BloodCorpsActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

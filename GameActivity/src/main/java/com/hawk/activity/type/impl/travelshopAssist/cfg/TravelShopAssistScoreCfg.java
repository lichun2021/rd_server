 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/travel_shop_assist/travel_shop_assist_score.xml")
public class TravelShopAssistScoreCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public TravelShopAssistScoreCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/medal_action/medal_action_activity_time.xml")
public class MedalActionLotteryTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	...
	public MedalActionLotteryTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
*/
@HawkConfigManager.XmlResource(file = "activity/guild_back/guild_back_time.xml")
public class GuildBackTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

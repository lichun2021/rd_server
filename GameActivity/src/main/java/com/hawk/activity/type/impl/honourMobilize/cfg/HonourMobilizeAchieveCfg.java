 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/honour_mobilize/%s/honour_mobilize_achieve.xml", autoLoad=false, loadParams="366")
public class HonourMobilizeAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public HonourMobilizeAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

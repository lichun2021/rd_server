...
@HawkConfigManager.XmlResource(file = "activity/soldier_exchange/soldier_exchange_time.xml")
public class SoldierExchangeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public SoldierExchangeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college/%s/commander_college_rank.xml", autoLoad=false, loadParams="162")
public class CommandAcademyRankScoreCfg extends HawkConfigBase {
	/** 成就id*/
	@Id
	...
	public CommandAcademyRankScoreCfg() {
		id = 0;
		rankId = 0;
		rankUpper = 0;
		rankLower = 0;

...
@HawkConfigManager.XmlResource(file = "activity/return_develop/return_develop_achieve.xml")
public class DevelopSpurtAchieveTaskConfig extends AchieveConfig {
	...
	public DevelopSpurtAchieveTaskConfig(){
		achieveId = 0;
		playerType = 0;
		conditionType = 0;
		conditionValue = "";

 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/christmas_winter_dress/christmas_winter_dress_time.xml")
public class FireReigniteTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public FireReigniteTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

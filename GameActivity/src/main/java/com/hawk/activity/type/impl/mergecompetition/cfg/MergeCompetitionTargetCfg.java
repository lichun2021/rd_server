...
@HawkConfigManager.XmlResource(file = "activity/merge_competition/%s/merge_competition_target.xml", autoLoad=false, loadParams="368")
public class MergeCompetitionTargetCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public MergeCompetitionTargetCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

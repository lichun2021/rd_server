...
@HawkConfigManager.XmlResource(file = "activity/luck_get_gold/luck_get_gold_time.xml")
public class LuckGetGoldTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id

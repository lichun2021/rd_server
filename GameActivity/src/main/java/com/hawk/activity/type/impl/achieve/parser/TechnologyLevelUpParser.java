...
public class TechnologyLevelUpParser extends AchieveParser<TechnologyLevelUpEvent> {

	@Override
	public AchieveType geAchieveType() {
		return AchieveType.TECHNOLOGY_LEVEL_UP;
	}
	...
	protected boolean updateAchieve(AchieveItem achieveItem, AchieveConfig achieveConfig, TechnologyLevelUpEvent event) {
		...
		int tchId = achieveConfig.getConditionValue(0);
		if (tchId != 0 && tchId != event.getTechId()) {
			return false;
		}

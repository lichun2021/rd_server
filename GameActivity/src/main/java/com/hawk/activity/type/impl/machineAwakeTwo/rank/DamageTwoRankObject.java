package com.hawk.activity.type.impl.machineAwakeTwo.rank;
...
public class DamageTwoRankObject {
	...
	public DamageTwoRankObject(DamageRankType rankType) {
	 ...
	 */
	 String getRankKey(int termId){
		...
		case SELF_DAMAGE_RANK:
			key = ActivityRedisKey.MACHINE_AWAKE_TWO_DAMAGE_SELF_RANK;
			break;
		case GUILD_DAMAGE_RANK:
			key = ActivityRedisKey.MACHINE_AWAKE_TWO_DAMAGE_GUILD_RANK;
			break;
		}
		return key + termId;
	}
	 ...
	 * @return
	 */
	private DamageRankInfo.Builder buildSelfRankInfo(MachineAwakeTwoEntity entity) {
	 ...
	 * @return
	 */
	public GetDamageRankInfoResp.Builder buildRankInfoResp(MachineAwakeTwoEntity entity) {

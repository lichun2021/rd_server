 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/new_order/new_order_time.xml")
public class OrderTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public OrderTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

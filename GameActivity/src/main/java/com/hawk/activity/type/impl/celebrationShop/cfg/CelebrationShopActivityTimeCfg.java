 ...
 * @author luke
 */
@HawkConfigManager.XmlResource(file = "activity/celebration_shop/celebration_shop_time.xml")
public class CelebrationShopActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public CelebrationShopActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

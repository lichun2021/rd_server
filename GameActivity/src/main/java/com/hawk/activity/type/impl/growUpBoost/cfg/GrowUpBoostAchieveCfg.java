 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/grow_up_boost/grow_up_boost_achieve.xml")
public class GrowUpBoostAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

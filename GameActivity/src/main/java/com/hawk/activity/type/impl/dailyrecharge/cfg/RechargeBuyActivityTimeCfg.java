 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/recharge_buy/recharge_buy_time.xml")
public class RechargeBuyActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public RechargeBuyActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

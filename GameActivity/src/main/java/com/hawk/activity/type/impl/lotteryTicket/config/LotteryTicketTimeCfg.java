...
*  中部养成计划
*/
@HawkConfigManager.XmlResource(file = "activity/lottery_ticket/lottery_ticket_time.xml")
public class LotteryTicketTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

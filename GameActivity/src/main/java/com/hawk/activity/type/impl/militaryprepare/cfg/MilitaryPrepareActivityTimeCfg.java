 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/military_prepare/military_prepare_activity_time.xml")
public class MilitaryPrepareActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public MilitaryPrepareActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/gold_baby_new/%s/gold_baby_new_reward.xml", autoLoad=false, loadParams="332")
public class GoldBabyNewRewardCfg extends HawkConfigBase implements HawkRandObj{

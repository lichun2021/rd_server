package com.hawk.activity.type.impl.playerComeBack.cfg.version;
...
@HawkConfigManager.XmlResource(file = "activity/return_activity/return_activity_version_time.xml")
public class PlayerComeBackVersionTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public PlayerComeBackVersionTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hot_blood_war/%s/hot_blood_war_achieve.xml", autoLoad=false, loadParams="378")
public class HotBloodWarAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

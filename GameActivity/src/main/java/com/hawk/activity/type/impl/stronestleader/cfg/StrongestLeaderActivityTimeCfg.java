 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/strongest_leader/strongest_leader_activity_time.xml")
public class StrongestLeaderActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public StrongestLeaderActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

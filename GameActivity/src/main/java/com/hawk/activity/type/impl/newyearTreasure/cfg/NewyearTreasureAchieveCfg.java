 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/newyear_treasure/newyear_treasure_achieve.xml")
public class NewyearTreasureAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public NewyearTreasureAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

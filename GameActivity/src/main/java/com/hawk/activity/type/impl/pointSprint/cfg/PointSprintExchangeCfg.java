...
@HawkConfigManager.XmlResource(file = "activity/point_sprint/point_sprint_shop.xml")
public class PointSprintExchangeCfg extends AExchangeTipConfig {
    @Id

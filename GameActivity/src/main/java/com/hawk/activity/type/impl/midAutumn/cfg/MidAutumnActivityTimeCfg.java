...
@HawkConfigManager.XmlResource(file = "activity/mid_autumn/mid_autumn_activity_time.xml")
public class MidAutumnActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public MidAutumnActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *庆典基金
 */
@HawkConfigManager.XmlResource(file = "activity/celebration_fund/celebration_fund_time.xml")
public class CelebrationFundTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

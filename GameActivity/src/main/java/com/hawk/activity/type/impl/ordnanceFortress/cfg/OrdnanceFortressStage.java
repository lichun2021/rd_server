 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/ordnance_fortress/ordnance_fortress_stage.xml")
public class OrdnanceFortressStage extends HawkConfigBase {
	// 奖励ID
	@Id
	...
	public static final int xLength = 6;
	public static final int yLength = 6;

	public OrdnanceFortressStage() {
		id = 0;
		bigAwardWeight = 0;
		bigAwardPool = 0;
		commAwards = "";

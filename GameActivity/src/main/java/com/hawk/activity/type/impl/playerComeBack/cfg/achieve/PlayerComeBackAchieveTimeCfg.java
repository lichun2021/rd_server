...
@HawkConfigManager.XmlResource(file = "activity/return_activity/return_activity_task_time.xml")
public class PlayerComeBackAchieveTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	...
	public PlayerComeBackAchieveTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/fighter_puzzle/fighter_puzzle_achieve.xml")
public class FighterPuzzleAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public FighterPuzzleAchieveCfg() {
		day = 0;
		achieveId = 0;
		conditionType = 0;
		score = 0;

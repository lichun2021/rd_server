 ...
 * @author lating
 */
@HawkConfigManager.XmlResource(file = "activity/dress_collection/dress_collection_achieve.xml")
public class DressCollectionAchieveCfg extends AchieveConfig{
	/** 成就id */
	@Id
	...
	public DressCollectionAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

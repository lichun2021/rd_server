...
*/
@HawkConfigManager.XmlResource(file = "activity/jijia_skin_activity/jijia_skin_activity_time.xml")
public class JijiaSkinActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id
    ...
    public JijiaSkinActivityTimeCfg(){
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/beauty_contest_finals/beauty_contest_finals_achieve.xml")
public class BeautyContestFinalAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public BeautyContestFinalAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

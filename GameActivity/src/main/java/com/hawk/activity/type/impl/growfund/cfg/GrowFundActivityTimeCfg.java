 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/grow_fund/growfund_activity_time.xml")
public class GrowFundActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public GrowFundActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

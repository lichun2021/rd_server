 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/evoroad/evoroad_time.xml")
public class EvolutionActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EvolutionActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

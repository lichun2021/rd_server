 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/tiberium_fortress/tiberium_fortress_time.xml")
public class PlantFortressTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

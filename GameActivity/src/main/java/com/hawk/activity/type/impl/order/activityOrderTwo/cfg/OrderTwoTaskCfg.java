 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/new_order/new_order_achieve.xml")
public class OrderTwoTaskCfg extends HawkConfigBase implements IOrderTaskCfg {
	/** 成就id */
	@Id

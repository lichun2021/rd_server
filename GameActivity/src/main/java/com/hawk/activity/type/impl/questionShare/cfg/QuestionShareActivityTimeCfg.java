...
@HawkConfigManager.XmlResource(file = "activity/question_share/question_share_time.xml")
public class QuestionShareActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public QuestionShareActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/core_explore/core_explore_time.xml")
public class CoreExploreTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

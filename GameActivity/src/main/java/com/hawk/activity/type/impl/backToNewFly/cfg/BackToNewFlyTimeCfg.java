...
*/
@HawkConfigManager.XmlResource(file = "activity/back_to_new_fly/back_to_new_fly_time.xml")
public class BackToNewFlyTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/jx_jigsaw_connect/jx_jigsaw_connect_time.xml")
public class JXJigsawConnectActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public JXJigsawConnectActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

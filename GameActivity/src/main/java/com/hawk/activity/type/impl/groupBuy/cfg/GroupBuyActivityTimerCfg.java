...
@HawkConfigManager.XmlResource(file ="activity/group_buy/group_buying_time.xml")
public class GroupBuyActivityTimerCfg extends HawkConfigBase implements IActivityTimeCfg{
	//活动期数
	@Id
	...
	public GroupBuyActivityTimerCfg() {
		this.termId = 0;
		this.showTime = "";
		this.startTime = "";
		this.endTime = "";

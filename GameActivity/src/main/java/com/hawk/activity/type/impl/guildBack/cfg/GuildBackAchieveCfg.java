...
@HawkConfigManager.XmlResource(file = "activity/guild_back/guild_back_achieve.xml")
public class GuildBackAchieveCfg  extends AchieveConfig{
    /** 成就id*/
    @Id

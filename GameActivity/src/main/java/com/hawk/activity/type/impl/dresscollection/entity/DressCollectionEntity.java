package com.hawk.activity.type.impl.dresscollection.entity;
...
@Entity
@Table(name = "activity_dress_collection")
public class DressCollectionEntity extends HawkDBEntity implements IActivityDataEntity{
	@Id
	...
	public DressCollectionEntity() {
	}
	
	public DressCollectionEntity(String playerId) {
		this.playerId = playerId;
	}
	
	public DressCollectionEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
	}

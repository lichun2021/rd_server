 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/christmas_snow_shop/christmas_snow_shop_time.xml")
public class GunpowderRiseTwoTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数 */
	@Id
	...
	public GunpowderRiseTwoTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

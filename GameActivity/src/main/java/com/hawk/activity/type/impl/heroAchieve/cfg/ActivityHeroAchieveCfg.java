 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_achieve/%s/hero_achieve.xml", autoLoad=false, loadParams="29")
public class ActivityHeroAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

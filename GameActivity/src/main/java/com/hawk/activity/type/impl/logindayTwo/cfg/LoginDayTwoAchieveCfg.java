 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/login_day_two/login_day_two_achieve.xml")
public class LoginDayTwoAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id

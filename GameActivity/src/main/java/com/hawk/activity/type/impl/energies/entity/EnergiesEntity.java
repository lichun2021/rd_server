package com.hawk.activity.type.impl.energies.entity;
...
@Entity
@Table(name = "activity_energies")
public class EnergiesEntity extends HawkDBEntity implements IActivityDataEntity{
	@Id
	...
	public EnergiesEntity() {
		this.itemList = new ArrayList<>();
	}
	
	public EnergiesEntity(String playerId) {
		this.playerId = playerId;
		this.achieveItems = "";
		this.itemList = new ArrayList<>();
	}
	
	public EnergiesEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.achieveItems = "";
		this.itemList = new ArrayList<>();

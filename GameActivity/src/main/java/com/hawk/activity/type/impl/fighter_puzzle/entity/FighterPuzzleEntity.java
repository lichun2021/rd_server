package com.hawk.activity.type.impl.fighter_puzzle.entity;
...
@Entity
@Table(name = "activity_fighter_puzzle")
public class FighterPuzzleEntity extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public FighterPuzzleEntity() {
	}

	public FighterPuzzleEntity(String playerId, int termId) {

...
public class NewbieEquipTrainTimesParser extends AchieveParser<NewbieTrainEvent> {

	@Override
	public AchieveType geAchieveType() {
		return AchieveType.NOVICE_EQUIP_TRAINING_TIMES;
	}
	...
	protected boolean updateAchieve(AchieveItem achieveItem, AchieveConfig achieveConfig, NewbieTrainEvent event) {
		if (event.getType() == NoviceTrainType.TYPE_EQUIP_VALUE) {

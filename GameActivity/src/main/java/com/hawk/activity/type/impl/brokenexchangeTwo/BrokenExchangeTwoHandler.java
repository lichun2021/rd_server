...
public class BrokenExchangeTwoHandler extends ActivityProtocolHandler {
	@ProtocolHandler(code = HP.code.BROKEN_EXCHANGE_TWO_REQ_VALUE)
	public void brokenExchange(HawkProtocol protocol, String playerId) {
		BrokenExchangeTwoActivity activity = getActivity(ActivityType.BROKEN_EXCHANGE_TWO_ACTIVITY);

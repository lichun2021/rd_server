 ...
 *
 */
public class MachineAwakeTwoHandler extends ActivityProtocolHandler {
	 ...
	 * @return
	 */
	@ProtocolHandler(code = HP.code.MACHINE_AWAKE_TWO_GET_PAGE_INFO_C_VALUE)
	public boolean onGetStageInfo(HawkProtocol protocol, String playerId) {
		MachineAwakeTwoActivity activity = getActivity(ActivityType.MACHINE_AWAKE_TWO_ACTIVITY);
	 ...
	 * @return
	 */
	@ProtocolHandler(code = HP.code.MACHINE_AWAKE_TWO_GET_RANK_INFO_C_VALUE)

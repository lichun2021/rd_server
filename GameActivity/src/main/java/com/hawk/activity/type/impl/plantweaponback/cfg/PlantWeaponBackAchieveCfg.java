...
@HawkConfigManager.XmlResource(file = "activity/plant_weapon_back/plant_weapon_back_achieve.xml")
public class PlantWeaponBackAchieveCfg extends AchieveConfig {
	...
	public PlantWeaponBackAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

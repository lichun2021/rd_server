package com.hawk.activity.type.impl.heroWish.entity;
...
@Entity
@Table(name="activity_hero_wish")
public class HeroWishEntity extends  ActivityDataEntity {
    ...
    @IndexProp(id = 5)
	@Column(name = "addCount", nullable = false)
	private int addCount;
	
    @IndexProp(id = 6)
	@Column(name = "achieveCount", nullable = false)
	...
	public HeroWishEntity() {
	}
	
	public HeroWishEntity(String playerId, int termId) {

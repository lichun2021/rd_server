 ...
 * @author che
 */
@HawkConfigManager.XmlResource(file = "activity/merge_announce/merge_announce_time.xml")
public class MergeAnnounceTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

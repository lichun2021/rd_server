 ...
 * @author Winder
 */
@HawkConfigManager.XmlResource(file = "activity/mid_autumn/mid_autumn_achieve.xml")
public class MidAutumnAchieveCfg extends AchieveConfig{
	/** 成就id */
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/versionOftaste/versionOftaste_activity_time.xml")
public class NewlyExperienceTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/accumulate_consume_achieve/consume_activity_time.xml")
public class AccumulateConsumeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public AccumulateConsumeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

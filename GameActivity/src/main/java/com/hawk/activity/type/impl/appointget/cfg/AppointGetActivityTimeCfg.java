...
@HawkConfigManager.XmlResource(file = "activity/appoint_get/appoint_get_time.xml")
public class AppointGetActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public AppointGetActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
@HawkConfigManager.XmlResource(file = "activity/gold_baby/gold_baby_time.xml")
public class GoldBabyTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

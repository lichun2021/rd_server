...
@HawkConfigManager.XmlResource(file = "activity/gold_baby_new/%s/gold_baby_new_cumulative.xml", autoLoad=false, loadParams="332")
public class GoldBabyNewCumulativeCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public GoldBabyNewCumulativeCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

...
@HawkConfigManager.XmlResource(file ="activity/blessing/blessing_activity_time.xml")
public class GreetingsActivityTimerCfg extends HawkConfigBase implements IActivityTimeCfg{
	//活动期数
	@Id
	...
	public GreetingsActivityTimerCfg() {
		this.termId = 0;
		this.showTime = "";
		this.startTime = "";
		this.endTime = "";

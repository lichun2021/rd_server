...
@HawkConfigManager.XmlResource(file = "activity/back_gift_activity/back_gift_activity_date.xml")
public class BackGfitDateCfg extends HawkConfigBase{
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_love/hero_love_level_reward.xml")
public class HeroLoveLevelRewardCfg extends AchieveConfig {
	/** */
	@Id

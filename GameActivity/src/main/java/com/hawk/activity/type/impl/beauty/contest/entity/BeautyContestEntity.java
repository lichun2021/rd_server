package com.hawk.activity.type.impl.beauty.contest.entity;
...
@Entity
@Table(name="activity_beauty_contest")
public class BeautyContestEntity extends HawkDBEntity implements IActivityDataEntity {
	...
	public BeautyContestEntity() {
	}
	
	public BeautyContestEntity(String playerId, int termId) {

...
@HawkConfigManager.XmlResource(file = "activity/medal_invest_two/medal_invest_two_reward.xml")
public class MedalFundTwoRewardCfg extends HawkConfigBase {
	@Id

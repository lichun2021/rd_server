...
@HawkConfigManager.XmlResource(file = "activity/recharge_qixi/recharge_qixi_time.xml")
public class RechargeQixiActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public RechargeQixiActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

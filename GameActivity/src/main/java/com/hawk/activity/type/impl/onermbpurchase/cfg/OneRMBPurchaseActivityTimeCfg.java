 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/one_rmb/one_rmb_time.xml")
public class OneRMBPurchaseActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public OneRMBPurchaseActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/appoint_get/appoint_get_box.xml")
public class AppointGetBoxCfg extends AchieveConfig {
	// <data achieveId="331501" conditionType="1" conditionValue="300" rewards="30000_1400009_1" />
	/** 成就id*/
	@Id

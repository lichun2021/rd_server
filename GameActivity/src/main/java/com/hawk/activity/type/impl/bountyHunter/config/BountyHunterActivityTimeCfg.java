...
@HawkConfigManager.XmlResource(file = "activity/bounty_hunter/bounty_hunter_activity_time.xml")
public class BountyHunterActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public BountyHunterActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

package com.hawk.activity.type.impl.drogenBoatFestival.benefit.cfg;
 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_shop/dw_shop_time.xml")
public class DragonBoatBenefitTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DragonBoatBenefitTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

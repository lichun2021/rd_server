...
@HawkConfigManager.XmlResource(file = "activity/spread/spread_time.xml")
public class SpreadActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/pioneer_gift/pioneer_gift_acc_reward.xml")
public class PioneerGiftAccRewardCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public PioneerGiftAccRewardCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

...
@HawkConfigManager.XmlResource(file = "activity/universal_exchange_two/universal_exchange_two_time.xml")
public class CommonExchangeTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public CommonExchangeTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 * @author lating
 */
@HawkConfigManager.XmlResource(file = "activity/dress_collection_new/dress_collection_new_achieve.xml")
public class DressCollectionTwoAchieveCfg extends AchieveConfig{
	/** 成就id */
	@Id
	...
	public DressCollectionTwoAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

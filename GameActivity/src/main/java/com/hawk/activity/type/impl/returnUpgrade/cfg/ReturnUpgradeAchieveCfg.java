...
@HawkConfigManager.XmlResource(file = "activity/return_upgrade/return_upgrade_achieve.xml")
public class ReturnUpgradeAchieveCfg  extends AchieveConfig{
    /** 成就id*/
    @Id
    ...
    protected boolean assemble() {
        try {
            conditionAchieveType = AchieveType.getType(conditionType);
            if (conditionAchieveType == null) {

...
@HawkConfigManager.XmlResource(file ="activity/season_picture_puzzle/season_picture_puzzle_time.xml")
public class SeasonPuzzleTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	//活动期数
	@Id

package com.hawk.activity.type.impl.festivalTwo.entity;
...
@Entity
@Table(name = "activity_festival_two")
public class FestivalTwoEntity  extends HawkDBEntity implements IActivityDataEntity{
	...
	public FestivalTwoEntity() {
	}
	
	public FestivalTwoEntity(String playerId, int termId) {

...
@HawkConfigManager.XmlResource(file = "activity/flag_god/activity_flaggod_time.xml")
public class ActivityBannerKillTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public ActivityBannerKillTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 * @author hf
 */
@HawkConfigManager.XmlResource(file = "activity/ssy_jigsaw_connect/ssy_jigsaw_connect_time.xml")
public class JigsawConnectActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public JigsawConnectActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

...
*  中部养成计划
*/
@HawkConfigManager.XmlResource(file = "activity/back_immgration/back_immgration_time.xml")
public class BackImmgrationTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

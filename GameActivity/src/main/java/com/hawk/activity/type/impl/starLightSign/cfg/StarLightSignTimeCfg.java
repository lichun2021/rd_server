...
@HawkConfigManager.XmlResource(file = "activity/starlight_sign/starlight_time.xml")
public class StarLightSignTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

...
@HawkConfigManager.XmlResource(file = "activity/medal_invest_two/medal_invest_two_menu.xml")
public class MedalFundTwoMenuCfg extends HawkConfigBase {
	// 礼包ID
	@Id 

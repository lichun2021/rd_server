 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/hero_theme/hero_theme_time.xml")
public class HeroThemeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public HeroThemeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

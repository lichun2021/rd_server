 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/recharge_buy_new/recharge_buy_new_achieve.xml")
public class RechargeBuyNewAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public RechargeBuyNewAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

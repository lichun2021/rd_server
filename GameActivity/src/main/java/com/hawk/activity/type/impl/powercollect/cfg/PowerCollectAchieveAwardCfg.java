...
@HawkConfigManager.XmlResource(file = "activity/super_lab/super_lab_award.xml")
public class PowerCollectAchieveAwardCfg extends AchieveConfig {
	...
	public PowerCollectAchieveAwardCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

...
@HawkConfigManager.XmlResource(file = "activity/hellfire/activity_hellfire_condition.xml")
public class ActivityHellFireConditionCfg extends HawkConfigBase {
	/**
	 * 条件
	 */
	@Id
	...
	public ActivityHellFireConditionCfg() {

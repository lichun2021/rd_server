 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_four/url_model_four_time.xml")
public class UrlModelFourActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelFourActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/send_flower/send_flower_time.xml")
public class SendFlowerActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public SendFlowerActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

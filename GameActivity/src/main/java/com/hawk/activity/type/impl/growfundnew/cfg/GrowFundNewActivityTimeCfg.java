 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/new_grow_fund/%s/new_growfund_activity_time.xml", autoLoad=false, loadParams="263")
public class GrowFundNewActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public GrowFundNewActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

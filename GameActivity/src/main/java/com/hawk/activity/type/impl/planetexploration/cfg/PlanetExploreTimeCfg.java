...
@HawkConfigManager.XmlResource(file = "activity/planet_exploration/planet_exploration_time.xml")
public class PlanetExploreTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

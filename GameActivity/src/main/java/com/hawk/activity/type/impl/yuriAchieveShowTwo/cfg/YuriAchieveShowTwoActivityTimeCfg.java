 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/yuri_achieve_show_two/yuri_show_two_activity_time.xml")
public class YuriAchieveShowTwoActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public YuriAchieveShowTwoActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

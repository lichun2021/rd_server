 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/machine_awake/machine_awake_time.xml")
public class MachineAwakeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public MachineAwakeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

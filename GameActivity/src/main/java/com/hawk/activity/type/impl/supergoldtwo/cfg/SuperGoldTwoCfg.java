...
@HawkConfigManager.XmlResource(file = "activity/super_gold_two/%s/super_gold_two.xml", autoLoad=false, loadParams="210")
public class SuperGoldTwoCfg extends HawkConfigBase {

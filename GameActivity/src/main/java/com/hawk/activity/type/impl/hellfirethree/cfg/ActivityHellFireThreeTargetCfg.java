...
@HawkConfigManager.XmlResource(file = "activity/hellfire_thr/activity_hellfire_thr_target.xml")
public class ActivityHellFireThreeTargetCfg extends HawkConfigBase {
	/**
	 * 目标id
	 */
	@Id
	...
	public ActivityHellFireThreeTargetCfg() {
		this.id = 0;
		this.targetId = 0;
		this.lvMax = 0;
		this.lvMin = 0;
	...
	public boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("ActivityHellFireThreeTargetCfg reward error, id: %s , reward: %s", id, reward));
		}

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/fighter_puzzle/fighter_puzzle_score.xml")
public class FighterPuzzleScoreCfg extends AchieveConfig {
	/** */
	@Id

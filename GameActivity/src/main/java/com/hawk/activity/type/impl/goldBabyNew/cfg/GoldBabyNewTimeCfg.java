...
@HawkConfigManager.XmlResource(file = "activity/gold_baby_new/%s/gold_baby_new_time.xml", autoLoad=false, loadParams="332")
public class GoldBabyNewTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

 ...
 *
 */
public class AttackNewMonsterLvlParser extends AchieveParser<MonsterAttackEvent> {
	
	@Override
	public AchieveType geAchieveType() {
		return AchieveType.ATTACK_NEW_MONSTER_LEVEL;
	}
	...
	protected boolean updateAchieve(AchieveItem achieveData, AchieveConfig achieveConfig, MonsterAttackEvent event) {
		...
		if (monsterType != MonsterType.TYPE_7_VALUE && monsterType != MonsterType.TYPE_11_VALUE) {

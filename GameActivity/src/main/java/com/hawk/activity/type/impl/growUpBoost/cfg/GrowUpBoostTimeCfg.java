...
*  中部养成计划
*/
@HawkConfigManager.XmlResource(file = "activity/grow_up_boost/grow_up_boost_time.xml")
public class GrowUpBoostTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/commander_college_cut/%s/commander_college_cut_achieve.xml", autoLoad=false, loadParams="284")
public class CommandAcademySimplifyAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public CommandAcademySimplifyAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/rose/rose_time.xml")
public class DomeActivityTwoTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

package com.hawk.activity.type.impl.brokenexchange.cfg;
 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/exchange/broken_exchange_activity_time.xml")
public class ActivityExchangeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ActivityExchangeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

package com.hawk.activity.type.impl.domeExchangeTwo.entity;
...
@Entity
@Table(name="activity_dome_exchange_two")
public class DomeExchangeTwoEntity extends HawkDBEntity implements IActivityDataEntity {
	@Id
	...
	public DomeExchangeTwoEntity(){}
	
	public DomeExchangeTwoEntity(String playerId, int termId) {

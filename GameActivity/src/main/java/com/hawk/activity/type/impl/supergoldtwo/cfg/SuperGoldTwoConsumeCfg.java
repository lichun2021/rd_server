...
@HawkConfigManager.XmlResource(file = "activity/super_gold_two/%s/super_gold_two_consumer.xml", autoLoad=false, loadParams="210")
public class SuperGoldTwoConsumeCfg extends AchieveConfig{

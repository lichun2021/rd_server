 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/time_limit_drop/time_limit_drop_award.xml")
public class TimeLimitDroAwardCfg extends AchieveConfig {
	/** 成就id */
	@Id

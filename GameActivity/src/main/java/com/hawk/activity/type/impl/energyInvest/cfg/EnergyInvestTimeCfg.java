...
@HawkConfigManager.XmlResource(file = "activity/power_invest/power_invest_time.xml")
public class EnergyInvestTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

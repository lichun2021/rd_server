 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/alliance_boss/alliance_boss_time.xml")
public class GuildDragonAttackTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public GuildDragonAttackTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

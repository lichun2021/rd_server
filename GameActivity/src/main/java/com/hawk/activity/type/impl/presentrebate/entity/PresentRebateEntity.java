package com.hawk.activity.type.impl.presentrebate.entity;
...
@Entity
@Table(name = "activity_present_rebate")
public class PresentRebateEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	...
	public PresentRebateEntity() {
	}
	public PresentRebateEntity(String playerId, int termId) {

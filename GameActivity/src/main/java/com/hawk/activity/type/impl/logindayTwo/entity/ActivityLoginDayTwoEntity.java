package com.hawk.activity.type.impl.logindayTwo.entity;
 ...
 */
@Entity
@Table(name = "activity_login_day_two")
public class ActivityLoginDayTwoEntity extends AchieveActivityEntity implements IActivityDataEntity{
	...
	public ActivityLoginDayTwoEntity() {
	}
	
	public ActivityLoginDayTwoEntity(String playerId, int termId) {

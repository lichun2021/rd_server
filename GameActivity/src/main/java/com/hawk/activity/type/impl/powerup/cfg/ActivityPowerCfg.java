 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/power/%s/activity_power.xml", autoLoad=false, loadParams="19")
public class ActivityPowerCfg extends AchieveConfig {
	/** 成就id*/
	@Id

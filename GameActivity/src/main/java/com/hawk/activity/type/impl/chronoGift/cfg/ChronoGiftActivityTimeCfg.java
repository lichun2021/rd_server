 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/space_gift/space_gift_time.xml")
public class ChronoGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ChronoGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

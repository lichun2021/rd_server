...
@HawkConfigManager.XmlResource(file = "activity/exchange_two/%s/activity_item_collect_two.xml", autoLoad=false, loadParams="61")
public class ActivityItemCollectTwoCfg extends HawkConfigBase {
	/**
	 * 操作ID
	 */
	...
	public ActivityItemCollectTwoCfg() {
		this.id = 0;
		this.name = "";
		this.dropParam = 0;
		this.dropLimit = 0;

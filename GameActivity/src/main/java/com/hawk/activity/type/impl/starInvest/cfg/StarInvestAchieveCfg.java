...
@HawkConfigManager.XmlResource(file = "activity/star_invest/star_invest_achieve.xml")
public class StarInvestAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/j20_celebration/j20_celebration_achieve.xml")
public class FlightPlanAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

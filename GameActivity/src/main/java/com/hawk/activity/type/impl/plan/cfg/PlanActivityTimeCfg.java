...
@HawkConfigManager.XmlResource(file = "activity/plan/plan_activity_time.xml")
public class PlanActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

 ...
 * 双享豪礼成就配置
 */
@HawkConfigManager.XmlResource(file = "activity/double_gift/double_gift_achieve.xml")
public class DoubleGiftAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

package com.hawk.activity.type.impl.urlModelNine.cfg;
 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/url_model_nine/url_model_nine_time.xml")
public class UrlModelNineActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public UrlModelNineActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

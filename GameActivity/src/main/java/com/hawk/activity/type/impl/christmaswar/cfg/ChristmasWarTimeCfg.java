...
@HawkConfigManager.XmlResource(file = "activity/christmas_war/christmas_war_time.xml")
public class ChristmasWarTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

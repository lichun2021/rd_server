 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_topup/dw_topup_time.xml")
public class DragonBoatRechargeTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DragonBoatRechargeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

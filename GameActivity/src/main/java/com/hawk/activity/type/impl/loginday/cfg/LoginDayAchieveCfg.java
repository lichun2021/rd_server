 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/login_day/%s/login_day_achieve.xml", autoLoad=false, loadParams="7")
public class LoginDayAchieveCfg extends AchieveConfig {

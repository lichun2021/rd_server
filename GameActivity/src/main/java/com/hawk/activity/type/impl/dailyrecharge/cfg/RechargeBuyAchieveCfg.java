 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/recharge_buy/recharge_buy_achieve.xml")
public class RechargeBuyAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/medal_action/medal_action_cell_cfg.xml")
public class MedalActionLotteryCfg extends HawkConfigBase {
	/** 格子id*/
	@Id

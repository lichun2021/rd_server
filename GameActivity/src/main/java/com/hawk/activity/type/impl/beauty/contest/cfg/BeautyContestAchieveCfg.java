...
@HawkConfigManager.XmlResource(file = "activity/beauty_contest/beauty_contest_achieve.xml")
public class BeautyContestAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public BeautyContestAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

...
@HawkConfigManager.XmlResource(file = "activity/the_best_prize/the_best_prize_time.xml")
public class BestPrizeTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id

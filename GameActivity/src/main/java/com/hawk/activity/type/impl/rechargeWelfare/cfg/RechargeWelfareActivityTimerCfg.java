...
@HawkConfigManager.XmlResource(file ="activity/recharge_welfare/recharge_welfare_time.xml")
public class RechargeWelfareActivityTimerCfg extends HawkConfigBase implements IActivityTimeCfg{
	//活动期数
	@Id
	...
	public RechargeWelfareActivityTimerCfg() {
		this.termId = 0;
		this.showTime = "";
		this.startTime = "";
		this.endTime = "";

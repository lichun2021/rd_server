 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/double_recharge/double_recharge_activity_time.xml")
public class DoubleRechargeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DoubleRechargeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

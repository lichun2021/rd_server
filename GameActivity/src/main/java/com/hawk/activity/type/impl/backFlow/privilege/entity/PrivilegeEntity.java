package com.hawk.activity.type.impl.backFlow.privilege.entity;
...
@Entity
@Table(name = "activity_back_privilege")
public class PrivilegeEntity  extends AchieveActivityEntity implements IActivityDataEntity {
	 ...
	 */
    @IndexProp(id = 7)
	@Column(name = "buffStartTime", nullable = false)
	...
	public PrivilegeEntity(String playerId) {
		this.playerId = playerId;
	}
	
	public PrivilegeEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
	}

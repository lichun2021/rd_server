 ...
 * 新首充时间配置
 */
@HawkConfigManager.XmlResource(file = "activity/first_recharge_three/first_recharge_three_time.xml")
public class FirstRechargeThreeTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id
    ...
    public FirstRechargeThreeTimeCfg(){
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

...
public class DomeExchangeHandler extends ActivityProtocolHandler {
	 ...
	 * @param playerId
	 */
	@ProtocolHandler(code = HP.code.DOME_EXCHANGE_TIPS_C_VALUE)
	public void domeExchangePlayerTips(HawkProtocol protocol, String playerId){
		DomeExchangeActivity activity = getActivity(ActivityType.DOME_EXCHANGE);
	 ...
	 * @param playerId
	 */
	@ProtocolHandler(code = HP.code.DOME_EXCHANGE_EXCHANGE_VALUE)

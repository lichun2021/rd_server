...
@HawkConfigManager.XmlResource(file = "activity/quest_treasure/quest_treasure_time.xml")
public class QuestTreasureTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/equip_order/equip_order_level.xml")
public class OrderEquipLevelCfg extends HawkConfigBase {
	/** 成就id */
	@Id

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/joy_exchange/joy_exchange_time.xml")
public class JoyBuyActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

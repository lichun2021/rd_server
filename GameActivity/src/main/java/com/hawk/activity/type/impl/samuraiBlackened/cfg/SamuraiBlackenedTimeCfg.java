 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/samurai_blackened/samurai_blackened_time.xml")
public class SamuraiBlackenedTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public SamuraiBlackenedTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

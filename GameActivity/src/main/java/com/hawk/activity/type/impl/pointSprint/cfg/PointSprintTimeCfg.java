...
@HawkConfigManager.XmlResource(file = "activity/point_sprint/point_sprint_time.xml")
public class PointSprintTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id

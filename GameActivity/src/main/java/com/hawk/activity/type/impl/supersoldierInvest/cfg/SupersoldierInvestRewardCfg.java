...
@HawkConfigManager.XmlResource(file = "activity/mecha_invest/mecha_invest_reward.xml")
public class SupersoldierInvestRewardCfg extends HawkConfigBase {
	@Id
	...
	public SupersoldierInvestRewardCfg(){
		id = 0;
		day = 0;
		pool = 0;
		first = "";

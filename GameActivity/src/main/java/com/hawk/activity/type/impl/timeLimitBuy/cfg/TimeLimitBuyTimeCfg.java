 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/time_limit_buy/time_limit_buy_time.xml")
public class TimeLimitBuyTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/hellfire_thr/activity_hellfire_thr_time.xml")
public class ActivityHellFireThreeTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public ActivityHellFireThreeTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

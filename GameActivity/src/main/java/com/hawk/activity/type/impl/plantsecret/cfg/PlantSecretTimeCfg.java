 ...
 * @author lating
 */
@HawkConfigManager.XmlResource(file = "activity/taineng_secret/taineng_secret_time.xml")
public class PlantSecretTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /**
     * 活动期数
     */
    @Id

...
*/
@HawkConfigManager.XmlResource(file = "activity/new_start/new_start_time.xml")
public class NewStartTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
    /** 活动期数*/
    @Id

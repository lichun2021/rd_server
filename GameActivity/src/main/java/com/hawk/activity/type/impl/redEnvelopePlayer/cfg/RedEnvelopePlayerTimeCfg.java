...
@HawkConfigManager.XmlResource(file = "activity/playerRedPacket/playerRedPacket_activity_time.xml")
public class RedEnvelopePlayerTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public RedEnvelopePlayerTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

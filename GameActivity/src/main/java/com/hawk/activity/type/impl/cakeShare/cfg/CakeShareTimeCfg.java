 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/celebration_receive_cake/celebration_receive_cake_time.xml")
public class CakeShareTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/plant_weapon_back/plant_weapon_back_time.xml")
public class PlantWeaponBackTimeCfg extends HawkConfigBase implements IActivityTimeCfg {

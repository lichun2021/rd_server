 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/red_recharge/red_recharge_box_reward.xml")
public class HappyRedRechargeScoreCfg extends AchieveConfig {
	@Id
	...
	public HappyRedRechargeScoreCfg() {
		achieveId = 0;
		rewards = "";
		conditionType = 0;
		conditionValue = "";

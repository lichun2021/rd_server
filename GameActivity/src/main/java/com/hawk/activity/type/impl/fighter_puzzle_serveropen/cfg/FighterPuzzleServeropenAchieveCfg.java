 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/fighter_puzzle_sopen/%s/fighter_puzzle_sopen_achieve.xml", autoLoad=false, loadParams="282")
public class FighterPuzzleServeropenAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public FighterPuzzleServeropenAchieveCfg() {
		day = 0;
		achieveId = 0;
		conditionType = 0;
		score = 0;

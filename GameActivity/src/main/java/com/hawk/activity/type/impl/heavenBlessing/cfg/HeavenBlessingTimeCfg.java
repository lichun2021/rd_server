 ...
 * @author Leon
 */
@HawkConfigManager.XmlResource(file = "activity/heaven_blessing/heaven_blessing_time.xml")
public class HeavenBlessingTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /** 活动期数*/
    @Id

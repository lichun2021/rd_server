...
@HawkConfigManager.XmlResource(file = "activity/strongpoint/strongpoint_activity_achieve.xml")
public class StrongpointActivityAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	...
	public StrongpointActivityAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

...
@HawkConfigManager.XmlResource(file = "activity/hellfire/activity_hellfire_time.xml")
public class ActivityHellFireTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public ActivityHellFireTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

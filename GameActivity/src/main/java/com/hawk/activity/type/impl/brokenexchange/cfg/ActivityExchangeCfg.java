...
@HawkConfigManager.XmlResource(file = "activity/exchange/activity_exchange.xml")
public class ActivityExchangeCfg extends HawkConfigBase {
	/**
	 * 唯一ID
	 */
	@Id

 ...
 * 双享豪礼活动配置
 */
@HawkConfigManager.XmlResource(file = "activity/double_gift/double_gift_time.xml")
public class DoubleGiftActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DoubleGiftActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/jx_jigsaw_connect/jx_jigsaw_connect_achieve.xml")
public class JXJigsawConnectAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public JXJigsawConnectAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

 ...
 * @author luke
 */
@HawkConfigManager.XmlResource(file = "activity/arms_upgrade/arms_upgrade_time.xml")
public class ArmamentExchangeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ArmamentExchangeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

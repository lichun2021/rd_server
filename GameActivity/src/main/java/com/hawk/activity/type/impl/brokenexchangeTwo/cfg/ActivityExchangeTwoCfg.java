...
@HawkConfigManager.XmlResource(file = "activity/exchange_two/%s/activity_exchange_two.xml", autoLoad=false, loadParams="61")
public class ActivityExchangeTwoCfg extends HawkConfigBase {
	/**
	 * 唯一ID
	 */
	@Id

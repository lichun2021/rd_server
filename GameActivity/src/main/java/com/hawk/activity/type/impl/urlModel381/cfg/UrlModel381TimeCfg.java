 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/act_381/act_381_time.xml")
public class UrlModel381TimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

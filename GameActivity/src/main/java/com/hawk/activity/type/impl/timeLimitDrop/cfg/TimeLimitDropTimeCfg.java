...
@HawkConfigManager.XmlResource(file = "activity/time_limit_drop/time_limit_drop_time.xml")
public class TimeLimitDropTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

...
@HawkConfigManager.XmlResource(file = "activity/radiation_war_two/radiation_war_two_achieve.xml")
public class RadiationWarTwoAchieveCfg extends AchieveConfig {
	/** 成就id */
	@Id
	private final int achieveId;

	/** 成就类型  1个人每日任务  2联盟击杀任务*/
	...
	public RadiationWarTwoAchieveCfg() {
		achieveId = 0;
		type = 0;
		conditionType = 0;
		conditionValue = "";

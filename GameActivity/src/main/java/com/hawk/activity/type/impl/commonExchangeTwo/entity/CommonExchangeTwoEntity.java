package com.hawk.activity.type.impl.commonExchangeTwo.entity;
...
@Entity
@Table(name="activity_common_exchange_two")
public class CommonExchangeTwoEntity extends HawkDBEntity implements IActivityDataEntity {
	...
	public CommonExchangeTwoEntity(){}
	
	public CommonExchangeTwoEntity(String playerId, int termId) {

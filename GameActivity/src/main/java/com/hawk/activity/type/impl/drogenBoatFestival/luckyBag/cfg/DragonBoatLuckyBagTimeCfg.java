 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/dw_gold/dw_gold_time.xml")
public class DragonBoatLuckyBagTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public DragonBoatLuckyBagTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

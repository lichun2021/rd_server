...
@HawkConfigManager.XmlResource(file = "activity/new_year_lottery/new_year_lottery_time.xml")
public class NewyearLotteryActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	...
	public NewyearLotteryActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/gift_rebate/gift_rebate_achieve.xml")
public class PresentRebateAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id
	...
	public PresentRebateAchieveCfg() {
		achieveId = 0;
		conditionType = 0;
		conditionValue = "";
		rewards = "";

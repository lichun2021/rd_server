...
@HawkConfigManager.XmlResource(file = "activity/honor_repay/honor_repay_time.xml")
public class HonorRepayTimeCfg extends HawkConfigBase implements IActivityTimeCfg{

...
@HawkConfigManager.XmlResource(file = "activity/hero_back/hero_back_activity_time.xml")
public class HeroBackActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	@Id
	...
	public HeroBackActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

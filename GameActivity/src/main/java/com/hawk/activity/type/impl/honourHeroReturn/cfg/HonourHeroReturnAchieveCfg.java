 ...
 * @author richard
 */
@HawkConfigManager.XmlResource(file = "activity/honour_hero_return/honour_hero_return_achieve.xml")
public class HonourHeroReturnAchieveCfg extends AchieveConfig {
    /**
     * 成就id
     */
    @Id
    ...
    public HonourHeroReturnAchieveCfg() {
        achieveId = 0;
        conditionType = 0;
        conditionValue = "";
        rewards = "";

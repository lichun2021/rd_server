package com.hawk.activity.type.impl.rechargeGift.entity;
...
@Entity
@Table(name = "activity_recharge_gift")
public class RechargeGiftEntity extends AchieveActivityEntity implements IActivityDataEntity {
	 ...
	 */
    @IndexProp(id = 4)
	@Column(name = "rechargeTotal", nullable = false)
	...
	public RechargeGiftEntity() {
	}
	
	public RechargeGiftEntity(String playerId) {
		this.playerId = playerId;
		this.achieveItems = "";
	}
	
	public RechargeGiftEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.achieveItems = "";
	}

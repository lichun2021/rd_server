 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/invest/activity_invest_time.xml")
public class InvestActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id

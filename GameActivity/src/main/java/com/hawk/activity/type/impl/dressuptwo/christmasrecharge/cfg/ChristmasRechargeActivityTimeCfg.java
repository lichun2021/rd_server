 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/christmas_recharge/christmas_recharge_time.xml")
public class ChristmasRechargeActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public ChristmasRechargeActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

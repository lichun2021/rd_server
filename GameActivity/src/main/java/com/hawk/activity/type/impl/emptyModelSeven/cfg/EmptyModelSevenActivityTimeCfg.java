 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/empty_model_seven/empty_model_seven_activity_time.xml")
public class EmptyModelSevenActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public EmptyModelSevenActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

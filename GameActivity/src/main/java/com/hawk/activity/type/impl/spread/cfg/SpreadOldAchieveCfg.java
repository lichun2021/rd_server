 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/spread/spread_old_achieve.xml")
public class SpreadOldAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

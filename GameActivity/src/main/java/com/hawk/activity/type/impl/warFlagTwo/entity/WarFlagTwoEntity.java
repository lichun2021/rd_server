package com.hawk.activity.type.impl.warFlagTwo.entity;
 ...
 */
@Entity
@Table(name="activity_war_flag_two")
public class WarFlagTwoEntity extends HawkDBEntity implements IActivityDataEntity {
	@Id
	...
	public WarFlagTwoEntity(){}
	
	public WarFlagTwoEntity(String playerId, int termId) {

...
@HawkConfigManager.XmlResource(file = "activity/time_limit_login/time_limit_login_time.xml")
public class TimeLimitLoginTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id

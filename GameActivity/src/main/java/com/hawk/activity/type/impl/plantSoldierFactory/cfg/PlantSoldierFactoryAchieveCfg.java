...
@HawkConfigManager.XmlResource(file = "activity/plant_soldier_factory/plant_soldier_factory_achieve.xml")
public class PlantSoldierFactoryAchieveCfg  extends AchieveConfig{
    /** 成就id*/
    @Id
    ...
    public PlantSoldierFactoryAchieveCfg(){
        achieveId = 0;
        conditionType = 0;
        conditionValue = "";
        rewards = "";

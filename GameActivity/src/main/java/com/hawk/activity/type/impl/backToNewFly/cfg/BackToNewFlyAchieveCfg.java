...
@HawkConfigManager.XmlResource(file = "activity/back_to_new_fly/back_to_new_fly_achieve.xml")
public class BackToNewFlyAchieveCfg  extends AchieveConfig{
    /** 成就id*/
    @Id
    ...
    private final int baseCondition;

    private final int baseConditionUp;
    ...
    public int getBaseCondition() {
        return baseCondition;
    }

    public int getBaseConditionUp() {
        return baseConditionUp;
    }
}
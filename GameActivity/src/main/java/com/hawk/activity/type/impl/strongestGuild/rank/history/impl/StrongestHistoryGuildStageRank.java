...
public class StrongestHistoryGuildStageRank implements StrongestHistoryRank {

	private int termId;
	
	private int stageId;
	
	public StrongestHistoryGuildStageRank(int termId, int stageId){
		this.termId = termId;
	...
	public String toString() {
		return "StrongestHistoryGuildStageRank [termId=" + termId + ", stageId=" + stageId + "]";
	}
}

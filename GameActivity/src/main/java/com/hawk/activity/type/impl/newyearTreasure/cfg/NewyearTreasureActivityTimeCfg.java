 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/newyear_treasure/newyear_treasure_activity_time.xml")
public class NewyearTreasureActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public NewyearTreasureActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

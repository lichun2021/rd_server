...
@HawkConfigManager.XmlResource(file = "activity/medal_invest/medal_invest_menu.xml")
public class MedalFundMenuCfg extends HawkConfigBase {
	// 礼包ID
	@Id 

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/ordnance_fortress/ordnance_fortress_time.xml")
public class OrdnanceFortressTimeCfg extends HawkConfigBase implements IActivityTimeCfg{
	/** 活动期数*/
	@Id
	...
	public OrdnanceFortressTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

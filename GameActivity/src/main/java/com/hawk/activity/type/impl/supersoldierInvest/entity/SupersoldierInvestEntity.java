package com.hawk.activity.type.impl.supersoldierInvest.entity;
...
@Entity
@Table(name = "activity_supersoldier_invest")
public class SupersoldierInvestEntity extends HawkDBEntity implements IActivityDataEntity{
	@Id
	...
	public SupersoldierInvestEntity() {
	}
	
	public SupersoldierInvestEntity(String playerId) {
		this.playerId = playerId;
		this.daliyTaskMap = new HashMap<>();
		this.buyInfoMap = new HashMap<>();
	}
	
	public SupersoldierInvestEntity(String playerId, int termId) {
		this.playerId = playerId;
		this.termId = termId;
		this.daliyTaskMap = new HashMap<>();
		this.buyInfoMap = new HashMap<>();

 ...
 * @author richard
 */
@HawkConfigManager.XmlResource(file = "activity/honour_hero_return/honour_hero_return_time.xml")
public class HonourHeroReturnTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
    /**
     * 活动期数
     */
    @Id
    ...
    public HonourHeroReturnTimeCfg() {
        termId = 0;
        showTime = "";
        startTime = "";
        endTime = "";

 ...
 * @author richard
 */
@HawkConfigManager.XmlResource(file = "activity/honour_hero_return/honour_hero_return_exchange.xml")
public class HonourHeroReturnExchangeCfg extends HawkConfigBase {
    /**
     * 唯一ID
     */
    @Id
    ...
    public HonourHeroReturnExchangeCfg() {
        id = 0;
        needItem = "";
        gainItem = "";
        times = 0;

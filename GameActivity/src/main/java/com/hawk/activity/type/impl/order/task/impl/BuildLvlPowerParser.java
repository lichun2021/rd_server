...
public class BuildLvlPowerParser implements OrderTaskParser<BuildingLevelUpEvent> {

	@Override
	public OrderTaskType getTaskType() {
		return OrderTaskType.BUILD_POWER_UP;
	}
	...
	public boolean onEventUpdate(IOrderDateEntity dataEntity, IOrderTaskCfg cfg, OrderItem orderItem, BuildingLevelUpEvent event) {
		...
		return onAddValue(dataEntity, cfg, orderItem, event.getAddPower());
	}

package com.hawk.activity.type.impl.powercollect.entity;
...
@Entity
@Table(name = "activity_power_collect")
public class PowerCollectEntity extends HawkDBEntity implements IActivityDataEntity{
    ...
    @IndexProp(id = 7)
	@Column(name="collectCnt", nullable = false)
	...
	public PowerCollectEntity(){}
	
	public PowerCollectEntity(String playerId, int termId){
	...
	public void addCollectCnt(int count){
		this.collectCnt += count;
	}

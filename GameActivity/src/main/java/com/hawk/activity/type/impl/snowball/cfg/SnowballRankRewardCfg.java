 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/snowball/snowball_rank_reward.xml")
public class SnowballRankRewardCfg extends HawkConfigBase {
	@Id
	...
	protected final boolean checkValid() {
		...
		if (!valid) {
			throw new InvalidParameterException(String.format("SnowballRank reward error, id: %s , reward: %s", id, rewards));
		}

package com.hawk.activity.type.impl.newFirstRecharge.entity;
 ...
 */
@Entity
@Table(name = "activity_new_first_recharge")
public class NewFirstRechargeEntity extends HawkDBEntity implements IActivityDataEntity {
    @Id
    ...
    /** 当前已经弹窗的等级*/
    @IndexProp(id = 11)
    @Column(name = "popLevel", nullable = false)
    ...
    public NewFirstRechargeEntity(){

    }

    public NewFirstRechargeEntity(String playerId, int termId){

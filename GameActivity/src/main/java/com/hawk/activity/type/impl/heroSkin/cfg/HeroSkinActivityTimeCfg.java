...
@HawkConfigManager.XmlResource(file = "activity/hero_skin_lottery/hero_skin_lottery_activity_time.xml")
public class HeroSkinActivityTimeCfg extends HawkConfigBase implements IActivityTimeCfg {
	/** 活动期数*/
	@Id
	...
	public HeroSkinActivityTimeCfg() {
		termId = 0;
		showTime = "";
		startTime = "";
		endTime = "";

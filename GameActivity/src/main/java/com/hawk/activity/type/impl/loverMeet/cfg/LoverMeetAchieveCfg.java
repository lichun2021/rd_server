 ...
 *
 */
@HawkConfigManager.XmlResource(file = "activity/lover_meet/lover_meet_achieve.xml")
public class LoverMeetAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

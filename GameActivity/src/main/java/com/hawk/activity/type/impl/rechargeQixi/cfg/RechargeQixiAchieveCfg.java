...
@HawkConfigManager.XmlResource(file = "activity/recharge_qixi/recharge_qixi_achieve.xml")
public class RechargeQixiAchieveCfg extends AchieveConfig {
	/** 成就id*/
	@Id

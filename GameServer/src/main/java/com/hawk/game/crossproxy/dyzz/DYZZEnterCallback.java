...
public class DYZZEnterCallback extends CsRpcCallback {
	private Player player;
	public DYZZEnterCallback(Player player) {
		this.player = player;
	}
	@Override
	public int invoke(Object args) {
		...
		Player.logger.info("DYZZ  login_c resp  playerId:{}, errorCode:{}", player.getId(), rpcCommonResp.getErrorCode());
	...
	public void onTimeout(Object obj) {
		Player.logger.info("dyzz enter timeout playerId:{}", player.getId());
		DYZZCallbackOperationService.getInstance().onPrepareCrossFail(player);
	}

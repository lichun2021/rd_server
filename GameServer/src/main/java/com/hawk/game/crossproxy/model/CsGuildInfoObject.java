...
public class CsGuildInfoObject extends GuildInfoObject {

	private CGuildInfo.Builder guildInfo;

	public CsGuildInfoObject(GuildInfoEntity entity) {
		super(entity);
	}

	public CGuildInfo.Builder getGuildInfo() {
		return guildInfo;
	}

	public void setGuildInfo(CGuildInfo.Builder guildInfo) {

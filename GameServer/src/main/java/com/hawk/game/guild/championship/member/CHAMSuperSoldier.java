...
public class CHAMSuperSoldier extends SuperSoldier {
	private PBSuperSoldierInfo sourceData;

	private CHAMSuperSoldier(SuperSoldierEntity dbEntity) {
		super(dbEntity);
	}

	public static CHAMSuperSoldier create(PBSuperSoldierInfo data) {
		CHAMSuperSoldier result = new CHAMSuperSoldier(null);

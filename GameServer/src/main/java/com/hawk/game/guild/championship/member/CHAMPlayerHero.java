...
public class CHAMPlayerHero extends PlayerHero {
	private PBHeroInfo heroData;

	private CHAMPlayerHero(HeroEntity heroEntity) {
		super(heroEntity);
	}

	public static CHAMPlayerHero create(PBHeroInfo data) {
		CHAMPlayerHero result = new CHAMPlayerHero(null);

 ...
 * 单人铁幕装置
 */
public class FGYLBuildingMarchSingle extends IFGYLWorldMarch implements IFGYLReportPushMarch, IFGYLPassiveAlarmTriggerMarch {
	private WorldMarchType marchType;

	public FGYLBuildingMarchSingle(IFGYLPlayer parent) {
		super(parent);
	}

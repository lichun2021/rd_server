...
public class FGYLProtocol extends HawkProtocol {
	private HawkProtocol source;
	private IFGYLPlayer player;

	private FGYLProtocol() {
	}

	public static FGYLProtocol valueOf(HawkProtocol source, IFGYLPlayer player) {
		FGYLProtocol result = new FGYLProtocol();

...
public class TBLYProtocol extends HawkProtocol {
	private HawkProtocol source;
	private ITBLYPlayer player;

	private TBLYProtocol() {
	}

	public static TBLYProtocol valueOf(HawkProtocol source, ITBLYPlayer player) {
		TBLYProtocol result = new TBLYProtocol();

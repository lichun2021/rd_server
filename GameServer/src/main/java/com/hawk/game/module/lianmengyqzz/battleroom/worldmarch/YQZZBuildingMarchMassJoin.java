...
public class YQZZBuildingMarchMassJoin extends IYQZZMassJoinMarch implements IYQZZReportPushMarch, IYQZZPassiveAlarmTriggerMarch {

	public YQZZBuildingMarchMassJoin(IYQZZPlayer parent) {
		super(parent);
	}
	...
	public void pullAttackReport() {
		List<IYQZZWorldMarch> marchList = getParent().getParent().getPointMarches(getTerminalId());

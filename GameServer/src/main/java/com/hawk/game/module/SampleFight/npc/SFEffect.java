...
import com.hawk.game.module.SampleFight.cfg.SFEffectCfg;
...
public class SFEffect extends PlayerEffect {
	private SFPlayer parent;

	public SFEffect(SFPlayer parent, PlayerData playerData) {
		super(playerData);
		this.parent = parent;
	}
	...
	public int getEffVal(EffType effType, String targetId, EffectParams effParams) {
		try {
			...
			int effVal = effHero + effSuperSoldier + SFEffectCfg.getEffval(effType);
			return effVal;

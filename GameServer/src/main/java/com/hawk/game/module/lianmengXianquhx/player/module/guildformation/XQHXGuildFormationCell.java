...
public class XQHXGuildFormationCell extends GuildFormationCell {
	private XQHXGuildFormationObj parent;
	...
	public XQHXGuildFormationObj getParent() {
		return parent;
	}

	public void setParent(XQHXGuildFormationObj parent) {
		this.parent = parent;
	}

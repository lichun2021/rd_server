package com.hawk.game.module.lianmengfgyl.battleroom.invoker;
 ...
 *
 */
public class FGYLMoveCityMsgInvoker extends HawkMsgInvoker {

	private int moveCityType;
	private Player player;
	private ConsumeItems consumeItems;
	
	public FGYLMoveCityMsgInvoker(Player player, ConsumeItems consumeItems, int moveCityType){
		this.player = player;

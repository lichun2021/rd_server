...
public class FGYLPlayerData extends IFGYLPlayerData {
	private IFGYLPlayerEffect playerEffect;
	/** 兵数据副本 */
	...
	private FGYLPlayerData(IFGYLPlayer parent) {
		super(parent);
	}

	@Override
	public FGYLPlayer getParent() {
		return (FGYLPlayer) super.getParent();
	}

	public static FGYLPlayerData valueOf(FGYLPlayer player) {
		PlayerData source = player.getSource().getData();
		FGYLPlayerData result = new FGYLPlayerData(player);
		...
		// effect 对象
		result.playerEffect = new FGYLPlayerEffect(result);
	...
	@Override
	public IFGYLPlayerEffect getPlayerEffect() {
		return playerEffect;
	}
	...
	public void setPlayerEffect(IFGYLPlayerEffect playerEffect) {

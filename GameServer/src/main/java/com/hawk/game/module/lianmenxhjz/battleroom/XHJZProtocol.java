...
public class XHJZProtocol extends HawkProtocol {
	private HawkProtocol source;
	private IXHJZPlayer player;

	private XHJZProtocol() {
	}

	public static XHJZProtocol valueOf(HawkProtocol source, IXHJZPlayer player) {
		XHJZProtocol result = new XHJZProtocol();

...
public class XQHXPointUtil {
	private XQHXPointUtil() {
	}

	// public static int pointRedis(WorldPointType pt) {
	//// XQHX_FUELBANK = 26; // tbly燃料库 2
	//// XQHX_IRON_CRUTAIN_DIVICE = 27; // 铁幕装置 4
	//// XQHX_NUCLEAR_MISSILE_SILO = 29; // 核弹发射井 4
	//// XQHX_WEATHER_CONTROLLER = 30; // 天气控制器 4
	//// XQHX_CHRONO_SPHERE = 31; // 超时空传送器 4
	//// XQHX_COMMAND_CENTER = 32; // 指挥部 4
	//// XQHX_MILITARY_BASE = 33; // 军事基地 3
	//// XQHX_HEADQUARTERS = 34; // 司令部 7
	// switch (pt) {
	// case PLAYER:
	// return 2;
	// case RESOURCE:
	...
	// case XQHX_FUELBANK:
	// return 2;
	// case XQHX_IRON_CRUTAIN_DIVICE:
	// return 4;
	// case XQHX_NUCLEAR_MISSILE_SILO:
	// return 4;
	// case XQHX_WEATHER_CONTROLLER:
	// return 4;
	// case XQHX_CHRONO_SPHERE:
	// return 4;
	// case XQHX_COMMAND_CENTER:
	// return 4;
	// case XQHX_MILITARY_BASE:
	// return 3;
	// case XQHX_HEADQUARTERS:
	// return 7;
	// case NIAN:
	// return 2;
	// case MONSTER:
	// return 1;
	// case XQHX_TECHNOLOGY_LAB:
	// return 3;
	//
	// default:
	// break;

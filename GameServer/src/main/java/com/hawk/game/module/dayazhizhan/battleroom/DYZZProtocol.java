...
public class DYZZProtocol extends HawkProtocol {
	private HawkProtocol source;
	private IDYZZPlayer player;

	private DYZZProtocol() {
	}

	public static DYZZProtocol valueOf(HawkProtocol source, IDYZZPlayer player) {
		DYZZProtocol result = new DYZZProtocol();

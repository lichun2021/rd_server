...
public class XHJZPlayerData extends IXHJZPlayerData {
	private IXHJZPlayerEffect playerEffect;
	/** 兵数据副本 */
	...
	private XHJZPlayerData(IXHJZPlayer parent) {
		super(parent);
	}

	@Override
	public XHJZPlayer getParent() {
		return (XHJZPlayer) super.getParent();
	}

	public static XHJZPlayerData valueOf(XHJZPlayer player) {
		PlayerData source = player.getSource().getData();
		XHJZPlayerData result = new XHJZPlayerData(player);
		...
		// effect 对象
		result.playerEffect = new XHJZPlayerEffect(result);
	...
	@Override
	public IXHJZPlayerEffect getPlayerEffect() {
		return playerEffect;
	}
	...
	public void setPlayerEffect(IXHJZPlayerEffect playerEffect) {

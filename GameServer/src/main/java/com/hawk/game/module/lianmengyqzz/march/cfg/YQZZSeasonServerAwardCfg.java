...
@HawkConfigManager.XmlResource(file = "xml/moon_war_season_nation_award.xml")
public class YQZZSeasonServerAwardCfg  extends HawkConfigBase {
    @Id
    ...
    public YQZZSeasonServerAwardCfg() {
        id = 0;
        score = 0;
        award = "";
    }

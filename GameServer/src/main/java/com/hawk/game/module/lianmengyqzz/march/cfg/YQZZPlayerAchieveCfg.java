 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/moon_war_player_achieve.xml")
public class YQZZPlayerAchieveCfg extends HawkConfigBase implements YQZZAchieveCfg{

package com.hawk.game.module.plantsoldier.strengthen.instrumentUpgrade.cfg;
...
@HawkConfigManager.XmlResource(file = "xml/plant_instrument_upgrade.xml")
public class PlantInstrumentUpgradeCfg extends HawkConfigBase {
	...
	private static PlantInstrumentUpgradeCfg zeroLevelCfg;

	public PlantInstrumentUpgradeCfg() {
		id = 0;
		level = 0;
		power = 0;
		chips = "";
	...
	protected boolean checkValid() {
		...
		if (frontStage != 0) {
			PlantInstrumentUpgradeCfg cfg = HawkConfigManager.getInstance().getConfigByKey(PlantInstrumentUpgradeCfg.class, frontStage);
			if (cfg == null) {
		...
		if (postStage != 0) {
			PlantInstrumentUpgradeCfg cfg = HawkConfigManager.getInstance().getConfigByKey(PlantInstrumentUpgradeCfg.class, postStage);
			if (cfg == null) {
	...
	public static PlantInstrumentUpgradeCfg getZeroLevelCfg() {
		return zeroLevelCfg;
	}

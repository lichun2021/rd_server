 ...
 *
 */
@HawkConfigManager.KVResource(file = "xml/tbly_chrono_sphere.xml")
public class TBLYChronoSphereCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	public int getMissileCoolDownTime() {
		return missileCoolDownTime;
	}

	public int getMissileEffectTime() {
		return missileEffectTime;
	}

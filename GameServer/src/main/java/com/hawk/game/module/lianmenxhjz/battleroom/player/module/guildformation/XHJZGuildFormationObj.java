...
public class XHJZGuildFormationObj extends GuildFormationObj {
	...
	public void unSerializ(String str) {
		...
		arr.forEach(s -> {
			XHJZGuildFormationCell cell = new XHJZGuildFormationCell();
	...
	public void setParent(XHJZBattleRoom parent) {
		this.parent = parent;
	}

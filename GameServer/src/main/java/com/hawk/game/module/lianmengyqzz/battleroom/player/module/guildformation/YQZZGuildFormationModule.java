 ...
 *
 */
public class YQZZGuildFormationModule extends PlayerModule {
	...
	public YQZZGuildFormationModule(IYQZZPlayer player) {
		super(player);
		this.player = player;
	}
	...
	private void checkJoinPush() {
		...
		if (player.hasGuild()) {
			YQZZGuildFormationObj formationObj = getGuildFormation();
			for (GuildFormationCell ff : formationObj.getFormations()) {
				YQZZGuildFormationCell formation = (YQZZGuildFormationCell) ff;
				// 不需要出征
	 ...
	 * @return
	 */
	private YQZZGuildFormationObj getGuildFormation() {

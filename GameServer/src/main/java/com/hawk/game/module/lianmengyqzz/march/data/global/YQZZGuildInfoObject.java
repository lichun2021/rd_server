...
public class YQZZGuildInfoObject extends GuildInfoObject {

	private YQZZJoinGuild guildInfo;

	public YQZZGuildInfoObject(GuildInfoEntity entity) {
		super(entity);
	}

	public YQZZJoinGuild getGuildInfo() {
		return guildInfo;
	}

	public void setGuildInfo(YQZZJoinGuild guildInfo) {
	...
	public String getTag() {
		return guildInfo.getGuildTag();
	}

	@Override
	public int getFlagId() {
		return guildInfo.getGuildFlag();
	}
	...
	public String getLeaderId() {
		return guildInfo.getLeaderId();
	}

	@Override
	public String getLeaderName() {
		return guildInfo.getLeaderName();
	}

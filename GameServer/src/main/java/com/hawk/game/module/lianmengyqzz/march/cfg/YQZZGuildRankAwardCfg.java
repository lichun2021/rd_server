 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/moon_war_alliance_rankaward.xml")
public class YQZZGuildRankAwardCfg extends HawkConfigBase {
	/** 活动期数 */
	@Id

 ...
 *
 */
public class SpaceMechaMainMassMarch extends PlayerMarch implements MassMarch, MechaSpaceMarch, IReportPushMarch, IPassiveAlarmTriggerMarch{

	public SpaceMechaMainMassMarch(WorldMarch marchEntity) {
		super(marchEntity);
	}

	@Override
	public WorldMarchType getMarchType() {
		return WorldMarchType.SPACE_MECHA_MAIN_MARCH_MASS;
	}

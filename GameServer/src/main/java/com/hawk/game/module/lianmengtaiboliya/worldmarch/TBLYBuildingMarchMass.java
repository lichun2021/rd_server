...
/** 集结
 */
public class TBLYBuildingMarchMass extends ITBLYMassMarch implements ITBLYReportPushMarch , ITBLYPassiveAlarmTriggerMarch {

	private WorldMarchType marchType;
	private WorldMarchType joinMassType;

	public TBLYBuildingMarchMass(ITBLYPlayer parent) {
		super(parent);
	}

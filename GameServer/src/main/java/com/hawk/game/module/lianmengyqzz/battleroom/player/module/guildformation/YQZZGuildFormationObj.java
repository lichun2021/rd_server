...
public class YQZZGuildFormationObj extends GuildFormationObj {
	...
	public void unSerializ(String str) {
		...
		arr.forEach(s -> {
			YQZZGuildFormationCell cell = new YQZZGuildFormationCell();
	...
	public void setParent(YQZZBattleRoom parent) {
		this.parent = parent;
	}

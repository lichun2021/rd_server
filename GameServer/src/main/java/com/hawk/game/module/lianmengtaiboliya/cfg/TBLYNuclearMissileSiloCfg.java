...
@HawkConfigManager.KVResource(file = "xml/tbly_nuclear_missile_silo.xml")
public class TBLYNuclearMissileSiloCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	public TBLYNuclearMissileSiloCfg() {
		firstControlHonor = 8;

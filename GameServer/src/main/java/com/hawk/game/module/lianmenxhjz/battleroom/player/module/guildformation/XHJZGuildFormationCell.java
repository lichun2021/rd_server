package com.hawk.game.module.lianmenxhjz.battleroom.player.module.guildformation;
...
public class XHJZGuildFormationCell extends GuildFormationCell {
	private XHJZGuildFormationObj parent;
	...
	public XHJZGuildFormationObj getParent() {
		return parent;
	}

	public void setParent(XHJZGuildFormationObj parent) {
		this.parent = parent;
	}

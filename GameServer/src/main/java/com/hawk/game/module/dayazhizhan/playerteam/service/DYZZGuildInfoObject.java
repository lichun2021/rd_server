...
public class DYZZGuildInfoObject extends GuildInfoObject {

	private DYZZGuildData guildInfo;

	public DYZZGuildInfoObject(GuildInfoEntity entity) {
		super(entity);
	}

	public DYZZGuildData getGuildInfo() {
		return guildInfo;
	}

	public void setGuildInfo(DYZZGuildData guildInfo) {

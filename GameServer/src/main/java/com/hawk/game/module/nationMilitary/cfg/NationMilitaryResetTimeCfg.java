...
@HawkConfigManager.XmlResource(file = "xml/nation_military_reset_time.xml")
public class NationMilitaryResetTimeCfg extends HawkConfigBase {
	...
	public NationMilitaryResetTimeCfg() {
		this.id = 101;

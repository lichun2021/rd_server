 ...
 * @author lwt
 * @date 2018年12月27日 */
public class TBLYJoinRoomMsg extends HawkMsg {
	private TBLYBattleRoom battleRoom;
	private ITBLYPlayer player;

	private TBLYJoinRoomMsg() {
	}

	public static TBLYJoinRoomMsg valueOf(TBLYBattleRoom room, ITBLYPlayer player) {
		TBLYJoinRoomMsg msg = new TBLYJoinRoomMsg();
		msg.battleRoom = room;
		msg.player = player;
		return msg;
	}

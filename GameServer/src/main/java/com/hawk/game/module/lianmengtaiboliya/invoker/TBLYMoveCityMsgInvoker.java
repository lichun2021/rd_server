package com.hawk.game.module.lianmengtaiboliya.invoker;
 ...
 *
 */
public class TBLYMoveCityMsgInvoker extends HawkMsgInvoker {

	private int moveCityType;
	private Player player;
	private ConsumeItems consumeItems;
	
	public TBLYMoveCityMsgInvoker(Player player, ConsumeItems consumeItems, int moveCityType){
		this.player = player;

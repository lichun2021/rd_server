...
import com.hawk.game.module.lianmengXianquhx.entity.XQHXArmyEntity;
import com.hawk.game.module.lianmengXianquhx.entity.XQHXDbEntityCopyUtil;
...
public class XQHXPlayerData extends IXQHXPlayerData {
	private IXQHXPlayerEffect playerEffect;
	/** 兵数据副本 */
	...
	private XQHXPlayerData(IXQHXPlayer parent) {
		super(parent);
	}

	@Override
	public XQHXPlayer getParent() {
		return (XQHXPlayer) super.getParent();
	}

	public static XQHXPlayerData valueOf(XQHXPlayer player) {
		PlayerData source = player.getSource().getData();
		XQHXPlayerData result = new XQHXPlayerData(player);
		result.playerId = source.getPlayerId();
		result.dataCache = source.getDataCache();
		// army副本
		Map<Integer, XQHXArmyEntity> armyMap = new HashMap<>();
		...
		for (BattleSoldierCfg arCfg : armyit) {
			XQHXArmyEntity army = new XQHXArmyEntity();
		...
		for (ArmyEntity army : source.getArmyEntities()) {
			armyMap.put(army.getArmyId(), XQHXDbEntityCopyUtil.copyOf(army));
		}
		...
		// effect 对象
		result.playerEffect = new XQHXPlayerEffect(result);
	...
	@Override
	public IXQHXPlayerEffect getPlayerEffect() {
		return playerEffect;
	}
	...
	public ArmyEntity getArmyEntity(int armyId) {
		...
		XQHXArmyEntity armyEntity = new XQHXArmyEntity();
	...
	public void setPlayerEffect(IXQHXPlayerEffect playerEffect) {

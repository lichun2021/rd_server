...
public class YQZZAchievParserCountryHoldBuildEachEnd extends IYQZZAchievParser{

	@Override
	public YQZZAchieveType getYQZZAchieveType() {
		return YQZZAchieveType.COUNTRY_HOLD_BUILDING_EACH;
	}
	...
	public boolean achieveFinish(YQZZAchievecomponent achieve,List<Long> conditionValueList,long targetValue) {
		...
		long achiveVal = achieve.getValue();
		if(achiveVal >= targetValue){

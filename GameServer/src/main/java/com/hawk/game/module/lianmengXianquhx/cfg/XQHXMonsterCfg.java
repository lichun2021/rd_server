...
@HawkConfigManager.XmlResource(file = "xml/xqhx_monster.xml")
public class XQHXMonsterCfg extends HawkConfigBase {
	@Id
	private final int id;
	private final int monsterId;// ="302001"
	private final int playerScore;// ="30"
	private final int allianceScore;// ="30"
	private final int allianceOrder;// ="100"

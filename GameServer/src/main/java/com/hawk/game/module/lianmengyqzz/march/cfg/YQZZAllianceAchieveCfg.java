 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/moon_war_alliance_achieve.xml")
public class YQZZAllianceAchieveCfg extends HawkConfigBase implements YQZZAchieveCfg{

...
public class FGYLGuildFormationCell extends GuildFormationCell {
	private FGYLGuildFormationObj parent;
	...
	public FGYLGuildFormationObj getParent() {
		return parent;
	}

	public void setParent(FGYLGuildFormationObj parent) {
		this.parent = parent;
	}

package com.hawk.game.module.lianmengXianquhx.invoker;
 ...
 *
 */
public class XQHXMoveCityMsgInvoker extends HawkMsgInvoker {

	private int moveCityType;
	private Player player;
	private ConsumeItems consumeItems;
	
	public XQHXMoveCityMsgInvoker(Player player, ConsumeItems consumeItems, int moveCityType){
		this.player = player;

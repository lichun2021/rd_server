...
public class XQHXProtocol extends HawkProtocol {
	private HawkProtocol source;
	private IXQHXPlayer player;

	private XQHXProtocol() {
	}

	public static XQHXProtocol valueOf(HawkProtocol source, IXQHXPlayer player) {
		XQHXProtocol result = new XQHXProtocol();

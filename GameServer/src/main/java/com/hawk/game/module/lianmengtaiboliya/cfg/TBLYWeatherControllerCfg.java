...
@HawkConfigManager.KVResource(file = "xml/tbly_weather_controller.xml")
public class TBLYWeatherControllerCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	public TBLYWeatherControllerCfg() {
		firstControlHonor = 8;

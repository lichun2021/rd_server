...
public class TBLYGuildFormationObj extends GuildFormationObj {
	...
	public void unSerializ(String str) {
		...
		arr.forEach(s -> {
			TBLYGuildFormationCell cell = new TBLYGuildFormationCell();
	...
	public void setParent(TBLYBattleRoom parent) {
		this.parent = parent;
	}

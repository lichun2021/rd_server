...
public class XHJZPlayerPush extends IXHJZPlayerPush {
	...
	public XHJZPlayerPush(Player player) {
		super(player);
	}
	...
	public void syncPlayerInfo() {
		...
		newBuilder.setXhjzCamp(getPlayer().getCamp().intValue());
//		newBuilder.setIsRegisterPuidCtrlPlayer(GameUtil.isOBPuidCtrlPlayer(player.getOpenId()));
		newBuilder.setXhjzGasoline((int) getPlayer().getGasoline());
		newBuilder.setXhjzCommonder(getPlayer().getCommonder());
...
//		newBuilder.setIsRegisterPuidCtrlPlayer(GameUtil.isOBPuidCtrlPlayer(player.getOpenId()));
	...
	public void pushJoinGame() {
		...
		XHJZPlayerData playerData = (XHJZPlayerData) getData();
//		playerData.unLockOriginalData();
	...
	public void pushGameOver() {
		...
		// }
		// }
		XHJZQuitRoomMsg msg = XHJZQuitRoomMsg.valueOf(getPlayer().getQuitReason());
	...
	public XHJZPlayer getPlayer() {
		return (XHJZPlayer) player;
	}

	@Override
	public IXHJZPlayerData getData() {
		return (IXHJZPlayerData) player.getData();
	}

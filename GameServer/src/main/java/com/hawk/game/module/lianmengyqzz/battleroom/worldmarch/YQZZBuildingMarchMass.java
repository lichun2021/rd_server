...
/** 集结
 */
public class YQZZBuildingMarchMass extends IYQZZMassMarch implements IYQZZReportPushMarch , IYQZZPassiveAlarmTriggerMarch {

	private WorldMarchType marchType;
	private WorldMarchType joinMassType;

	public YQZZBuildingMarchMass(IYQZZPlayer parent) {
		super(parent);
	}

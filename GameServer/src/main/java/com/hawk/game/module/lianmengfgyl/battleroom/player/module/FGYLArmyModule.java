...
public class FGYLArmyModule extends PlayerModule {

	private IFGYLPlayer player;

	public FGYLArmyModule(IFGYLPlayer player) {
		super(player);
		this.player = player;
	}
	...
	private QueueEntity addQueue(IFGYLPlayer player, int queueType, int queueStatus, String itemId,
	...
	private List<ItemInfo> cureConsume(IFGYLPlayer player, List<ArmySoldierPB> cureList, int recoverTime, boolean immediate, boolean useGold, int hpCode) {
	 ...
	 * @return
	 */
	private Map<Integer, Integer> cureSoldier(IFGYLPlayer player, List<ArmySoldierPB> cureList, boolean immediate) {

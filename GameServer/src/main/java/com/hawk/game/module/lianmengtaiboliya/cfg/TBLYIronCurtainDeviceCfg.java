...
@HawkConfigManager.KVResource(file = "xml/tbly_iron_crutain_divice.xml")
public class TBLYIronCurtainDeviceCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	public TBLYIronCurtainDeviceCfg() {
		firstControlHonor = 8;

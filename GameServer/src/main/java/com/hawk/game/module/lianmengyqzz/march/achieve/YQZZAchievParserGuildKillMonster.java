...
public class YQZZAchievParserGuildKillMonster extends IYQZZAchievParser{

	@Override
	public YQZZAchieveType getYQZZAchieveType() {
		return YQZZAchieveType.GUILD_KILL_MONSTER;
	}
	...
	public boolean updateAchieveOnUpdate(YQZZAchievecomponent achieve,List<Long> conditionValueList,long targetValue) {
		...
		long curVal = data.getGuildKillMonster(guildId);

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/dyzz_season_time_cfg.xml")
public class DYZZSeasonTimeCfg extends HawkConfigBase{
	/** 活动期数*/
	@Id
	...
	protected boolean checkValid() {
		ConfigIterator<DYZZSeasonTimeCfg> it = HawkConfigManager.getInstance().getConfigIterator(DYZZSeasonTimeCfg.class);
		long baseTime = 0;
		long baseTermId = 0;
		for (DYZZSeasonTimeCfg timeCfg : it) {

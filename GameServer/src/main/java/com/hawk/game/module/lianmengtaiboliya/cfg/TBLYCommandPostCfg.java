...
@HawkConfigManager.KVResource(file = "xml/tbly_command_post.xml")
public class TBLYCommandPostCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	// # npc第一条行行军发出/ 秒
	private final int npcMarchFirst;// = 60

	// # 行军间隔 / 秒
	private final int npcMarchInterval;// = 60

	// # 行军时间 无视距离/ 秒
	private final int npcMarchTime;// = 15
	...
	public TBLYCommandPostCfg() {
		npcMarchInterval = Integer.MAX_VALUE;
		npcMarchTime = 60;
		firstControlHonor = 8;
	...
	public int getNpcMarchInterval() {
		return npcMarchInterval;
	}

	public int getNpcMarchTime() {
		return npcMarchTime;
	}

	public int getNpcMarchFirst() {
		return npcMarchFirst;
	}

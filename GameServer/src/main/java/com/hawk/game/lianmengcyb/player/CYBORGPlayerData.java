...
import com.hawk.game.lianmengcyb.entity.CYBORGArmyEntity;
import com.hawk.game.lianmengcyb.entity.CYBORGDbEntityCopyUtil;
...
public class CYBORGPlayerData extends ICYBORGPlayerData {
	private ICYBORGPlayerEffect playerEffect;
	/** 兵数据副本 */
	...
	private CYBORGPlayerData(ICYBORGPlayer parent) {
		super(parent);
	}

	public static CYBORGPlayerData valueOf(CYBORGPlayer player) {
		PlayerData source = player.getSource().getData();
		CYBORGPlayerData result = new CYBORGPlayerData(player);
		result.playerId = source.getPlayerId();
		result.dataCache = source.getDataCache();
		// army副本
		Map<Integer, CYBORGArmyEntity> armyMap = new HashMap<>();
		...
		for (BattleSoldierCfg arCfg : armyit) {
			CYBORGArmyEntity army = new CYBORGArmyEntity();
		...
		for (ArmyEntity army : source.getArmyEntities()) {
			armyMap.put(army.getArmyId(), CYBORGDbEntityCopyUtil.copyOf(army));
		}
		...
		// effect 对象
		result.playerEffect = new CYBORGPlayerEffect(result);
	...
	@Override
	public ICYBORGPlayerEffect getPlayerEffect() {
		return playerEffect;
	}
	...
	public List<RechargeEntity> getPlayerRechargeEntities() {
		// TODO Auto-generated method stub
		return getSource().getPlayerRechargeEntities();
	}
	...
	public ArmyEntity getArmyEntity(int armyId) {
		...
		CYBORGArmyEntity armyEntity = new CYBORGArmyEntity();
	...
	public void addPlayerRechargeEntity(RechargeEntity entity) {
		// TODO Auto-generated method stub
		getSource().addPlayerRechargeEntity(entity);
	}
	...
	public void setPlayerEffect(ICYBORGPlayerEffect playerEffect) {
	...
	public CYBORGPlayer getParent() {
		// TODO Auto-generated method stub
		return (CYBORGPlayer) super.getParent();
	}

 ...
 * @author zhenyu.shang
 * @since 2017年8月28日 */
public class CYBORGMassJoinSingleMarch extends ICYBORGMassJoinMarch implements ICYBORGReportPushMarch {

	public CYBORGMassJoinSingleMarch(ICYBORGPlayer parent) {
		super(parent);

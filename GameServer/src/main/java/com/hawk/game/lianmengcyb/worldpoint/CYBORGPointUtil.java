...
public class CYBORGPointUtil {
	private CYBORGPointUtil() {
	}

	public static int pointRedis(WorldPointType pt) {
//		CYBORG_FUELBANK					= 26;	// CYBORG燃料库   2
//		CYBORG_IRON_CRUTAIN_DIVICE		= 27;   // 铁幕装置   4
//		CYBORG_NUCLEAR_MISSILE_SILO		= 29;   // 核弹发射井   4
//		CYBORG_WEATHER_CONTROLLER			= 30;   // 天气控制器   4
//		CYBORG_CHRONO_SPHERE				= 31;   // 超时空传送器   4
//		CYBORG_COMMAND_CENTER				= 32;   // 指挥部   4
//		CYBORG_MILITARY_BASE				= 33;   // 军事基地   3
//		CYBORG_HEADQUARTERS				= 34;   // 司令部   7
		switch (pt) {
		case PLAYER:
			return 2;
		case RESOURCE:
			return 1;
		case CYBORG_FUELBANK:
			return 2;
		case CYBORG_IRON_CRUTAIN_DIVICE:
			return 4;
		case CYBORG_NUCLEAR_MISSILE_SILO:
			return 4;
		case CYBORG_WEATHER_CONTROLLER:
			return 4;
		case CYBORG_CHRONO_SPHERE:
			return 4;
		case CYBORG_COMMAND_CENTER:
			return 4;
		case CYBORG_MILITARY_BASE:
			return 3;
		case CYBORG_HEADQUARTERS:
			return 5;
		case NIAN:
			return 2;
		case MONSTER:

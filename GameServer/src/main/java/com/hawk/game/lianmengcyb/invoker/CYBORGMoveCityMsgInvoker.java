 ...
 *
 */
public class CYBORGMoveCityMsgInvoker extends HawkMsgInvoker {

	private int moveCityType;
	private Player player;
	private ConsumeItems consumeItems;
	
	public CYBORGMoveCityMsgInvoker(Player player, ConsumeItems consumeItems, int moveCityType){
		this.player = player;
	...
	public boolean onMessage(HawkAppObj targetObj, HawkMsg msg) {
		// 道具消耗
		Action action = Action.CYBORG_MOVE_CITY;

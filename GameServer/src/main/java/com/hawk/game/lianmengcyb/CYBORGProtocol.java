...
public class CYBORGProtocol extends HawkProtocol {
	private HawkProtocol source;
	private ICYBORGPlayer player;

	private CYBORGProtocol() {
	}

	public static CYBORGProtocol valueOf(HawkProtocol source, ICYBORGPlayer player) {
		CYBORGProtocol result = new CYBORGProtocol();
	...
	public HawkProtocol getSource() {
		return source;
	}

	public void setSource(HawkProtocol source) {
		this.source = source;
	}

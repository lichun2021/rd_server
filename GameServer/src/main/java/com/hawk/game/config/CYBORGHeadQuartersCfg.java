...
@HawkConfigManager.KVResource(file = "xml/cyborg_headquarters.xml")
public class CYBORGHeadQuartersCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	protected boolean assemble() {
		{
			...
			for (String xy : Splitter.on(",").omitEmptyStrings().split(refreshPoint)) {

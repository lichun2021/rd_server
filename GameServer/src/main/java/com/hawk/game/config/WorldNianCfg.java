 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/world_nian.xml")
public class WorldNianCfg extends HawkConfigBase {
	...
	protected final int allowWorldSolo;
	...
	public int getAllowWorldSolo() {
		return allowWorldSolo;
	}

...
@HawkConfigManager.XmlResource(file = "xml/supersoldier_skill_level.xml")
@HawkConfigBase.CombineId(fields = { "skillLevel", "skillQuality" })
public class SuperSoldierSkillLevelCfg extends HawkConfigBase {
	...
	public SuperSoldierSkillLevelCfg() {
		skillLevel = 1;
		skillExp = 0;
		id = 0;
		skillQuality = 1;

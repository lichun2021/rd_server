...
@HawkConfigManager.KVResource(file = "xml/cyborg_nuclear_missile_silo.xml")
public class CYBORGNuclearMissileSiloCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	// # 杀伤百分比 %
	private final int killPercentage;// = 50
	...
	public CYBORGNuclearMissileSiloCfg() {
		firstControlHonor = 8;

 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/tiberium_season_guild_award.xml")
public class TiberiumSeasonGuildAwardCfg extends HawkConfigBase {
	@Id
	...
	public TiberiumSeasonGuildAwardCfg() {
		id = 0;
		score = 0;
		award = "";
	}

...
@HawkConfigManager.KVResource(file = "xml/cyborg_weather_controller.xml")
public class CYBORGWeatherControllerCfg extends HawkConfigBase {
	// # 首次占领个人 积分
	...
	// # 控制时间减少百分比 %
	private final int coolDownReducePercentage;// = 50
	// # 占领倒计时 /秒
	...
	public CYBORGWeatherControllerCfg() {
		firstControlHonor = 8;

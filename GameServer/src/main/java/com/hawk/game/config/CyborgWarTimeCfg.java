 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/cyborg_war_time.xml")
public class CyborgWarTimeCfg extends HawkConfigBase {
	/** 活动期数 */
	@Id
	...
	protected boolean checkValid() {
		ConfigIterator<CyborgWarTimeCfg> it = HawkConfigManager.getInstance().getConfigIterator(CyborgWarTimeCfg.class);
		long baseTermId = 0;
		for (CyborgWarTimeCfg timeCfg : it) {

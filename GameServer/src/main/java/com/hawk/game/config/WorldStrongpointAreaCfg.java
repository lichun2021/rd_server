 ...
 *
 */
@HawkConfigManager.XmlResource(file = "xml/world_strongpoint_area.xml")
public class WorldStrongpointAreaCfg extends HawkConfigBase {
	@Id
	...
	public WorldStrongpointAreaCfg() {
		id = 0;

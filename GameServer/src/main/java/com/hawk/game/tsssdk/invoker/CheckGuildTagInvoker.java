...
@Category(scene = GameMsgCategory.CHECK_GUILD_TAG)
public class CheckGuildTagInvoker implements TsssdkInvoker {
	...
	public int invoke(Player player, int result, String guildTag, int protocol, String callback) {
		...
		int operationResult = GuildUtil.checkGuildTag(guildTag);

 ...
 * @since 2017年8月28日
 */
public class ManorRepairMarch extends PlayerMarch implements ManorMarch, IReportPushMarch, IPassiveAlarmTriggerMarch{

	public ManorRepairMarch(WorldMarch marchEntity) {
		super(marchEntity);
	}

	@Override
	public WorldMarchType getMarchType() {
		return WorldMarchType.MANOR_REPAIR;
	}

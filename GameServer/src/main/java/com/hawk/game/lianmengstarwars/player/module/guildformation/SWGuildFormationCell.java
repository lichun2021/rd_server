package com.hawk.game.lianmengstarwars.player.module.guildformation;
...
public class SWGuildFormationCell extends GuildFormationCell {
	private SWGuildFormationObj parent;
	...
	public SWGuildFormationObj getParent() {
		return parent;
	}

	public void setParent(SWGuildFormationObj parent) {
		this.parent = parent;
	}

 ...
 * 单人铁幕装置
 */
public class SWBuildingMarchSingle extends ISWWorldMarch implements ISWReportPushMarch, ISWPassiveAlarmTriggerMarch {
	private WorldMarchType marchType;

	public SWBuildingMarchSingle(ISWPlayer parent) {
		super(parent);
	}

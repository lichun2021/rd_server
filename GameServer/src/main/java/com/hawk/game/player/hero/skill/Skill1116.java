...
@HeroSkill(skillID = { 111601, 111602, 111603, 111604, 111605 })
public class Skill1116 extends ISSSHeroSkill {
	/**
	【12731】
  - 【万分比】【12731】战技持续期间，自身出征数量最多的狙击兵受到攻击时，伤害减少 +XX.XX%【12731】
    - 战报相关
      - 于战报中展示
      - 不合并至精简战报中
    ...
    - 自身出征数量最多的狙击兵
      ...
      - 满足条件后，该作用号效果仅对玩家出征时数量最多的狙击兵（兵种类型 = 6）生效（若存在多个部队数量一样且最高，取等级高的）

...
@HeroSkill(skillID = { 109501, 109502, 109503, 109504, 109505 })
public class Skill1095 extends ISSSHeroSkill {
	/**
	 * 【12181】
	...
	private int effect12181;// 填效果1作用号【12071】
	private double effect12181p1;
	...
	public List<PBHeroEffect> effectVal() {
		...
		try {
			...
			effect12181 = NumberUtils.toInt(ps[0]);
			effect12181p1 = NumberUtils.toDouble(ps[1]);
	...
	public int getProficiencyEffect(EffType effType, EffectParams effParams) {
		...
		if (effType.getNumber() == effect12181) {
			return (int) Math.ceil(effect12181p1 * getParent().getParent().attrVale(101));
		}
	...
	public int effectTime() {
		return effectTime * 1000 + getSoulEffVal(EffType.EFF_12328) * 1000;
	}

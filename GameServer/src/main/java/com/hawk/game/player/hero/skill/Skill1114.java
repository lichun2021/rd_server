...
@HeroSkill(skillID = { 111401, 111402, 111403, 111404, 111405 })
public class Skill1114 extends ISSSHeroSkill {
	/**
	【12681】
  - 【万分比】【12681】战技持续期间，自身出征数量最多的攻城车受到攻击时，伤害减少 +XX.XX%【12681】
    - 战报相关
      - 于战报中展示
      - 不合并至精简战报中
	...
	private int effect;// 填效果1作用号【12071】
	...
	public int effectTime() {
		return effectTime * 1000 + getSoulEffVal(EffType.HERO_12695) * 1000;
	}

...
@HeroSkill(skillID = { 111001, 111002, 111003, 111004, 111005 })
public class Skill1110 extends ISSSHeroSkill {
	/**
	12581】
- 【万分比】【12581】战技持续期间，集结战斗中采矿车受到攻击时，伤害减少 +XX.XX%
  ...
  - 此为英雄战技专属作用号，配置格式如下
	...
	public int effectTime() {
		return effectTime * 1000 + getSoulEffVal(EffType.EFF_12594) * 1000;
	}

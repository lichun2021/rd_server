...
@HeroSkill(skillID = { 110601, 110602, 110603, 110604, 110605 })
public class Skill1106 extends ISSSHeroSkill {
	/**
	...
	public int effectTime() {
		return effectTime * 1000 + getSoulEffVal(EffType.HERO_12485) * 1000;
	}

...
@HeroSkill(skillID = { 110001, 110002, 110003, 110004, 110005 })
public class Skill1100 extends ISSSHeroSkill {
	/**
	-【12341】
- 【万分比】【12341】战技持续期间，自身出征数量最多的攻城车受到攻击时，伤害减少 +XX.XX%
  - 战报相关
    - 于战报中展示
    - 不合并至精简战报中
  ...
  - 此为英雄战技专属作用号，配置格式如下
	...
	public int effectTime() {
		return effectTime * 1000 + getSoulEffVal(EffType.HERO_12357) * 1000;
	}

...
@EffectChecker(effType = EffType.CROSS_EFF_10015)
public class Checker10015 implements IChecker {
	/**
...
10018	万分比	受到敌方攻城车（兵种类型 = 7）攻击时，伤害减少	
	...
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (isSoldier(parames.type) && parames.tarType == SoldierType.FOOT_SOLDIER_6) {

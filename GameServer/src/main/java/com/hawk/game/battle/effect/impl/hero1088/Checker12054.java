...
/**
【12054】
- 【万分比】【12053】若自身出征轰炸机（兵种类型 = 3）数量超过自身出征部队总数 50%，自身出征数量最多的轰炸机单位在本场战斗中获得如下效果: 【轻装简行】降低自身智【智能护盾】 吸收伤害比率 +XX.XX%
  - 战报相关
    - 于战报中展示
    - 不合并至精简战报中
  ...
  - 【智能护盾】【id = 302】为轰炸机兵种基础技能，此处降低其可吸收的伤害比率
    - 即实际吸收比率 = 基础比率 + 其他比率加成 - 【本作用值】
      - 基础比率读取battle_soldier_skill表，字段p1
      - 该数值为伤害吸收比率，不得低于0
 */
@BattleTupleType(tuple = Type.SOLDIER_SKILL)
@EffectChecker(effType = EffType.EFF_12054)
public class Checker12054 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		if (!Checker12051.check(parames,ConstProperty.getInstance().getEffect12054SelfNumLimit())) {

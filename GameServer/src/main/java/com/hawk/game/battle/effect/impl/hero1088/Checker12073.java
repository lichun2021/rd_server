...
@EffectChecker(effType = EffType.EFF_12073)
public class Checker12073 implements IChecker {
	/**
	 *【12073】
- 【万分比】【12073】战技持续期间，【轻装简行】效果变更为: 降低自身【智能护盾】吸收伤害比率 +XX.XX%
  ...
  - 此为英雄战技专属作用号，配置格式如下
	...
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.troopEffType != WarEff.NO_EFF && parames.solider.getEffVal(EffType.EFF_12054) > 0) {

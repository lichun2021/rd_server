...
@EffectChecker(effType = EffType.PLANT_SOLDIER_1936)
public class Checker1936 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.PLANE_SOLDIER_3 && parames.solider.getSoldierCfg().isPlantSoldier()) {

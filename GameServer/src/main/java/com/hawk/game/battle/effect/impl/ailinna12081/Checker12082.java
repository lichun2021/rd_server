...
@EffectChecker(effType = EffType.EFF_12082)
public class Checker12082 extends Checker12081 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		...
		if (Objects.nonNull(object)) {
			...
			effPlayerVal = selectPlayer(parames, ConstProperty.getInstance().getEffect12082SelfNumLimit(), ConstProperty.getInstance().getEffect12082AllNumLimit(),
					ConstProperty.getInstance().getEffect12082Maxinum());

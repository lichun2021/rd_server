...
@EffectChecker(effType = EffType.EFF_5022)
public class Checker5022 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.TANK_SOLDIER_2 && parames.unity.getPlayer().isInDungeonMap()) {

...
@EffectChecker(effType = EffType.WAR_ACKACK_ATK_PLANE)
public class Checker173 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		...
		if (type == SoldierType.WEAPON_LANDMINE_101 || type == SoldierType.WEAPON_ACKACK_102 || type == SoldierType.WEAPON_ANTI_TANK_103) {
			if (type == SoldierType.WEAPON_ACKACK_102 && (tarType == SoldierType.PLANE_SOLDIER_3 || tarType == SoldierType.PLANE_SOLDIER_4)) {

...
@EffectChecker(effType = EffType.EFF_5037)
public class Checker5037 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.CANNON_SOLDIER_7 && parames.unity.getPlayer().isInDungeonMap()) {

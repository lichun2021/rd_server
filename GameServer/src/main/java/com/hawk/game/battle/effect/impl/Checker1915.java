...
@EffectChecker(effType = EffType.PLANT_SOLDIER_1915)
public class Checker1915 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.CANNON_SOLDIER_8 && parames.solider.getSoldierCfg().isPlantSoldier()) {

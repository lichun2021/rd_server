...
@EffectChecker(effType = EffType.EFF_5023)
public class Checker5023 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.PLANE_SOLDIER_3 && parames.unity.getPlayer().isInDungeonMap()) {

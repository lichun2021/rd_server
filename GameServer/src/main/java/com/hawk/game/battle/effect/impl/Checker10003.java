...
@EffectChecker(effType = EffType.CROSS_EFF_10003)
public class Checker10003 implements IChecker {
	/**
	...
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (isSoldier(parames.type) && parames.tarType == SoldierType.TANK_SOLDIER_2) {

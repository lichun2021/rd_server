...
@EffectChecker(effType = EffType.PLANT_SOLDIER_1922)
public class Checker1922 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.FOOT_SOLDIER_5 && parames.solider.getSoldierCfg().isPlantSoldier()) {

...
@EffectChecker(effType = EffType.PLANT_SOLDIER_1933)
public class Checker1933 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.TANK_SOLDIER_2 && parames.solider.getSoldierCfg().isPlantSoldier()) {

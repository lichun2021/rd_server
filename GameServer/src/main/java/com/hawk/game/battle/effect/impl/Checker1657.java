...
@EffectChecker(effType = EffType.HERO_1657)
public class Checker1657 implements IChecker {
	/**
	 * •芯片描述      
	...
	public CheckerKVResult value(CheckerParames parames) {
		...
		Skill1078 skill = (Skill1078) skillOp.get();
		BattleSoldier_2 tank = (BattleSoldier_2) parames.solider;
		tank.setEffect1657p5(skill.getP5());
		tank.setEffect1657p6(skill.getP6());
		tank.setEffect1657p7(skill.getP7());

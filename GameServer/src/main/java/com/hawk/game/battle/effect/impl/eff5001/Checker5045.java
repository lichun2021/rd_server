...
@EffectChecker(effType = EffType.EFF_5045)
public class Checker5045 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.FOOT_SOLDIER_5 && parames.unity.getPlayer().isInDungeonMap()) {

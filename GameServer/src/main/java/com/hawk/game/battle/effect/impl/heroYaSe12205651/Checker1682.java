...
@EffectChecker(effType = EffType.HERO_1682)
public class Checker1682 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		...
		if (march8Plantcnt * 1D / parames.unitStatic.getPlayerArmyCountMapMarch().get(playerId) > ConstProperty.getInstance().getEffect1682SelfNumLimit()* GsConst.EFF_PER) {
			effPer = (int) (effPer * GsConst.EFF_PER * ConstProperty.getInstance().getEffect1682RateValue());
		}

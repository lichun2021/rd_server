...
@EffectChecker(effType = EffType.CROSS_EFF_10018)
public class Checker10018 implements IChecker {
	/**
...
10018	万分比	受到敌方攻城车（兵种类型 = 7）攻击时，伤害减少	
	...
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (isSoldier(parames.type) && parames.tarType == SoldierType.CANNON_SOLDIER_7) {

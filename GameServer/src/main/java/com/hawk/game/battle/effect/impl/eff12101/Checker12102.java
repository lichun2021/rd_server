...
@EffectChecker(effType = EffType.EFF_12102)
public class Checker12102 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (isSoldier(parames.type)) {
			effPer = parames.unity.getEffVal(effType()) * parames.unitStatic.getSoldierTypeAll().size();
		}

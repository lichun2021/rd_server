...
@EffectChecker(effType = EffType.SUPER_SOLDIER_1417)
public class Checker1417 implements IChecker {

	// 空军部队占出征部队20%以上时，全部队提升X%攻击力加成。 1417 20%为固定常量（读const表中，gouda_percent字段），X%=作用号/10000，当兵种类型type=3与type=4的部队之和占单人出征的30%触发，仅个人单独计算，不会计算全部队
	@Override

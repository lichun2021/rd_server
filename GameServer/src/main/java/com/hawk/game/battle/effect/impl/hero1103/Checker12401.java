...
/**
 * 【12401】
- 【万分比】【12401】任命在战备参谋部时，防御坦克每受到远程单位的 1 次伤害时，自身防御坦克防御，生命+XX.XX%（该效果可叠加，至多 X 层）
  - 战报相关
    - 于战报中展示
    - 合并至精简战报中
  ...
  - （该效果可叠加，至多 X 层）
    - 数值读取const表，字段effect12401Maxinum
 */
@BattleTupleType(tuple = Type.SOLDIER_SKILL)
@EffectChecker(effType = EffType.HERO_12401)
public class Checker12401 implements IChecker {

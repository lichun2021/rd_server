...
@EffectChecker(effType = EffType.PLANT_SOLDIER_1902)
public class Checker1902 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.TANK_SOLDIER_1 && parames.solider.getSoldierCfg().isPlantSoldier()) {

...
/**
 * 【1325~1326】
【绝对值】【1325~1326】在战斗中，自身所有单位受到伤害减少20%（作用号1325），此效果会在每回合匀速衰减，在【30（作用号1326）+己方队伍中核心科技品阶总和*25.00%（effect1325RankRatio）】回合时衰减至0.00%（品阶总和上限为80（effect1325Maxinum），回合数不为整时向上取整）->针对自身兵种留个内置系数（effect1325SoldierAdjust） 
- 自身所有单位受到伤害减少 XX.XX%
...
@EffectChecker(effType = EffType.EFF_1325)
public class Checker1325 implements IChecker {

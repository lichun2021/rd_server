...
@EffectChecker(effType = EffType.EFF_12075)
public class Checker12075 implements IChecker {
	/**
	 *- 【万分比】【12075】战技持续期间，自身所有轰炸机受到攻击时，伤害减少 +XX.XX%
  - 战报相关
    - 于战报中展示
    - 不合并至精简战报中
  ...
  - 此为英雄战技专属作用号，配置格式如下
	...
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.troopEffType != WarEff.NO_EFF && parames.type == SoldierType.PLANE_SOLDIER_3) {

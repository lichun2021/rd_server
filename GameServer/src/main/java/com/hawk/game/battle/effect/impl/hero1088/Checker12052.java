...
@EffectChecker(effType = EffType.EFF_12052)
public class Checker12052 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		if (!Checker12051.check(parames,ConstProperty.getInstance().getEffect12052SelfNumLimit())) {

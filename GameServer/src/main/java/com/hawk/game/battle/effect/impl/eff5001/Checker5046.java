...
@EffectChecker(effType = EffType.EFF_5046)
public class Checker5046 implements IChecker {
	@Override
	public CheckerKVResult value(CheckerParames parames) {
		int effPer = 0;
		int effNum = 0;
		if (parames.type == SoldierType.FOOT_SOLDIER_6 && parames.unity.getPlayer().isInDungeonMap()) {

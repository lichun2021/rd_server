 ...
 *
 */
public class CollegeDismissInvoker extends HawkMsgInvoker {
	/** 玩家 */
	...
	public CollegeDismissInvoker(Player player, int hpCode) {
		this.player = player;
		this.hpCode = hpCode;
	}
	...
	public boolean onMessage(HawkAppObj targetObj, HawkMsg msg) {
		int result = CollegeService.getInstance().dismissCollege(player);

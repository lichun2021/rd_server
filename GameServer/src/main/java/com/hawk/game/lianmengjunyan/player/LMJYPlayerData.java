...
import com.hawk.game.lianmengjunyan.entity.LMJYDbEntityCopyUtil;
...
public class LMJYPlayerData extends ILMJYPlayerData {
	private ILMJYPlayerEffect playerEffect;
	/** 兵数据副本 */
	...
	private LMJYPlayerData(LMJYPlayer parent) {
		super(parent);
	}

	public static LMJYPlayerData valueOf(LMJYPlayer parent) {
		LMJYPlayerData result = new LMJYPlayerData(parent);
		PlayerData source = parent.getSource().getData();
		result.playerId = source.getPlayerId();
		result.dataCache = source.getDataCache();
		// army副本
		Map<Integer, ArmyEntity> armyMap = new HashMap<>();
		...
		for (ArmyEntity army : source.getArmyEntities()) {
			armyMap.put(army.getArmyId(), LMJYDbEntityCopyUtil.copyOf(army));
		}
		...
		// effect 对象
		result.playerEffect = new LMJYPlayerEffect(result);
	...
	@Override
	public ILMJYPlayerEffect getPlayerEffect() {
		return playerEffect;
	}
	...
	public int getEffVal(EffType effType) {
		// TODO Auto-generated method stub
		return getSource().getEffVal(effType);
	}

	@Override
	public int getEffVal(EffType effType, String targetId) {
		// TODO Auto-generated method stub
		return getSource().getEffVal(effType, targetId);
	}
	...
	public void setPlayerEffect(ILMJYPlayerEffect playerEffect) {
	...
	@Override
	public LMJYPlayer getParent() {
		// TODO Auto-generated method stub
		return (LMJYPlayer) super.getParent();
	}

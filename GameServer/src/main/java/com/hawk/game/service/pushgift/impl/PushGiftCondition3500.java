 ...
 * 礼包条件：泰能破译达到一定等级，返回主界面，且VIP等级在vipMin_vipMax之间 时触发
    - 等级：plant_crystal_analysis_chip     level
 * 配置格式：等级_vipMin_vipMax
 * @author Golden
 *
 */
public class PushGiftCondition3500 extends AbstractPushGiftCondition {
	...
	public int getConditionType() {
		return PushGiftConditionEnum.PUSH_GIFT_3500.getType();
	}
}

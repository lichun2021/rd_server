...
public class TBLYSeasonBigSignupState implements ITBLYSeasonBigState {
    @Override
    public void enter() {
        TBLYSeasonService.getInstance().onBigSignUp();
    }
    ...
    public TiberiumWar.TLWBigStateInfo.Builder getStateInfo(Player player) {
        ...
        builder.setState(TiberiumWar.TLWBigState.TLW_BIG_SIGNUP);
        return builder;
    }
}

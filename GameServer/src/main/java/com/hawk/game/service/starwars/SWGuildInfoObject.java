...
public class SWGuildInfoObject extends GuildInfoObject {

	private SWGuildData guildInfo;

	public SWGuildInfoObject(GuildInfoEntity entity) {
		super(entity);
	}

	public SWGuildData getGuildInfo() {
		return guildInfo;
	}

	public void setGuildInfo(SWGuildData guildInfo) {

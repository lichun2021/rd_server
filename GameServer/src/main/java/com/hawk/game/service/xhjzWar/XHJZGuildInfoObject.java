...
public class XHJZGuildInfoObject extends GuildInfoObject {
    private XHJZWarGuildData guildInfo;
    public XHJZGuildInfoObject(GuildInfoEntity entity) {
        super(entity);
    }

    public XHJZWarGuildData getGuildInfo() {
        return guildInfo;
    }

    public void setGuildInfo(XHJZWarGuildData guildInfo) {
    ...
    @Override
    public GsConst.GuildActiveType getActiveType() {
        throw new UnsupportedOperationException();
    }

    @Override
    public void setActiveType(GsConst.GuildActiveType activeType) {
        throw new UnsupportedOperationException();
    }

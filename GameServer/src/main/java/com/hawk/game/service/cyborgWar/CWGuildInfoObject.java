...
public class CWGuildInfoObject extends GuildInfoObject {

	private CWGuildData guildInfo;

	public CWGuildInfoObject(GuildInfoEntity entity) {
		super(entity);
	}

	public CWGuildData getGuildInfo() {
		return guildInfo;
	}

	public void setGuildInfo(CWGuildData guildInfo) {

 ...
 *
 */
public class PushGiftCureSpeedCondition extends AbstractPushGiftCondition {
	...
	public boolean isReach(PlayerData playerData, PushGiftLevelCfg cfg, List<Integer> param) {
		...
		// 治疗加速道具存量判断
		int speedTime = playerData.getItemSpeedTimeByItemType(ToolSpeedUpType.TOOL_SPEED_CURE_VALUE);
	...
	public int getConditionType() {
		return PushGiftConditionEnum.CURE_SPEED.getType(); 
	}

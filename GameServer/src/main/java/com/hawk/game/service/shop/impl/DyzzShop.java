...
import com.hawk.game.config.DyzzShopItemCfg;
import com.hawk.game.config.DyzzShopKVCfg;
 ...
 */
public class DyzzShop extends ShopBase<DyzzShopKVCfg, DyzzShopItemCfg>{
    ...
    public ShopType getType(){
        return ShopType.DYZZ_SHOP;
    }

    // Custom Code Begin
    // 此处为自定义代码
    public Action getCostAction(){
        return Action.DYZZ_SHOP_BUY;
    }

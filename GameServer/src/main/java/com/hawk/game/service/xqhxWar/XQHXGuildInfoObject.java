 ...
 * 先驱回响联盟实体
 */
public class XQHXGuildInfoObject extends GuildInfoObject {
    private XQHXWarGuildData guildInfo;
    public XQHXGuildInfoObject(GuildInfoEntity entity) {
        super(entity);
    }

    public XQHXWarGuildData getGuildInfo() {
        return guildInfo;
    }

    public void setGuildInfo(XQHXWarGuildData guildInfo) {

...
public class XHJZWarGuildData {
    ...
    public XHJZWarGuildData(){

    }

    public XHJZWarGuildData(GuildInfoObject guildInfoObject){
    ...
    public static XHJZWarGuildData unSerialize(String json) {
        if(HawkOSOperator.isEmptyString(json)){
            return null;
        }
        XHJZWarGuildData guildData = JSON.parseObject(json, XHJZWarGuildData.class);
        return guildData;
    }

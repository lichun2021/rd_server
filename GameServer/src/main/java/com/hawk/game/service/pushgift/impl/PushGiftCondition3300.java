...
/**
 * 礼包类型 = 2802
 * 礼包条件：泰能战士仪器升级达到一定等级，返回主界面，且VIP等级在vipMin_vipMax之间 时触发
 *  - 组ID：plant_instrument_upgrade_chip    group
    - 等级：plant_instrument_upgrade_chip     level
 * 配置格式：组ID_等级_vipMin_vipMax
 * @author Golden
 *
 */
public class PushGiftCondition3300 extends AbstractPushGiftCondition {
	...
	public int getConditionType() {
		return PushGiftConditionEnum.PUSH_GIFT_3300.getType();
	}
}

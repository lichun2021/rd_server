...
public class PushGiftPvpDefenceFailExtraCondition extends AbstractPushGiftCondition {
	...
	public boolean isReach(List<Integer> cfgParam, List<Integer> param) {
		return param.get(0).intValue() >= cfgParam.get(1) && (cfgParam.get(3) <= param.get(1) && param.get(1) <= cfgParam.get(4)); 
	}

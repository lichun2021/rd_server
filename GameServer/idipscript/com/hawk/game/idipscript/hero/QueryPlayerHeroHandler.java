package com.hawk.game.idipscript.hero;
...
public class QueryPlayerHeroHandler extends IdipScriptHandler {
	...
	static final int MAX_LIST_NUM = 50;
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		int indexStart = pageNo > 1 ? (pageNo - 1) * MAX_LIST_NUM : 0;
		int indexEnd = indexStart + MAX_LIST_NUM;
		indexStart += 1;
		...
		result.getBody().put("TotalPageNo", (int)Math.ceil(heros.size() * 1.0d /MAX_LIST_NUM));

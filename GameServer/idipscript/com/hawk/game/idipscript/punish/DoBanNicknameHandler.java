 ...
 * 禁止玩家修改昵称 -- 10282142
 *
 * localhost:8081/idip/4427
 *
 * @author lating
 */
@HawkScript.Declare(id = "idip/4427")
public class DoBanNicknameHandler extends IdipScriptHandler {
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		RedisProxy.getInstance().addIDIPBanInfo(player.getId(), banInfo, IDIPBanType.BAN_PLAYER_NAME);

 ...
 * 禁止玩家修改签名 -- 10282143
 *
 * localhost:8081/idip/4429
 *
 * @author lating
 */
@HawkScript.Declare(id = "idip/4429")
public class DoBanSignatureHandler extends IdipScriptHandler {
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		RedisProxy.getInstance().addIDIPBanInfo(player.getId(), banInfo, IDIPBanType.BAN_SIGNATURE);

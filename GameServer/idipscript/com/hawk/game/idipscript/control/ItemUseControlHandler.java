 ...
 * 道具使用控制 -- 10282068
 *
 * localhost:8080/script/idip/4239?ItemId=&Switch=
 *
 * @param ItemId       道具ID
 * @param Switch       开关
 * 
 * @author lating
 */
@HawkScript.Declare(id = "idip/4239")
public class ItemUseControlHandler extends IdipScriptHandler {
	@Override
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		IdipUtil.systemSwitchControl(switchVal, ControlerModule.ITEM_USE, itemId);

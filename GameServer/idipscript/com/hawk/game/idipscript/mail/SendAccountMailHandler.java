...
/**
 * 发送文本邮件请求（指定账号） -- 10282007
 *
 * localhost:8080/script/idip/4109?OpenId=&RoleId=&Title=&Content=
 *
 ...
 * @author lating
 */
@HawkScript.Declare(id = "idip/4109")
public class SendAccountMailHandler extends IdipScriptHandler {
	@Override
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		if (!RedisProxy.getInstance().saveIdipSerialID(serialID)) {
			HawkLog.errPrintln("SendAccountMailHandler4109 request repeatd of serial: {}", serialID);

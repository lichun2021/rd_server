...
/**
 * 全服禁止修改联盟名称、联盟堡垒名称、联盟宣言 -- 10282117
 *
...
public class ChangeGuildNameControlHandler extends IdipScriptHandler {
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		if (switchVal == 0) {
			...
			GlobalData.getInstance().addGlobalBanType(controlType, reason);
			LocalRedis.getInstance().addGlobalControlBan(controlType, reason);
		}

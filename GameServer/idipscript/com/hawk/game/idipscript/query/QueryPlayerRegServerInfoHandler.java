...
/**
 * 查询注册区角色信息请求 -- 10282145
 *
 * localhost:8081/idip/4439
 *
 * @author lating
 */
@HawkScript.Declare(id = "idip/4439")
public class QueryPlayerRegServerInfoHandler extends IdipScriptHandler {
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		int partition = request.getJSONObject("body").getIntValue("Partition");
		if (!player.getServerId().equals(String.valueOf(partition))) {
			result.getHead().put("Result", IdipConst.SysError.PARAM_ERROR);
			result.getHead().put("RetErrMsg", "Partition param not match");
			return result;
		}

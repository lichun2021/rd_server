...
public class QueryEquipHandler extends IdipScriptHandler {
	...
	static final int MAX_EQUIPLIST_NUM = 30;
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		int indexStart = pageNo > 1 ? (pageNo - 1) * MAX_EQUIPLIST_NUM : 0;
		int indexEnd = indexStart + MAX_EQUIPLIST_NUM;
		indexStart += 1;
		...
		result.getBody().put("TotalPageNum", (int)Math.ceil(armourEntities.size() * 1.0d /MAX_EQUIPLIST_NUM));

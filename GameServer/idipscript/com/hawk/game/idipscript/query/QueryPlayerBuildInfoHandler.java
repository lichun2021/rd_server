...
public class QueryPlayerBuildInfoHandler extends IdipScriptHandler {
	...
	static final int MAX_BUILDLIST_NUM = 50;
	...
	protected IdipResult onRequest(JSONObject request, HawkScriptHttpInfo httpInfo) {
		...
		int indexStart = pageNo > 1 ? (pageNo - 1) * MAX_BUILDLIST_NUM : 0;
		int indexEnd = indexStart + MAX_BUILDLIST_NUM;
		indexStart += 1;
		...
		result.getBody().put("TotalPageNo", (int)Math.ceil(buildingEntities.size() * 1.0d /MAX_BUILDLIST_NUM));

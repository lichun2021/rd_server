...
/**
 * 非安全资源转换为安全资源(AQ) -- 10282823
 *
 * localhost:8080/script/idip/4317
 * 
 * @author lating
 */
@HawkScript.Declare(id = "idip/4317")
public class PlayerResourceTransfer4317Handler extends IdipScriptHandler {
	...
	private static void resourceTransfer(JSONObject request, Player player) {
		...
		HawkLog.logPrintln("idip AQ transfer unsafe resource to safe, playerId: {}, total: {}", player.getId(), total);
	}
}
